    ...
    <div class="login-panel">
      <el-form ref="formRef" :model="form" :rules="rules" class="login-form">
        ...
        <div class="accounts">
          ...
          <el-tag type="success">engineer / 123456</el-tag>
          <el-tag type="warning">reviewer / 123456</el-tag>
        </div>
      </el-form>
    </div>
  </div>
...
.login-visual {
  ...
  color: #f8fafc;
  background:
    linear-gradient(135deg, rgba(15, 23, 42, 0.94), rgba(21, 94, 117, 0.74)),
