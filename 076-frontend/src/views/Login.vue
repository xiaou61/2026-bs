  ...
  <div class="login-wrap">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">企业信息管理</h2>
        <p class="subtitle">高效管理 · 智慧运营</p>
      </div>
...
.login-card::before {
  ...
  animation: enterpriseGradient 4s linear infinite;
}
