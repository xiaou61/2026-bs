  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">实验室耗材采购与库存</h2>
        <p class="subtitle">面向高校实验室的耗材采购审批、库存台账、领用登记和预警处置平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>keeper / 123456</el-tag>
...
.login-card::before {
  ...
  animation: labGradient 4s linear infinite;
}
