<template><DataPage title="账号权限" description="中心管理员、窗口经办、材料审核、督办人员、办事群众账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
