<template><DataPage title="账号权限" description="仓储管理员、盘点人员、申领单位、调度人员、审核人员账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
