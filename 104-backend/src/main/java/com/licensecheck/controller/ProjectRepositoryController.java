...
import com.licensecheck.service.ProjectRepositoryService;
...
public class ProjectRepositoryController {
    private final ProjectRepositoryService service;
    private final AuthService authService;

    @GetMapping("/page")
    public Result<PageInfo<ProjectRepository>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ProjectRepository entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ProjectRepository entity) {
        authService.assertAdminOrComplianceOrDeveloper(role);
        service.save(entity);
        return Result.success();
    }
