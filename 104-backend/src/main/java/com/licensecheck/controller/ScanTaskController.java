...
public class ScanTaskController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ScanTask>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ScanTask entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ScanTask entity) {
        service.save(entity);
        return Result.success();
    }
