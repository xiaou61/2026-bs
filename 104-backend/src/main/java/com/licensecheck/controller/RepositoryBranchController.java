...
public class RepositoryBranchController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<RepositoryBranch>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody RepositoryBranch entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody RepositoryBranch entity) {
        service.save(entity);
        return Result.success();
    }
