...
import com.coldchain.service.CarrierCompanyService;
...
public class CarrierCompanyController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<CarrierCompany>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody CarrierCompany entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody CarrierCompany entity) {
        authService.assertAdminOrDispatcher(role);
        service.save(entity);
        return Result.success();
    }
