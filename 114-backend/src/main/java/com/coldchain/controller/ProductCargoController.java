...
public class ProductCargoController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ProductCargo>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ProductCargo entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ProductCargo entity) {
        service.save(entity);
        return Result.success();
    }
