  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">企业访客预约登记与门禁联动</h2>
        <p class="subtitle">面向企业园区的访客预约、员工审批、门禁联动、轨迹追踪和异常预警协同管理平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>reception / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>employee / 123456</el-tag>
...
.login-card::before {
  ...
  animation: accessGradient 4s linear infinite;
}

@keyframes accessGradient {
