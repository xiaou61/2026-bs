<template><DataPage title="账号权限" description="前台接待员、被访员工、安保门岗、外来访客、行政主管账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
