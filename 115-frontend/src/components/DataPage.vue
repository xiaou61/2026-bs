...
const form = reactive({})
const statusOptions = [{ label: '启用', value: 'ACTIVE' }, { label: '草稿', value: 'DRAFT' }, { label: '待审核', value: 'PENDING' }, { label: '清关中', value: 'DECLARING' }, { label: '已放行', value: 'RELEASED' }, { label: '已结算', value: 'SETTLED' }, { label: '已完成', value: 'COMPLETED' }, { label: '异常差异', value: 'DIFFERENCE' }, { label: '成功', value: 'SUCCESS' }]
