...
('legal', '123456', '抽检员', 'LEGAL', '法务部', '139140000200', 'legal@demo.local', 1, NOW(), NOW()),
('applicant', '123456', '商户负责人', 'APPLICANT', '业务部门', '139140000300', 'applicant@demo.local', 1, NOW(), NOW()),
('approver', '123456', '监管审核员', 'APPROVER', '管理委员会', '139140000400', 'approver@demo.local', 1, NOW(), NOW());
...
('CLM-134-001', 'CLM-134-001', '负责领域一', 38.5, '2026-05-6 10:00', 'SUBMITTED', NOW(), NOW()),
('CLM-134-002', 'CLM-134-002', '负责领域二', 51.5, '2026-05-7 10:00', 'SUBMITTED', NOW(), NOW());
...
('APR-134-001', 'APR-134-001', '样品类型一', '审批人一', '抽样说明一', 'REVIEWING', NOW(), NOW()),
('APR-134-002', 'APR-134-002', '样品类型二', '审批人二', '抽样说明二', 'REVIEWING', NOW(), NOW());
...
('PAY-134-001', 'PAY-134-001', 38.5, '2026-05-6 10:00', '申请人一', 'FINISHED', NOW(), NOW()),
('PAY-134-002', 'PAY-134-002', 51.5, '2026-05-7 10:00', '申请人二', 'FINISHED', NOW(), NOW());
...
('PAT-134-001', 'PAT-134-001', '专利名称一', '负责领域一', '2026-05-6 10:00', 'PUBLISHED', NOW(), NOW()),
('PAT-134-002', 'PAT-134-002', '专利名称二', '负责领域二', '2026-05-7 10:00', 'PUBLISHED', NOW(), NOW());
