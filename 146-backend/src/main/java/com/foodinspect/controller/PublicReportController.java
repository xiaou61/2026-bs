...
public class PublicReportController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<PublicReport>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody PublicReport entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody PublicReport entity) {
        service.save(entity);
        return Result.success();
    }
