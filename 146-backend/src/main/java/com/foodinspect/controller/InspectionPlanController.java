...
import com.foodinspect.service.InspectionPlanService;
...
public class InspectionPlanController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<InspectionPlan>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PutMapping
    public Result<Void> update(@RequestBody InspectionPlan entity) {
        service.save(entity);
        return Result.success();
    }
