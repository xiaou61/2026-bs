...
import com.foodinspect.service.SamplingTaskService;
...
public class SamplingTaskController {
    ...
    private final SamplingTaskService service;

    @GetMapping("/page")
    public Result<PageInfo<SamplingTask>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody SamplingTask entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody SamplingTask entity) {
        authService.assertAnyRole(role, "ADMIN", "INSPECTOR");
        service.save(entity);
        return Result.success();
    }
