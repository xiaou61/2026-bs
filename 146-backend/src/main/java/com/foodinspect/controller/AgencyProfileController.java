...
public class AgencyProfileController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<AgencyProfile>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody AgencyProfile entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody AgencyProfile entity) {
        service.save(entity);
        return Result.success();
    }
