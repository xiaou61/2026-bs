...
public class DisposalRecordController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<DisposalRecord>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody DisposalRecord entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody DisposalRecord entity) {
        service.save(entity);
        return Result.success();
    }
