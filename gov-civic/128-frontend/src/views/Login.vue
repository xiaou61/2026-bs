  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">ESG数据填报与报告</h2>
        <p class="subtitle">面向ESG披露的数据填报、审核评分、改进任务和可视化报告平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>filler / 123456</el-tag>
...
.login-card::before {
  ...
  animation: esgGradient 4s linear infinite;
}

@keyframes esgGradient {
