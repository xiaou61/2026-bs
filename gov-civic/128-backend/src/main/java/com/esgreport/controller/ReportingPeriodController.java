...
import com.esgreport.service.ReportingPeriodService;
...
public class ReportingPeriodController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ReportingPeriod>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ReportingPeriod entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ReportingPeriod entity) {
        authService.assertAdminOrEditor(role);
        service.save(entity);
        return Result.success();
    }
