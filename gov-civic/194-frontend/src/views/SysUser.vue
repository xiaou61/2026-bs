<template><DataPage title="账号权限" description="园区监管、暂存管理员、转运调度、环保巡查、产废企业账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
