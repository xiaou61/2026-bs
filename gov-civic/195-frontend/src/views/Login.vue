  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">便民服务中心事项预约与窗口评价</h2>
        <p class="subtitle">面向政务服务场景的事项预约、排队叫号、窗口评价、投诉处理和绩效归档一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="warning" effect="plain" round>window / 123456</el-tag>
          <el-tag type="info" effect="plain" round>citizen / 123456</el-tag>
        </div>
      </div>

      <div class="gov-tips">
        <span>🏛️ 便民服务 · 人民至上 🏛️</span>
      </div>
    </el-card>
  </div>
</template>
...
.login-card::before {
  ...
  animation: govGradient 4s linear infinite;
}

@keyframes govGradient {
