  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">城市公厕巡检保洁与耗材补给</h2>
        <p class="subtitle">面向市政环卫场景的公厕巡检、保洁任务、耗材补给、投诉受理和整改跟踪一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>sanitation / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>inspector / 123456</el-tag>
          <el-tag type="info" effect="plain" round>citizen / 123456</el-tag>
        </div>
      </div>

      <div class="sanitation-tips">
        <span>🚻 美丽城市 · 从厕所革命开始 🚻</span>
      </div>
    </el-card>
  </div>
</template>
...
.login-card::before {
  ...
  right: 0;
  height: 6px;
  background: linear-gradient(90deg, #4CAF50, #66BB6A, #81C784, #A5D6A7, #4CAF50);
  background-size: 300% 100%;
  animation: cleanGradient 4s linear infinite;
}
