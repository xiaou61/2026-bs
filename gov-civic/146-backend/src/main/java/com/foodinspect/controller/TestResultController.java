...
import com.foodinspect.service.TestResultService;
...
public class TestResultController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<TestResult>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody TestResult entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody TestResult entity) {
        authService.assertAnyRole(role, "ADMIN", "REVIEWER");
        service.save(entity);
        return Result.success();
    }
