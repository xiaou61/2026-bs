...
import com.foodinspect.service.SampleRecordService;
...
public class SampleRecordController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<SampleRecord>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody SampleRecord entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody SampleRecord entity) {
        authService.assertAnyRole(role, "ADMIN", "INSPECTOR");
        service.save(entity);
        return Result.success();
    }
