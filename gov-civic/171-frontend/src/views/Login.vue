  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">应急物资储备盘点与调拨审批</h2>
        <p class="subtitle">面向应急管理场景的物资台账、库存盘点、调拨申请、出库记录和预警通知一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>warehouse / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>checker / 123456</el-tag>
          <el-tag type="info" effect="plain" round>dispatch / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: emergencyGradient 3s linear infinite;
}
