...
import com.worksite.service.ConstructionProjectService;
...
public class ConstructionProjectController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ConstructionProject>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ConstructionProject entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ConstructionProject entity) {
        authService.assertAdminOrSupervisor(role);
        service.save(entity);
        return Result.success();
    }
