...
import com.worksite.service.InspectionTaskService;
...
public class InspectionTaskController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<InspectionTask>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody InspectionTask entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody InspectionTask entity) {
        authService.assertAdminOrSupervisor(role);
        service.save(entity);
        return Result.success();
    }
