...
import com.worksite.service.SafetyInspectorService;
...
public class SafetyInspectorController {
    private final AuthService authService;
    private final SafetyInspectorService service;

    @GetMapping("/page")
    public Result<PageInfo<SafetyInspector>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody SafetyInspector entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody SafetyInspector entity) {
        authService.assertAdminOrSupervisor(role);
        service.save(entity);
        return Result.success();
    }
