...
import com.worksite.service.HazardReportService;
...
public class HazardReportController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<HazardReport>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody HazardReport entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody HazardReport entity) {
        authService.assertAdminOrInspector(role);
        service.save(entity);
        return Result.success();
    }
