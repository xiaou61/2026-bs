...
import com.carbonmanage.service.AccountingPeriodService;
...
public class AccountingPeriodController {
    ...
    @GetMapping("/page")
    public Result<IPage<AccountingPeriod>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody AccountingPeriod entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody AccountingPeriod entity) {
        authService.assertAdminOrAccountant(role);
        service.save(entity);
        return Result.success();
    }
