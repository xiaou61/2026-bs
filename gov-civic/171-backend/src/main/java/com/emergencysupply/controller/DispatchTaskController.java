...
import com.emergencysupply.service.DispatchTaskService;
...
public class DispatchTaskController extends BaseController {
    ...
    private static final String[] WRITE_ROLES = {"ADMIN", "DISPATCH", "WAREHOUSE", "APPLICANT", "AUDITOR"};

    public DispatchTaskController(AuthService authService, DispatchTaskService service) {
        super(authService);
