...
import com.floodcity.service.WaterLevelDataService;
...
public class WaterLevelDataController {
    ...
    private final WaterLevelDataService service;

    @GetMapping("/page")
    public Result<IPage<WaterLevelData>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody WaterLevelData entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody WaterLevelData entity) {
        authService.assertAdminOrMonitor(role);
        service.save(entity);
        return Result.success();
    }
