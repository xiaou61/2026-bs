...
public class DrainagePumpController {
    ...
    @GetMapping("/page")
    public Result<IPage<DrainagePump>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody DrainagePump entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody DrainagePump entity) {
        authService.assertAdminOrDispatcherOrManager(role);
        service.save(entity);
        return Result.success();
    }
