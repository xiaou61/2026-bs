...
import com.datamasking.common.BusinessException;
import com.datamasking.dto.LoginRequest;
import com.datamasking.entity.SysUser;
import com.datamasking.mapper.SysUserMapper;
import com.datamasking.utils.JwtUtils;
...
public class AuthService {
    ...
    public void assertAdminOrOwnerOrAuditor(String role) {
        assertAny(role, "ADMIN", "OWNER", "AUDITOR");
    }

    public void assertAuthenticated(String role) {
        assertAny(role, "ADMIN", "SECURITY", "OWNER", "AUDITOR");
    }
