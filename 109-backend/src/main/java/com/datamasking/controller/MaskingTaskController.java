...
public class MaskingTaskController {
    ...
    @GetMapping("/page")
    public Result<IPage<MaskingTask>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody MaskingTask entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody MaskingTask entity) {
        authService.assertAdminOrSecurity(role);
        service.save(entity);
        return Result.success();
    }
