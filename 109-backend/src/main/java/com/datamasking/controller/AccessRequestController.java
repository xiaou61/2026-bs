...
public class AccessRequestController {
    ...
    @GetMapping("/page")
    public Result<IPage<AccessRequest>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody AccessRequest entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody AccessRequest entity) {
        service.save(entity);
        return Result.success();
    }
