...
public class RecognitionTaskController {
    ...
    @GetMapping("/page")
    public Result<IPage<RecognitionTask>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody RecognitionTask entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody RecognitionTask entity) {
        service.save(entity);
        return Result.success();
    }
