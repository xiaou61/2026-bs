...
import com.datamasking.service.DataSourceConfigService;
...
public class DataSourceConfigController {
    ...
    @GetMapping("/page")
    public Result<IPage<DataSourceConfig>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody DataSourceConfig entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody DataSourceConfig entity) {
        authService.assertAdmin(role);
        service.save(entity);
        return Result.success();
    }
