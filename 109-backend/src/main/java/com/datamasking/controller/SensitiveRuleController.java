...
import com.datamasking.service.SensitiveRuleService;
...
public class SensitiveRuleController {
    ...
    private final SensitiveRuleService service;

    @GetMapping("/page")
    public Result<IPage<SensitiveRule>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody SensitiveRule entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody SensitiveRule entity) {
        authService.assertAdminOrSecurity(role);
        service.save(entity);
        return Result.success();
    }
