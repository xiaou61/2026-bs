...
public class ExportApprovalController {
    ...
    @GetMapping("/page")
    public Result<IPage<ExportApproval>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ExportApproval entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ExportApproval entity) {
        service.save(entity);
        return Result.success();
    }
