...
public class RecognitionResultController {
    ...
    @GetMapping("/page")
    public Result<IPage<RecognitionResult>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody RecognitionResult entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody RecognitionResult entity) {
        service.save(entity);
        return Result.success();
    }
