...
public class AnchorProfileController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<AnchorProfile>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody AnchorProfile entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody AnchorProfile entity) {
        service.save(entity);
        return Result.success();
    }
