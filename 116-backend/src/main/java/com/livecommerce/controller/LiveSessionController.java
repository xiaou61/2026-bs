...
public class LiveSessionController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<LiveSession>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody LiveSession entity) {
        authService.assertAdminOrOperator(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody LiveSession entity) {
        authService.assertAdminOrOperator(role);
        service.save(entity);
        return Result.success();
    }
