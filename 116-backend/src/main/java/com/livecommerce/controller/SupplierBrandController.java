...
public class SupplierBrandController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<SupplierBrand>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody SupplierBrand entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody SupplierBrand entity) {
        service.save(entity);
        return Result.success();
    }
