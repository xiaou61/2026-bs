...
public class AfterSaleTicketController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<AfterSaleTicket>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody AfterSaleTicket entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody AfterSaleTicket entity) {
        service.save(entity);
        return Result.success();
    }
