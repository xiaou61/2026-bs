...
public class PromotionScriptController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<PromotionScript>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody PromotionScript entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody PromotionScript entity) {
        service.save(entity);
        return Result.success();
    }
