...
public class ProductSelectionController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ProductSelection>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ProductSelection entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ProductSelection entity) {
        service.save(entity);
        return Result.success();
    }
    ...
    public Result<Void> shortlist(@PathVariable Long id) {
