...
public class SchedulePlanController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<SchedulePlan>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody SchedulePlan entity) {
        authService.assertAdminOrOperator(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody SchedulePlan entity) {
        authService.assertAdminOrOperator(role);
        service.save(entity);
        return Result.success();
    }
