...
public class LiveOrderController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<LiveOrder>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody LiveOrder entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody LiveOrder entity) {
        service.save(entity);
        return Result.success();
    }
