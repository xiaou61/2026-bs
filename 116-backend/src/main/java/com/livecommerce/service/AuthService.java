...
import com.livecommerce.common.BusinessException;
import com.livecommerce.dto.LoginRequest;
import com.livecommerce.entity.SysUser;
import com.livecommerce.mapper.SysUserMapper;
import com.livecommerce.utils.JwtUtils;
...
public class AuthService {
    ...
    public void assertAdminOrService(String role) {
        assertAny(role, "ADMIN", "SERVICE");
    }
    ...
    public void assertAdminOrOperatorOrMerchant(String role) {
        assertAny(role, "ADMIN", "OPERATOR", "MERCHANT");
    }

    public void assertAdminOrOperatorOrService(String role) {
        assertAny(role, "ADMIN", "OPERATOR", "SERVICE");
    }

    public void assertAuthenticated(String role) {
        assertAny(role, "ADMIN", "OPERATOR", "SERVICE", "MERCHANT");
    }
