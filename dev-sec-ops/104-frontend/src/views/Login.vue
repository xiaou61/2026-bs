  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">开源许可证合规扫描</h2>
        <p class="subtitle">项目台账、依赖扫描、风险整改和审计报告一体化管理</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>compliance / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>developer / 123456</el-tag>
          <el-tag type="danger" effect="plain" round>auditor / 123456</el-tag>
        </div>
      </div>

      <div class="compliance-tips">
        <span>🛡️ 开源合规 · 安全可控 🛡️</span>
      </div>
    </el-card>
  </div>
</template>
...
.login-card::before {
  ...
  animation: complianceGradient 4s linear infinite;
}
