  ...
  <div class="page">
    <el-card>
      ...
      <div class="search-bar">
        <el-input v-for="item in filters" :key="item.prop" v-model="query[item.prop]" :placeholder="item.label" clearable style="width: 190px" />
      ...
      <el-table :data="tableData" v-loading="loading" border>
        ...
        <el-table-column v-if="!readonly || rowActions.length" label="操作" fixed="right" width="260">
    ...
    <el-dialog v-model="dialogVisible" :title="form.id ? '编辑记录' : '新增记录'" width="620px">
