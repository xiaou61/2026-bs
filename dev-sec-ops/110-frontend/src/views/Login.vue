  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">个人数据隐私授权与访问审计</h2>
        <p class="subtitle">授权目的、访问申请、撤销请求、风险预警、审计报告闭环</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>privacy / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>datauser / 123456</el-tag>
...
.login-card::before {
  ...
  animation: privacyGradient 4s linear infinite;
}
