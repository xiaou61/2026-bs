  ...
  <div class="login-page">
    ...
    <div class="login-visual">
      <div class="brand-block">
        ...
        <h1>大模型提示词资产管理与效果评测平台</h1>
        <p>沉淀 Prompt 资产、版本、测试集、评测结果和复核反馈，支撑企业 AI 应用团队持续优化提示词质量。</p>
        <div class="features">
    ...
    <div class="login-panel">
      <el-form ref="formRef" :model="form" :rules="rules" class="login-form">
        <div class="form-header">
          ...
          <h2>系统登录</h2>
          <p class="form-subtitle">输入账号进入AI评测平台</p>
        </div>
        ...
        <div class="accounts">
          ...
          <div class="account-tags">
            ...
            <el-tag type="success" effect="plain" round>engineer / 123456</el-tag>
...
.login-form::before {
  ...
  right: 0;
  height: 6px;
  background: linear-gradient(90deg, #06b6d4, #0891b2, #22d3ee, #06b6d4);
...
.login-form :deep(.el-input__wrapper) {
  ...
  box-shadow: 0 2px 12px rgba(6, 182, 212, 0.08) !important;
  padding: 4px 12px;
...
.login-btn {
  ...
  background: linear-gradient(135deg, #06b6d4 0%, #0891b2 50%, #22d3ee 100%) !important;
