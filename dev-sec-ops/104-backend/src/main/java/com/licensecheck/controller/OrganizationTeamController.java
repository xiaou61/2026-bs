...
import com.licensecheck.service.OrganizationTeamService;
...
public class OrganizationTeamController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<OrganizationTeam>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody OrganizationTeam entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody OrganizationTeam entity) {
        authService.assertAdminOrCompliance(role);
        service.save(entity);
        return Result.success();
    }
