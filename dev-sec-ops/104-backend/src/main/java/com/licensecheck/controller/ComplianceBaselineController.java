...
public class ComplianceBaselineController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ComplianceBaseline>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ComplianceBaseline entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ComplianceBaseline entity) {
        authService.assertAdminOrCompliance(role);
        service.save(entity);
        return Result.success();
    }
