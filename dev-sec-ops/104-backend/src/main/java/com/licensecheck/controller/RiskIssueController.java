...
public class RiskIssueController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<RiskIssue>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody RiskIssue entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody RiskIssue entity) {
        authService.assertAdminOrCompliance(role);
        service.save(entity);
        return Result.success();
    }
