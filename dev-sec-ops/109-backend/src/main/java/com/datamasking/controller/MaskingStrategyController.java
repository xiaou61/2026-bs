...
import com.datamasking.service.MaskingStrategyService;
...
public class MaskingStrategyController {
    ...
    private final MaskingStrategyService service;

    @GetMapping("/page")
    public Result<IPage<MaskingStrategy>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody MaskingStrategy entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody MaskingStrategy entity) {
        authService.assertAdminOrSecurity(role);
        service.save(entity);
        return Result.success();
    }
