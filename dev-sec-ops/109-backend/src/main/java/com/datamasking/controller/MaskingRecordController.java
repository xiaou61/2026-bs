...
public class MaskingRecordController {
    ...
    @GetMapping("/page")
    public Result<IPage<MaskingRecord>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody MaskingRecord entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody MaskingRecord entity) {
        authService.assertAdminOrSecurity(role);
        service.save(entity);
        return Result.success();
    }
