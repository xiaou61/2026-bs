...
import com.apitestcase.service.ApiEndpointService;
...
public class ApiEndpointController {
    ...
    @GetMapping("/page")
    public Result<IPage<ApiEndpoint>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ApiEndpoint entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ApiEndpoint entity) {
        authService.assertAdminOrProductOrDeveloper(role);
        service.save(entity);
        return Result.success();
    }
