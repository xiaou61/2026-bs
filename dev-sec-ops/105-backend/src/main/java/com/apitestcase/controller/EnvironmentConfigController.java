...
public class EnvironmentConfigController {
    ...
    @GetMapping("/page")
    public Result<IPage<EnvironmentConfig>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody EnvironmentConfig entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody EnvironmentConfig entity) {
        authService.assertAdminOrTesterOrDeveloper(role);
        service.save(entity);
        return Result.success();
    }
