...
import com.apitestcase.service.TestCaseService;
...
public class TestCaseController {
    ...
    @GetMapping("/page")
    public Result<IPage<TestCase>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody TestCase entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody TestCase entity) {
        authService.assertAdminOrTesterOrDeveloper(role);
        service.save(entity);
        return Result.success();
    }
