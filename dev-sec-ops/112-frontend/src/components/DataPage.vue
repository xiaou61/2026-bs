  ...
  <div class="page">
    <el-card>
      ...
      <el-table :data="tableData" v-loading="loading" border>
        ...
        <el-table-column v-if="!readonly || rowActions.length" label="操作" fixed="right" width="280">
    ...
    <el-dialog v-model="dialogVisible" :title="form.id ? '编辑记录' : '新增记录'" width="660px">
...
const props = defineProps({ title: String, description: String, api: Object, columns: Array, formFields: Array, rowActions: { type: Array, default: () => [] }, defaults: { type: Object, default: () => ({}) }, readonly: Boolean, statusOptions: { type: Array, default: () => [{ label: '启用', value: 'ACTIVE' }, { label: '草稿', value: 'DRAFT' }, { label: '待确认', value: 'WAIT_CONFIRM' }, { label: '已确认', value: 'CONFIRMED' }, { label: '处理中', value: 'OPEN' }, { label: '已完成', value: 'FINISHED' }, { label: '已归档', value: 'ARCHIVED' }] } })
