<template>
  <DataPage title="用户管理" description="维护管理员、知识编辑员和员工账号。" :api="api" :filters="filters" :columns="columns" :form-fields="formFields" :defaults="{ role: 'STAFF', status: 1 }" />
</template>
...
const filters = [
  { prop: 'keyword', label: '关键词', type: 'input', placeholder: '用户名/昵称/部门' },
