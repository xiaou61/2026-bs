    ...
    <el-col :span="12">
      <el-card>
        ...
        <el-form ref="profileRef" :model="profileForm" :rules="profileRules" label-width="90px">
          ...
          <el-form-item label="昵称" prop="nickname"><el-input v-model="profileForm.nickname" maxlength="50" show-word-limit /></el-form-item>
          <el-form-item label="头像链接"><el-input v-model="profileForm.avatar" maxlength="255" /></el-form-item>
...
const profileForm = reactive({ id: null, username: '', nickname: '', avatar: '', phone: '', email: '' })
