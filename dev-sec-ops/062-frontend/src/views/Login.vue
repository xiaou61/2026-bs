  ...
  <div class="login-wrap">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">反欺诈平台</h2>
        <p class="subtitle">守护安全 · 打击欺诈</p>
      </div>
...
const handleLogin = async () => {
  ...
  try {
    ...
    if (['ADMIN', 'ANALYST'].includes(res.data.user.role)) {
...
.login-wrap {
  ...
  background: linear-gradient(135deg, #0f172a 0%, #1e3a8a 30%, #1d4ed8 60%, #06b6d4 100%);
  position: relative;
  overflow: hidden;
}
...
.login-card::before {
  ...
  right: 0;
  height: 6px;
  background: linear-gradient(90deg, #06b6d4, #1d4ed8, #1e3a8a, #06b6d4);
...
.login-form :deep(.el-input__wrapper:hover) {
  box-shadow: 0 4px 16px rgba(29, 78, 216, 0.15) !important;
}
...
.submit-btn:hover {
  ...
  box-shadow: 0 12px 32px rgba(29, 78, 216, 0.4) !important;
}
