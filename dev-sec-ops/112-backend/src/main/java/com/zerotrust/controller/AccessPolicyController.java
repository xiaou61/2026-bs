...
import com.zerotrust.service.AccessPolicyService;
...
public class AccessPolicyController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<AccessPolicy>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody AccessPolicy entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody AccessPolicy entity) {
        authService.assertAdminOrSecurity(role);
        service.save(entity);
        return Result.success();
    }
