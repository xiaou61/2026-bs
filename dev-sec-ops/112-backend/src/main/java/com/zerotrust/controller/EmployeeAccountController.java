...
public class EmployeeAccountController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<EmployeeAccount>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody EmployeeAccount entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody EmployeeAccount entity) {
        authService.assertAdmin(role);
        service.save(entity);
        return Result.success();
    }
