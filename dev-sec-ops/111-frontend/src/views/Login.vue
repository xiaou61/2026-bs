  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">网络钓鱼演练与安全培训</h2>
        <p class="subtitle">演练活动、邮件模板、点击追踪、课程考试、风险评分闭环</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="warning" effect="plain" round>trainer / 123456</el-tag>
...
.login-card::before {
  ...
  animation: phishingGradient 4s linear infinite;
}

@keyframes phishingGradient {
