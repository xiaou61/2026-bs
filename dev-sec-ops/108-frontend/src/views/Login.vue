  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">云原生成本分析与资源优化</h2>
        <p class="subtitle">FinOps成本透明、预算控制、优化建议闭环</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>finops / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>devops / 123456</el-tag>
...
.login-card::before {
  ...
  animation: finopsGradient 4s linear infinite;
}

@keyframes finopsGradient {
