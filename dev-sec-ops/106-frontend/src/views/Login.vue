  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">DevOps发布审批与回滚管理</h2>
        <p class="subtitle">发布单、审批流、部署任务、回滚预案和变更检查协同管理</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>release / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>ops / 123456</el-tag>
          <el-tag type="danger" effect="plain" round>auditor / 123456</el-tag>
        </div>
      </div>

      <div class="devops-tips">
        <span>🚀 持续交付 · 快速部署 🚀</span>
      </div>
    </el-card>
  </div>
...
.login-card::before {
  ...
  animation: devopsGradient 4s linear infinite;
}
