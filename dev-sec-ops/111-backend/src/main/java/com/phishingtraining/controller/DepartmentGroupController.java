...
public class DepartmentGroupController {
    ...
    @GetMapping("/page")
    public Result<IPage<DepartmentGroup>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody DepartmentGroup entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody DepartmentGroup entity) {
        authService.assertAdmin(role);
        service.save(entity);
        return Result.success();
    }
