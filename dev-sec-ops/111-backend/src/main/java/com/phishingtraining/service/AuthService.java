...
import com.phishingtraining.common.BusinessException;
import com.phishingtraining.dto.LoginRequest;
import com.phishingtraining.entity.SysUser;
import com.phishingtraining.mapper.SysUserMapper;
import com.phishingtraining.utils.JwtUtils;
...
public class AuthService {
    ...
    public void assertAdminOrTrainerOrAuditor(String role) {
        assertAny(role, "ADMIN", "TRAINER", "AUDITOR");
    }

    public void assertAuthenticated(String role) {
        assertAny(role, "ADMIN", "SECURITY", "TRAINER", "AUDITOR");
    }
