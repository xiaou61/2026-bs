...
import com.carbonmanage.service.EnergyConsumptionService;
...
public class EnergyConsumptionController {
    ...
    @GetMapping("/page")
    public Result<IPage<EnergyConsumption>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody EnergyConsumption entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody EnergyConsumption entity) {
        authService.assertAdminOrAccountant(role);
        service.save(entity);
        return Result.success();
    }
