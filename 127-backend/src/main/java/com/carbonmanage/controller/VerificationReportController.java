...
import com.carbonmanage.service.VerificationReportService;
...
public class VerificationReportController {
    ...
    private final VerificationReportService service;

    @GetMapping("/page")
    public Result<IPage<VerificationReport>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody VerificationReport entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody VerificationReport entity) {
        authService.assertAdminOrAuditor(role);
        service.save(entity);
        return Result.success();
    }
