...
import com.carbonmanage.service.EmissionRecordService;
...
public class EmissionRecordController {
    ...
    private final EmissionRecordService service;

    @GetMapping("/page")
    public Result<IPage<EmissionRecord>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody EmissionRecord entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody EmissionRecord entity) {
        authService.assertAdminOrAccountant(role);
        service.save(entity);
        return Result.success();
    }
