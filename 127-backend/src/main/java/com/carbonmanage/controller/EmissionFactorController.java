...
public class EmissionFactorController {
    ...
    @GetMapping("/page")
    public Result<IPage<EmissionFactor>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody EmissionFactor entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody EmissionFactor entity) {
        service.save(entity);
        return Result.success();
    }
