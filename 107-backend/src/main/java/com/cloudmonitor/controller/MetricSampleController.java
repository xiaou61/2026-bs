...
public class MetricSampleController {
    ...
    @GetMapping("/page")
    public Result<IPage<MetricSample>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody MetricSample entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody MetricSample entity) {
        service.save(entity);
        return Result.success();
    }
