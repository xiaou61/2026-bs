...
public class CapacityPlanController {
    ...
    @GetMapping("/page")
    public Result<IPage<CapacityPlan>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody CapacityPlan entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody CapacityPlan entity) {
        service.save(entity);
        return Result.success();
    }
