...
public class MetricDefinitionController {
    ...
    @GetMapping("/page")
    public Result<IPage<MetricDefinition>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody MetricDefinition entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody MetricDefinition entity) {
        service.save(entity);
        return Result.success();
    }
