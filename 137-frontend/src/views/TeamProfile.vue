...
import { getTeamProfilePage, addTeamProfile, updateTeamProfile, deleteTeamProfile, activateTeamProfile, finishTeamProfile } from '../api'
const api = { page: getTeamProfilePage, add: addTeamProfile, update: updateTeamProfile, delete: deleteTeamProfile }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'activate') await activateTeamProfile(row.id)
  if (command === 'finish') await finishTeamProfile(row.id)
