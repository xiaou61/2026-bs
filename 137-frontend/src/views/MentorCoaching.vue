...
import { getMentorCoachingPage, addMentorCoaching, updateMentorCoaching, deleteMentorCoaching, submitMentorCoaching, approveMentorCoaching } from '../api'
const api = { page: getMentorCoachingPage, add: addMentorCoaching, update: updateMentorCoaching, delete: deleteMentorCoaching }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'submit') await submitMentorCoaching(row.id)
  if (command === 'approve') await approveMentorCoaching(row.id)
