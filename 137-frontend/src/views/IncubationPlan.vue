...
import { getIncubationPlanPage, addIncubationPlan, updateIncubationPlan, deleteIncubationPlan, submitIncubationPlan, approveIncubationPlan } from '../api'
const api = { page: getIncubationPlanPage, add: addIncubationPlan, update: updateIncubationPlan, delete: deleteIncubationPlan }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'submit') await submitIncubationPlan(row.id)
  if (command === 'approve') await approveIncubationPlan(row.id)
