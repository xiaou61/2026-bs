...
import { getAchievementShowcasePage, addAchievementShowcase, updateAchievementShowcase, deleteAchievementShowcase, activateAchievementShowcase, finishAchievementShowcase } from '../api'
const api = { page: getAchievementShowcasePage, add: addAchievementShowcase, update: updateAchievementShowcase, delete: deleteAchievementShowcase }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'activate') await activateAchievementShowcase(row.id)
  if (command === 'finish') await finishAchievementShowcase(row.id)
