...
import { getProjectApplicationPage, addProjectApplication, updateProjectApplication, deleteProjectApplication, processProjectApplication, finishProjectApplication } from '../api'
const api = { page: getProjectApplicationPage, add: addProjectApplication, update: updateProjectApplication, delete: deleteProjectApplication }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'process') await processProjectApplication(row.id)
  if (command === 'finish') await finishProjectApplication(row.id)
