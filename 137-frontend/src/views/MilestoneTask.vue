...
import { getMilestoneTaskPage, addMilestoneTask, updateMilestoneTask, deleteMilestoneTask, processMilestoneTask, finishMilestoneTask } from '../api'
const api = { page: getMilestoneTaskPage, add: addMilestoneTask, update: updateMilestoneTask, delete: deleteMilestoneTask }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'process') await processMilestoneTask(row.id)
  if (command === 'finish') await finishMilestoneTask(row.id)
