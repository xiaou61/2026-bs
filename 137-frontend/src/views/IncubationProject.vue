...
import { getIncubationProjectPage, addIncubationProject, updateIncubationProject, deleteIncubationProject, activateIncubationProject, finishIncubationProject } from '../api'
const api = { page: getIncubationProjectPage, add: addIncubationProject, update: updateIncubationProject, delete: deleteIncubationProject }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'activate') await activateIncubationProject(row.id)
  if (command === 'finish') await finishIncubationProject(row.id)
