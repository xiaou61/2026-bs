...
public class CareNoticeController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<CareNotice>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody CareNotice entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody CareNotice entity) {
        service.save(entity);
        return Result.success();
    }
