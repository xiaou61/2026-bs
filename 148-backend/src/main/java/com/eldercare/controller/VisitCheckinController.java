...
import com.eldercare.service.VisitCheckinService;
...
public class VisitCheckinController {
    ...
    private final VisitCheckinService service;

    @GetMapping("/page")
    public Result<PageInfo<VisitCheckin>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody VisitCheckin entity) {
        authService.assertAdminOrCaregiver(role);
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody VisitCheckin entity) {
        authService.assertAdminOrCaregiver(role);
        service.save(entity);
        return Result.success();
    }
