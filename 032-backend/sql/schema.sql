...
CREATE INDEX IF NOT EXISTS idx_elder_user ON elder(user_id);
CREATE INDEX IF NOT EXISTS idx_meas_elder_time ON measurement(elder_id, measured_at);
CREATE INDEX IF NOT EXISTS idx_appt_doctor_time ON appointment(doctor_user_id, start_time);
CREATE INDEX IF NOT EXISTS idx_appt_elder ON appointment(elder_id);
CREATE INDEX IF NOT EXISTS idx_fu_doctor_due ON follow_up(doctor_user_id, due_date);
CREATE INDEX IF NOT EXISTS idx_fu_elder ON follow_up(elder_id);
CREATE INDEX IF NOT EXISTS idx_notice_user_time ON notification(user_id, created_at);
