...
import com.opera.service.ArtistService;
...
public class ArtistController {
    ...
    @Autowired
    private ArtistService majorService;

    @GetMapping("/list")
    public Result<PageInfo<ArtistArchive>> list(@RequestParam(defaultValue = "1") Integer pageNum,
    ...
    @GetMapping("/enabled")
    public Result<List<ArtistArchive>> enabled() {
        return Result.success(majorService.enabledList());
    }

    @PostMapping("/add")
    public Result<String> add(@RequestBody ArtistArchive entity, @RequestAttribute("role") String role) {
        majorService.add(entity, role);
        return Result.success();
    }

    @PutMapping("/update")
    public Result<String> update(@RequestBody ArtistArchive entity, @RequestAttribute("role") String role) {
