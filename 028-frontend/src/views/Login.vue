<template>
  <div class="login-container">
    ...
    <div class="bg-decoration">
      ...
      <div class="bike-icon icon-1">🚲</div>
      <div class="bike-icon icon-2">🌿</div>
      <div class="bike-icon icon-3">🍃</div>
    </div>
    ...
    <div class="login-box">
      ...
      <div class="login-header">
        ...
        <h1 class="login-title">共享单车租赁</h1>
        <p class="login-subtitle">Green Travel, Smart Campus</p>
      </div>
