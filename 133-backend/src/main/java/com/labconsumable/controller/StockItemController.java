...
import com.labconsumable.service.StockItemService;
...
public class StockItemController {
    ...
    @GetMapping("/page")
    public Result<IPage<StockItem>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody StockItem entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody StockItem entity) {
        authService.assertAdminOrKeeper(role);
        service.save(entity);
        return Result.success();
    }
