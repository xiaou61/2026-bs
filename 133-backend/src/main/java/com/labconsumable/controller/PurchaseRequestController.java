...
import com.labconsumable.service.PurchaseRequestService;
...
public class PurchaseRequestController {
    ...
    @GetMapping("/page")
    public Result<IPage<PurchaseRequest>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody PurchaseRequest entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody PurchaseRequest entity) {
        authService.assertAdminOrTeacher(role);
        service.save(entity);
        return Result.success();
    }
