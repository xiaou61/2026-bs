...
import com.labconsumable.service.OutboundRecordService;
...
public class OutboundRecordController {
    ...
    @GetMapping("/page")
    public Result<IPage<OutboundRecord>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody OutboundRecord entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody OutboundRecord entity) {
        authService.assertAdminOrKeeper(role);
        service.save(entity);
        return Result.success();
    }
    ...
    public Result<Void> approve(@RequestAttribute String role, @PathVariable Long id) {
        authService.assertAdminOrApprover(role);
