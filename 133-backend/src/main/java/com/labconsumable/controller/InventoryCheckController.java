...
public class InventoryCheckController {
    ...
    @GetMapping("/page")
    public Result<IPage<InventoryCheck>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody InventoryCheck entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody InventoryCheck entity) {
        service.save(entity);
        return Result.success();
    }
