...
import com.labconsumable.service.SupplierProfileService;
...
public class SupplierProfileController {
    ...
    @GetMapping("/page")
    public Result<IPage<SupplierProfile>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody SupplierProfile entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody SupplierProfile entity) {
        authService.assertAdminOrKeeper(role);
        service.save(entity);
        return Result.success();
    }
