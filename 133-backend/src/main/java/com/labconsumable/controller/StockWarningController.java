...
public class StockWarningController {
    ...
    @GetMapping("/page")
    public Result<IPage<StockWarning>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody StockWarning entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody StockWarning entity) {
        service.save(entity);
        return Result.success();
    }
