...
import com.labconsumable.service.InboundRecordService;
...
public class InboundRecordController {
    ...
    @GetMapping("/page")
    public Result<IPage<InboundRecord>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody InboundRecord entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody InboundRecord entity) {
        authService.assertAdminOrKeeper(role);
        service.save(entity);
        return Result.success();
    }
