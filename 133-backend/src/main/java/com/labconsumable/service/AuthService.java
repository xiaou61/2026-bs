...
import com.labconsumable.common.BusinessException;
import com.labconsumable.dto.LoginRequest;
import com.labconsumable.entity.SysUser;
import com.labconsumable.mapper.SysUserMapper;
import com.labconsumable.utils.JwtUtils;
...
public class AuthService {
    ...
    public void assertAdminOrKeeperOrApprover(String role) {
        assertAny(role, "ADMIN", "KEEPER", "APPROVER");
    }

    public void assertAuthenticated(String role) {
        assertAny(role, "ADMIN", "KEEPER", "TEACHER", "APPROVER");
    }
