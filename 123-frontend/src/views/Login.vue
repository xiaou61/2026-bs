  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">城市内涝监测与应急调度</h2>
        <p class="subtitle">面向城市内涝场景的监测预警、应急任务、救援队伍和物资调度平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>monitor / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>dispatcher / 123456</el-tag>
          <el-tag type="info" effect="plain" round>manager / 123456</el-tag>
        </div>
      </div>

      <div class="flood-tips">
        <span>🌊 防汛预警 · 安全度汛 🌊</span>
      </div>
    </el-card>
  </div>
...
.login-page {
  ...
  align-items: center;
  background: linear-gradient(135deg, #01579B 0%, #0277BD 30%, #0288D1 60%, #039BE5 100%);
  position: relative;
  overflow: hidden;
}
...
.login-card {
  ...
  border-radius: 28px;
  box-shadow: 0 24px 64px rgba(1, 87, 155, 0.3);
  position: relative;
  z-index: 10;
...
.login-card::before {
  ...
  right: 0;
  height: 6px;
  background: linear-gradient(90deg, #01579B, #0277BD, #0288D1, #039BE5, #01579B);
  background-size: 300% 100%;
  animation: floodGradient 4s linear infinite;
}

@keyframes floodGradient {
...
.login-form :deep(.el-input__wrapper) {
  ...
  box-shadow: 0 2px 12px rgba(1, 87, 155, 0.08) !important;
  padding: 4px 12px;
  transition: all 0.3s ease;
}

.login-form :deep(.el-input__wrapper:hover) {
  box-shadow: 0 4px 16px rgba(1, 87, 155, 0.15) !important;
}

.login-form :deep(.el-input__wrapper.is-focus) {
  box-shadow: 0 4px 20px rgba(1, 87, 155, 0.25) !important;
}
...
.submit-btn:hover {
  ...
  box-shadow: 0 12px 32px rgba(1, 87, 155, 0.4) !important;
}
