...
import com.researchfund.service.ExpenseClaimService;
...
public class ExpenseClaimController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ExpenseClaim>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ExpenseClaim entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ExpenseClaim entity) {
        authService.assertAdminOrResearcher(role);
        service.save(entity);
        return Result.success();
    }
    ...
    public Result<Void> approve(@RequestAttribute String role, @PathVariable Long id) {
        authService.assertAdminOrLeader(role);
