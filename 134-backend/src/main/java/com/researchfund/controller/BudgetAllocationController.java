...
public class BudgetAllocationController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<BudgetAllocation>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody BudgetAllocation entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody BudgetAllocation entity) {
        service.save(entity);
        return Result.success();
    }
