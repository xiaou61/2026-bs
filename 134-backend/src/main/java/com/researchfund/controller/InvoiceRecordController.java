...
import com.researchfund.service.InvoiceRecordService;
...
public class InvoiceRecordController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<InvoiceRecord>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody InvoiceRecord entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody InvoiceRecord entity) {
        authService.assertAdminOrResearcher(role);
        service.save(entity);
        return Result.success();
    }
