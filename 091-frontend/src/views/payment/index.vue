<template>
  <div>
    <el-card>
      <div class="toolbar">
        <el-select v-model="query.status" placeholder="流水状态" clearable style="width: 160px">
      ...
      <el-table :data="tableData" border v-loading="loading">
        ...
        <el-table-column prop="payNo" label="流水单号" width="220" />
        <el-table-column prop="orderId" label="订单ID" width="100" />
        <el-table-column prop="payType" label="类型" width="120" />
