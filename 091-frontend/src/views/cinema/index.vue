<template>
  <div>
    <el-card>
      <div class="toolbar">
        <el-input v-model="query.name" placeholder="门店名称" clearable style="width: 220px" />
        <el-button type="primary" @click="loadData">查询</el-button>
        <el-button v-if="isManager" type="success" @click="handleAdd">新增门店</el-button>
      </div>
      <el-table :data="tableData" border v-loading="loading">
        ...
        <el-table-column label="操作" width="170" v-if="isManager">
    ...
    <el-dialog v-model="dialogVisible" title="门店信息" width="560px">
