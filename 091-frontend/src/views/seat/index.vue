<template>
  <div>
    <el-card>
      <template #header>会员订票中心</template>
      <div class="toolbar">
        ...
        <el-button type="success" @click="handleLock">锁座</el-button>
        <el-button @click="handleUnlock">释放</el-button>
      </div>
      ...
      <div class="order-bar">
        ...
        <el-button type="danger" @click="handleCreateOrder">生成消费订单</el-button>
      </div>
    </el-card>
  </div>
</template>
