...
public class DisclosureTemplateController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<DisclosureTemplate>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody DisclosureTemplate entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody DisclosureTemplate entity) {
        service.save(entity);
        return Result.success();
    }
