...
public class ImprovementTaskController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ImprovementTask>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ImprovementTask entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ImprovementTask entity) {
        authService.assertAdminOrEsgManager(role);
        service.save(entity);
        return Result.success();
    }
