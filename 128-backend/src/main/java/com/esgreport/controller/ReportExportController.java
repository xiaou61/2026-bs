...
public class ReportExportController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ReportExport>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ReportExport entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ReportExport entity) {
        service.save(entity);
        return Result.success();
    }
