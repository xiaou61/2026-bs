...
public class CompanySubmissionController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<CompanySubmission>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody CompanySubmission entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody CompanySubmission entity) {
        service.save(entity);
        return Result.success();
    }
