...
public class ScoreModelController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ScoreModel>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ScoreModel entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ScoreModel entity) {
        service.save(entity);
        return Result.success();
    }
