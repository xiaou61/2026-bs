...
public class IndicatorLibraryController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<IndicatorLibrary>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody IndicatorLibrary entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody IndicatorLibrary entity) {
        service.save(entity);
        return Result.success();
    }
