...
import com.esgreport.service.IndicatorDataService;
...
public class IndicatorDataController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<IndicatorData>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody IndicatorData entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody IndicatorData entity) {
        authService.assertAdminOrEditor(role);
        service.save(entity);
        return Result.success();
    }
