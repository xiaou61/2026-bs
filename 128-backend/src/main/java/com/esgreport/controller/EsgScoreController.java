...
import com.esgreport.service.EsgScoreService;
...
public class EsgScoreController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<EsgScore>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody EsgScore entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody EsgScore entity) {
        authService.assertAdminOrEsgManager(role);
        service.save(entity);
        return Result.success();
    }
