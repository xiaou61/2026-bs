...
public class StakeholderFeedbackController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<StakeholderFeedback>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody StakeholderFeedback entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody StakeholderFeedback entity) {
        service.save(entity);
        return Result.success();
    }
