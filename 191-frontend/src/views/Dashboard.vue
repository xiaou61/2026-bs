<template>
  <div class="page">
    <div class="dashboard-grid">
      <div class="metric">器具借用<strong>{{ data.record01Count || 0 }}</strong></div>
      <div class="metric">康复计划<strong>{{ data.record02Count || 0 }}</strong></div>
      <div class="metric">随访记录<strong>{{ data.record03Count || 0 }}</strong></div>
      <div class="metric">回收提醒<strong>{{ data.record04Count || 0 }}</strong></div>
    </div>
