  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">社区助残器具借用与康复随访</h2>
        <p class="subtitle">面向社区助残场景的器具借用、康复计划、训练记录、随访跟踪和志愿帮扶一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="warning" effect="plain" round>therapist / 123456</el-tag>
