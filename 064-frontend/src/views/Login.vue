  ...
  <div class="login-wrap">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">经方药食两用服务</h2>
        <p class="subtitle">药食同源 · 健康养生</p>
      </div>
...
.login-card {
  ...
  border-radius: 28px;
  box-shadow: 0 24px 64px rgba(6, 95, 70, 0.2);
  position: relative;
  z-index: 10;
...
.register-btn:hover {
  box-shadow: 0 12px 32px rgba(13, 148, 136, 0.4) !important;
}
