...
const columns = [{ prop: 'planId', label: '面试ID' }, { prop: 'interviewerId', label: '面试官ID' }, { prop: 'score', label: '评分' }, { prop: 'resultStatus', label: '结果', map: resultMap }, { prop: 'strengths', label: '优势', minWidth: 220, long: true }, { prop: 'suggestion', label: '建议', minWidth: 220, long: true }]
const formFields = [{ prop: 'planId', label: '面试ID', type: 'number', min: 1, required: true }, { prop: 'interviewerId', label: '面试官ID', type: 'number', min: 1 }, { prop: 'score', label: '评分', type: 'number', min: 0, max: 100, precision: 2 }, { prop: 'resultStatus', label: '结果', type: 'select', options: resultOptions }, { prop: 'strengths', label: '优势', type: 'textarea', rows: 3 }, { prop: 'weaknesses', label: '不足', type: 'textarea', rows: 3 }, { prop: 'suggestion', label: '建议', type: 'textarea', rows: 3 }]
</script>
