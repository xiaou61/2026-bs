...
const formFields = [{ prop: 'userId', label: '用户ID', type: 'number', min: 1 }, { prop: 'realName', label: '姓名', required: true }, { prop: 'gender', label: '性别' }, { prop: 'education', label: '学历' }, { prop: 'workYears', label: '经验年限', type: 'number', min: 0 }, { prop: 'targetJob', label: '目标岗位' }, { prop: 'skillTags', label: '技能标签', type: 'textarea', rows: 3 }, { prop: 'expectedSalary', label: '期望薪资', type: 'number', min: 0, precision: 2 }, { prop: 'status', label: '状态', type: 'select', options: statusOptions }]
</script>
