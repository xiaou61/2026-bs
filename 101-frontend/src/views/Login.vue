  ...
  <div class="login-page">
    ...
    <div class="login-visual">
      <div class="brand-block">
        ...
        <div class="brand-tag">RECRUITMENT AI</div>
    ...
    <div class="login-panel">
      <el-form ref="formRef" :model="form" :rules="rules" class="login-form">
        <div class="form-header">
          ...
          <h2>系统登录</h2>
          <p class="form-subtitle">输入账号进入招聘管理系统</p>
        </div>
        ...
        <div class="accounts">
          ...
          <div class="account-tags">
            ...
            <el-tag type="danger" effect="plain" round>interviewer / 123456</el-tag>
          </div>
        </div>
        <div class="recruit-tips">
          <span>👔 找对人才 · 成就企业 👔</span>
        </div>
      </el-form>
    </div>
...
.login-form::before {
  ...
  animation: recruitGradient 4s linear infinite;
}

@keyframes recruitGradient {
...
.login-btn {
  ...
  background: linear-gradient(135deg, #0891b2 0%, #22d3ee 50%, #67e8f9 100%) !important;
  border: none !important;
  box-shadow: 0 8px 24px rgba(8, 145, 178, 0.3) !important;
...
.login-btn:hover {
  ...
  box-shadow: 0 12px 32px rgba(8, 145, 178, 0.4) !important;
}
