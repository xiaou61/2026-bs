  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">水务巡线工单与阀门检修协同</h2>
        <p class="subtitle">面向供水管网场景的巡线工单、阀门检修、故障报修、备件管理和风险预警协同管理平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>dispatch / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>patrol / 123456</el-tag>
          <el-tag type="info" effect="plain" round>repair / 123456</el-tag>
        </div>
      </div>
...
.login {
  ...
  align-items: center;
  background: linear-gradient(135deg, #0277BD 0%, #0288D1 30%, #039BE5 60%, #4FC3F7 100%);
  position: relative;
  overflow: hidden;
}
...
.login-card {
  ...
  border-radius: 28px;
  box-shadow: 0 24px 64px rgba(2, 119, 189, 0.3);
  position: relative;
  z-index: 10;
...
.login-card::before {
  ...
  right: 0;
  height: 6px;
  background: linear-gradient(90deg, #0277BD, #0288D1, #039BE5, #4FC3F7, #0277BD);
  background-size: 300% 100%;
  animation: waterGradient 4s linear infinite;
}
...
.login-form :deep(.el-input__wrapper) {
  ...
  box-shadow: 0 2px 12px rgba(2, 119, 189, 0.08) !important;
  padding: 4px 12px;
  transition: all 0.3s ease;
}

.login-form :deep(.el-input__wrapper:hover) {
  box-shadow: 0 4px 16px rgba(2, 119, 189, 0.15) !important;
}

.login-form :deep(.el-input__wrapper.is-focus) {
  box-shadow: 0 4px 20px rgba(2, 119, 189, 0.25) !important;
}
...
.submit-btn {
  ...
  box-shadow: 0 8px 24px rgba(2, 119, 189, 0.3) !important;
...
.submit-btn:hover {
  ...
  box-shadow: 0 12px 32px rgba(2, 119, 189, 0.4) !important;
}
