...
import com.conferencereview.service.ReviewerProfileService;
...
public class ReviewerProfileController {
    ...
    private final ReviewerProfileService service;

    @GetMapping("/page")
    public Result<IPage<ReviewerProfile>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ReviewerProfile entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ReviewerProfile entity) {
        authService.assertAdminOrManager(role);
        service.save(entity);
        return Result.success();
    }
