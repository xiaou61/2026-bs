...
public class AcceptanceNoticeController {
    ...
    @GetMapping("/page")
    public Result<IPage<AcceptanceNotice>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody AcceptanceNotice entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody AcceptanceNotice entity) {
        service.save(entity);
        return Result.success();
    }
