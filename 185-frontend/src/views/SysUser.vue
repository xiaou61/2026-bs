<template><DataPage title="账号权限" description="环卫管理员、保洁员、补给员、巡检员、市民监督账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
