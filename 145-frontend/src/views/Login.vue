  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">城市噪声投诉监测与执法</h2>
        <p class="subtitle">面向城市噪声治理场景的投诉受理、点位监测、执法联动、整改复测和公众回访协同平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>citizen / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>officer / 123456</el-tag>
          <el-tag type="info" effect="plain" round>supervisor / 123456</el-tag>
        </div>
      </div>

      <div class="noise-tips">
        <span>🔊 降低噪音 · 安静生活 🔊</span>
      </div>
    </el-card>
  </div>
...
.login-card::before {
  ...
  animation: noiseGradient 4s linear infinite;
}

@keyframes noiseGradient {
