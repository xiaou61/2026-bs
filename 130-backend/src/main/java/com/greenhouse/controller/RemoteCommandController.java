...
import com.greenhouse.service.RemoteCommandService;
...
public class RemoteCommandController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<RemoteCommand>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody RemoteCommand entity) {
        authService.assertAdminOrTechnicianOrManager(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody RemoteCommand entity) {
        authService.assertAdminOrTechnicianOrManager(role);
        service.save(entity);
        return Result.success();
    }
