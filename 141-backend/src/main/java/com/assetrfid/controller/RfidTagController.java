...
import com.assetrfid.service.RfidTagService;
...
public class RfidTagController {
    ...
    @GetMapping("/page")
    public Result<IPage<RfidTag>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody RfidTag entity) {
        authService.assertAdminOrAssetAdmin(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody RfidTag entity) {
        authService.assertAdminOrAssetAdmin(role);
        service.save(entity);
        return Result.success();
    }
