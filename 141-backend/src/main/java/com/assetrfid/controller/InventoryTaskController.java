...
public class InventoryTaskController {
    ...
    @GetMapping("/page")
    public Result<IPage<InventoryTask>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody InventoryTask entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody InventoryTask entity) {
        service.save(entity);
        return Result.success();
    }
