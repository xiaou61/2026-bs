...
import com.assetrfid.service.InventoryTaskService;
...
public class InventoryTaskController {
    ...
    @GetMapping("/page")
    public Result<IPage<InventoryTask>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody InventoryTask entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody InventoryTask entity) {
        authService.assertAdminOrAssetAdmin(role);
        service.save(entity);
        return Result.success();
    }
