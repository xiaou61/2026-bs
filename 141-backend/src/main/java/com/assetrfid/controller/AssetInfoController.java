...
import com.assetrfid.service.AssetInfoService;
...
public class AssetInfoController {
    ...
    @GetMapping("/page")
    public Result<IPage<AssetInfo>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody AssetInfo entity) {
        authService.assertAdminOrAssetAdmin(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody AssetInfo entity) {
        authService.assertAdminOrAssetAdmin(role);
        service.save(entity);
        return Result.success();
    }
