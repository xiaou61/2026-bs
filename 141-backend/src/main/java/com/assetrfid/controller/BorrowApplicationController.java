...
public class BorrowApplicationController {
    ...
    @GetMapping("/page")
    public Result<IPage<BorrowApplication>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody BorrowApplication entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody BorrowApplication entity) {
        service.save(entity);
        return Result.success();
    }
