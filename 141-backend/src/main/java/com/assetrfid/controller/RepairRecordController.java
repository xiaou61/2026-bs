...
import com.assetrfid.service.RepairRecordService;
...
public class RepairRecordController {
    ...
    @GetMapping("/page")
    public Result<IPage<RepairRecord>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody RepairRecord entity) {
        authService.assertAdminOrAssetAdminOrBorrower(role);
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody RepairRecord entity) {
        authService.assertAdminOrAssetAdminOrBorrower(role);
        service.save(entity);
        return Result.success();
    }
