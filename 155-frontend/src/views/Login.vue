  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">社区党建活动报名与积分激励</h2>
        <p class="subtitle">面向基层党组织的活动报名、签到积分、志愿任务、荣誉排行和公告通知一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>secretary / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>organizer / 123456</el-tag>
          <el-tag type="info" effect="plain" round>volunteer / 123456</el-tag>
          <el-tag type="danger" effect="plain" round>resident / 123456</el-tag>
        </div>
      </div>

      <div class="party-tips">
        <span>⭐ 不忘初心 · 牢记使命 ⭐</span>
      </div>
    </el-card>
  </div>
...
.login-card::before {
  ...
  animation: partyGradient 4s linear infinite;
}
