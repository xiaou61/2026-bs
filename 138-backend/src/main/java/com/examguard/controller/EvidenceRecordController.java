...
public class EvidenceRecordController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<EvidenceRecord>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody EvidenceRecord entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody EvidenceRecord entity) {
        service.save(entity);
        return Result.success();
    }
