...
import com.examguard.service.CandidateProfileService;
...
public class CandidateProfileController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<CandidateProfile>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody CandidateProfile entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody CandidateProfile entity) {
        authService.assertAdminOrCandidate(role);
        service.save(entity);
        return Result.success();
    }
