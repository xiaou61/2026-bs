...
public class InvigilatorProfileController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<InvigilatorProfile>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody InvigilatorProfile entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody InvigilatorProfile entity) {
        service.save(entity);
        return Result.success();
    }
