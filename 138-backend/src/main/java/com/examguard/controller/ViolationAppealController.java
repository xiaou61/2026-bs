...
public class ViolationAppealController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ViolationAppeal>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ViolationAppeal entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ViolationAppeal entity) {
        service.save(entity);
        return Result.success();
    }
