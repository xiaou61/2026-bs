...
import com.examguard.entity.ExamSession;
import com.examguard.service.AuthService;
import com.examguard.service.ExamSessionService;
...
public class ExamSessionController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ExamSession>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ExamSession entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ExamSession entity) {
        authService.assertAdminOrInvigilator(role);
        service.save(entity);
        return Result.success();
    }
