...
import com.examguard.service.SuspiciousBehaviorService;
...
public class SuspiciousBehaviorController {
    private final AuthService authService;
    private final SuspiciousBehaviorService service;

    @GetMapping("/page")
    public Result<PageInfo<SuspiciousBehavior>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody SuspiciousBehavior entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody SuspiciousBehavior entity) {
        authService.assertAdminOrInvigilator(role);
        service.save(entity);
        return Result.success();
    }
