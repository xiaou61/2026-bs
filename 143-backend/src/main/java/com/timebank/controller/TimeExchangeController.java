...
import com.timebank.service.TimeExchangeService;
...
public class TimeExchangeController {
    private final AuthService authService;
    private final TimeExchangeService service;

    @GetMapping("/page")
    public Result<IPage<TimeExchange>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody TimeExchange entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody TimeExchange entity) {
        authService.assertAdminOrResidentOrVolunteer(role);
        service.save(entity);
        return Result.success();
    }
