...
import com.timebank.service.ResidentProfileService;
...
public class ResidentProfileController {
    ...
    @GetMapping("/page")
    public Result<IPage<ResidentProfile>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ResidentProfile entity) {
        authService.assertAdminOrManager(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ResidentProfile entity) {
        authService.assertAdminOrManager(role);
        service.save(entity);
        return Result.success();
    }
