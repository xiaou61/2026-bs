...
public class SiteNoticeController {
    ...
    @GetMapping("/page")
    public Result<IPage<SiteNotice>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody SiteNotice entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody SiteNotice entity) {
        service.save(entity);
        return Result.success();
    }
