...
('trainer', '123456', '社区居民', 'TRAINER', '企业大学', '139139000200', 'trainer@demo.local', 1, NOW(), NOW()),
('employee', '123456', '志愿者', 'EMPLOYEE', '业务部门', '139139000300', 'employee@demo.local', 1, NOW(), NOW()),
('manager', '123456', '站点管理员', 'MANAGER', '管理中心', '139139000400', 'manager@demo.local', 1, NOW(), NOW());
