...
public class FailureRecordController {
    ...
    @GetMapping("/page")
    public Result<IPage<FailureRecord>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody FailureRecord entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody FailureRecord entity) {
        service.save(entity);
        return Result.success();
    }
