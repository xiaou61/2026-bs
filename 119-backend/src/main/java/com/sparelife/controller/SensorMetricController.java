...
public class SensorMetricController {
    ...
    @GetMapping("/page")
    public Result<IPage<SensorMetric>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody SensorMetric entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody SensorMetric entity) {
        service.save(entity);
        return Result.success();
    }
