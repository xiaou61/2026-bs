...
public class LifePredictionController {
    ...
    @GetMapping("/page")
    public Result<IPage<LifePrediction>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody LifePrediction entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody LifePrediction entity) {
        authService.assertAdminOrAnalyst(role);
        service.save(entity);
        return Result.success();
    }
