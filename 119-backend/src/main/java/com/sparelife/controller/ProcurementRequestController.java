...
import com.sparelife.service.ProcurementRequestService;
...
public class ProcurementRequestController {
    ...
    @GetMapping("/page")
    public Result<IPage<ProcurementRequest>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ProcurementRequest entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ProcurementRequest entity) {
        authService.assertAdminOrDeviceAdmin(role);
        service.save(entity);
        return Result.success();
    }
