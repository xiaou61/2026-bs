...
import com.droneinspect.service.DefectReportService;
...
public class DefectReportController {
    ...
    @GetMapping("/page")
    public Result<IPage<DefectReport>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody DefectReport entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody DefectReport entity) {
        service.save(entity);
        return Result.success();
    }
