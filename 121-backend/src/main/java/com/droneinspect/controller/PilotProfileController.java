...
public class PilotProfileController {
    ...
    @GetMapping("/page")
    public Result<IPage<PilotProfile>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody PilotProfile entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody PilotProfile entity) {
        service.save(entity);
        return Result.success();
    }
