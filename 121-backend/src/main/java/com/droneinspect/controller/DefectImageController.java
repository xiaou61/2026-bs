...
public class DefectImageController {
    ...
    @GetMapping("/page")
    public Result<IPage<DefectImage>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody DefectImage entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody DefectImage entity) {
        service.save(entity);
        return Result.success();
    }
