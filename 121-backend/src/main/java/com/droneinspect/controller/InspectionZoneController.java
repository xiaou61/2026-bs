...
import com.droneinspect.service.InspectionZoneService;
...
public class InspectionZoneController {
    private final AuthService authService;
    private final InspectionZoneService service;

    @GetMapping("/page")
    public Result<IPage<InspectionZone>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody InspectionZone entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody InspectionZone entity) {
        authService.assertAdminOrEngineer(role);
        service.save(entity);
        return Result.success();
    }
