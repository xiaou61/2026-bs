...
import com.vehicleclaim.service.AccidentReportService;
...
public class AccidentReportController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<AccidentReport>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody AccidentReport entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody AccidentReport entity) {
        authService.assertAdminOrApplicant(role);
        service.save(entity);
        return Result.success();
    }
