...
import com.smartwarehouse.service.TaskRouteService;
...
public class TaskRouteController {
    ...
    private final TaskRouteService service;

    @GetMapping("/page")
    public Result<PageInfo<TaskRoute>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody TaskRoute entity) {
        authService.assertAdminOrDispatcher(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody TaskRoute entity) {
        authService.assertAdminOrDispatcher(role);
        service.save(entity);
        return Result.success();
    }
