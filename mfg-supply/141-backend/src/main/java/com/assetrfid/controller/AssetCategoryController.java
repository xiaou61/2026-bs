...
import com.assetrfid.service.AssetCategoryService;
...
public class AssetCategoryController {
    ...
    @GetMapping("/page")
    public Result<IPage<AssetCategory>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody AssetCategory entity) {
        authService.assertAdminOrAssetAdmin(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody AssetCategory entity) {
        authService.assertAdminOrAssetAdmin(role);
        service.save(entity);
        return Result.success();
    }
