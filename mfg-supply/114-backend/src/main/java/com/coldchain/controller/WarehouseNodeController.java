...
import com.coldchain.service.WarehouseNodeService;
...
public class WarehouseNodeController {
    ...
    private final WarehouseNodeService service;

    @GetMapping("/page")
    public Result<PageInfo<WarehouseNode>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody WarehouseNode entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody WarehouseNode entity) {
        authService.assertAdmin(role);
        service.save(entity);
        return Result.success();
    }
