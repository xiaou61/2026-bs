...
import com.twinpark.service.DefectReportService;
...
public class DefectReportController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<DefectReport>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody DefectReport entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody DefectReport entity) {
        authService.assertAdminOrInspector(role);
        service.save(entity);
        return Result.success();
    }
