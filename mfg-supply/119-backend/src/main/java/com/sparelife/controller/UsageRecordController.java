...
public class UsageRecordController {
    ...
    @GetMapping("/page")
    public Result<IPage<UsageRecord>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody UsageRecord entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody UsageRecord entity) {
        authService.assertAdminOrMaintainer(role);
        service.save(entity);
        return Result.success();
    }
    ...
    public Result<Void> replace(@RequestAttribute String role, @PathVariable Long id) {
        authService.assertAdminOrMaintainer(role);
    ...
    @PutMapping("/scrap/{id}")
    public Result<Void> scrap(@RequestAttribute String role, @PathVariable Long id) {
        authService.assertAdminOrMaintainer(role);
