...
import com.droneinspect.service.FlightRouteService;
...
public class FlightRouteController {
    ...
    @GetMapping("/page")
    public Result<IPage<FlightRoute>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody FlightRoute entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody FlightRoute entity) {
        authService.assertAdminOrEngineer(role);
        service.save(entity);
        return Result.success();
    }
