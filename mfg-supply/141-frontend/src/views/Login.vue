  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">固定资产RFID盘点与借用</h2>
        <p class="subtitle">面向固定资产管理场景的RFID盘点、借用归还、维修折旧和预警通知协同平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>assetadmin / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>borrower / 123456</el-tag>
          <el-tag type="info" effect="plain" round>auditor / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: assetGradient 4s linear infinite;
}

@keyframes assetGradient {
