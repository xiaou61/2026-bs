<template>
  <el-card>
    <div class="bar">
      <el-input-number v-model="query.serviceId" :min="1" placeholder="任务ID" style="width: 160px" />
      <el-button type="primary" @click="loadData">查询</el-button>
    </div>
    <el-table :data="tableData" v-loading="loading">
      <el-table-column prop="id" label="ID" width="80" />
      <el-table-column prop="orderId" label="执行工单ID" width="100" />
      <el-table-column prop="serviceId" label="任务ID" width="100" />
...
const tableData = ref([])
const total = ref(0)
const query = reactive({ pageNum: 1, pageSize: 10, serviceId: null })
