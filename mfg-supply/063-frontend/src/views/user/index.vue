<template>
  ...
  <el-dialog v-model="dialogVisible" :title="form.id ? '编辑用户' : '新增用户'" width="540px">
    <el-form ref="formRef" :model="form" :rules="rules" label-width="80px">
      ...
      <el-form-item label="角色"><el-select v-model="form.role" style="width: 100%"><el-option label="管理员" value="ADMIN" /><el-option label="业务人员" value="STAFF" /></el-select></el-form-item>
...
const openAdd = () => {
  Object.assign(form, { id: null, username: '', password: '', nickname: '', phone: '', email: '', role: 'STAFF', status: 1 })
