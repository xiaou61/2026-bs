  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">物流园区车辆入场预约与道口调度</h2>
        <p class="subtitle">面向物流园区场景的车辆预约、门禁签到、道口排队、装卸任务和周转统计协同管理平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="warning" effect="plain" round>gatekeeper / 123456</el-tag>
          <el-tag type="info" effect="plain" round>yardmaster / 123456</el-tag>
          <el-tag type="danger" effect="plain" round>carrier / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: logisticsGradient 4s linear infinite;
}

@keyframes logisticsGradient {
