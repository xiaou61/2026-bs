  ...
  <div class="page-container">
    <el-card>
      <div class="search-bar">
        <el-input v-model="query.name" placeholder="区域名称" clearable />
      ...
      <el-table :data="tableData" v-loading="loading">
        <el-table-column prop="areaNo" label="区域编号" min-width="140" />
    ...
    <el-dialog v-model="dialogVisible" :title="form.id ? '编辑区域' : '新增区域'" width="620px">
      <el-form :model="form" :rules="rules" ref="formRef" label-width="90px">
        <el-form-item label="区域编号" prop="areaNo">
          <el-input v-model="form.areaNo" />
        </el-form-item>
...
import { deleteArea, getAreaList, saveArea } from '../../api'
...
const rules = {
  areaNo: [{ required: true, message: '请输入区域编号', trigger: 'blur' }],
