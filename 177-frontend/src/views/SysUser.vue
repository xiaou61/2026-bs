<template><DataPage title="账号权限" description="基地运营、主播、选品专员、样品管理员、商家代表账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
