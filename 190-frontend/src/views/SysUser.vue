<template><DataPage title="账号权限" description="物业管理员、访修调度员、维修技师、设备巡检员、入驻用户账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
