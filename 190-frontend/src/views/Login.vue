  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">智慧楼宇访修协同与设备保养</h2>
        <p class="subtitle">面向楼宇物业场景的设备巡检、维修派单、保养提醒、备件管理和租户反馈一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="info" effect="plain" round>tenant / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: buildingGradient 4s linear infinite;
}
