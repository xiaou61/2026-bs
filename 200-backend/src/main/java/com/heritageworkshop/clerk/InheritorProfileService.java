...
public class InheritorProfileService {
    private final InheritorProfileMapper mapper;

    public PageInfo<InheritorProfile> page(Integer pageNum, Integer pageSize, String keyword, String status) {
