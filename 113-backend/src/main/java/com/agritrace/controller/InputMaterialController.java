...
public class InputMaterialController {
    ...
    @GetMapping("/page")
    public Result<IPage<InputMaterial>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody InputMaterial entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody InputMaterial entity) {
        service.save(entity);
        return Result.success();
    }
