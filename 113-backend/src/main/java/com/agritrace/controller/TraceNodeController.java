...
public class TraceNodeController {
    ...
    @GetMapping("/page")
    public Result<IPage<TraceNode>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody TraceNode entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody TraceNode entity) {
        service.save(entity);
        return Result.success();
    }
