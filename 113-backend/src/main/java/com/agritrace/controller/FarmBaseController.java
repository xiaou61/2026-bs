...
public class FarmBaseController {
    ...
    @GetMapping("/page")
    public Result<IPage<FarmBase>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody FarmBase entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody FarmBase entity) {
        authService.assertAdminOrFarmer(role);
        service.save(entity);
        return Result.success();
    }
