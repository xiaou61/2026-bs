...
public class PlantingRecordController {
    ...
    @GetMapping("/page")
    public Result<IPage<PlantingRecord>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody PlantingRecord entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody PlantingRecord entity) {
        authService.assertAdminOrFarmer(role);
        service.save(entity);
        return Result.success();
    }
