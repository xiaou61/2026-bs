...
import com.kindergarten.service.TermService;
...
public class TermController {
    ...
    @GetMapping("/list")
    public Result<PageInfo<SchoolTerm>> list(@RequestParam(defaultValue = "1") Integer pageNum,
    ...
    @GetMapping("/enabled")
    public Result<List<SchoolTerm>> enabled() {
        return Result.success(termService.enabledList());
    }

    @PostMapping("/add")
    public Result<String> add(@RequestBody SchoolTerm entity, @RequestAttribute("role") String role) {
        termService.add(entity, role);
        return Result.success();
    }

    @PutMapping("/update")
    public Result<String> update(@RequestBody SchoolTerm entity, @RequestAttribute("role") String role) {
