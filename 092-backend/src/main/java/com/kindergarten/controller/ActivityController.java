...
import com.kindergarten.service.ActivityService;
...
public class ActivityController {
    ...
    @Autowired
    private ActivityService courseService;

    @GetMapping("/list")
    public Result<PageInfo<ActivityInfo>> list(@RequestParam(defaultValue = "1") Integer pageNum,
    ...
    @GetMapping("/enabled")
    public Result<List<ActivityInfo>> enabled() {
        return Result.success(courseService.enabledList());
    }

    @PostMapping("/add")
    public Result<String> add(@RequestBody ActivityInfo entity, @RequestAttribute("role") String role) {
        courseService.add(entity, role);
        return Result.success();
    }

    @PutMapping("/update")
    public Result<String> update(@RequestBody ActivityInfo entity, @RequestAttribute("role") String role) {
