...
import com.accessibletravel.service.AssistRequestService;
...
public class AssistRequestController {
    ...
    private final AssistRequestService service;

    @GetMapping("/page")
    public Result<PageInfo<AssistRequest>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody AssistRequest entity) {
        authService.assertAdminOrTraveler(role);
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody AssistRequest entity) {
        authService.assertAdminOrTraveler(role);
        service.save(entity);
        return Result.success();
    }
