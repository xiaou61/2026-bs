...
public class RoutePlanController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<RoutePlan>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody RoutePlan entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody RoutePlan entity) {
        service.save(entity);
        return Result.success();
    }
