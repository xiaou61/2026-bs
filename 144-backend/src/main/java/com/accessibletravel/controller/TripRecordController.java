...
public class TripRecordController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<TripRecord>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody TripRecord entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody TripRecord entity) {
        service.save(entity);
        return Result.success();
    }
