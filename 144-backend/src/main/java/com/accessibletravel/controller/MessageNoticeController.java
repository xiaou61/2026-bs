...
public class MessageNoticeController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<MessageNotice>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody MessageNotice entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody MessageNotice entity) {
        service.save(entity);
        return Result.success();
    }
