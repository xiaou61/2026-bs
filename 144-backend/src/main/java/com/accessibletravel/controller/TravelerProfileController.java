...
public class TravelerProfileController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<TravelerProfile>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody TravelerProfile entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody TravelerProfile entity) {
        service.save(entity);
        return Result.success();
    }
