...
CREATE INDEX idx_enterprise_info_category ON enterprise_info(category_id);
CREATE INDEX idx_enterprise_info_seller ON enterprise_info(seller_id);
...
CREATE INDEX idx_info_process_user ON info_process(user_id);
CREATE INDEX idx_info_process_service ON info_process(service_id);
