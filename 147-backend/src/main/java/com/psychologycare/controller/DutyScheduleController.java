...
public class DutyScheduleController {
    ...
    @GetMapping("/page")
    public Result<IPage<DutySchedule>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody DutySchedule entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody DutySchedule entity) {
        service.save(entity);
        return Result.success();
    }
