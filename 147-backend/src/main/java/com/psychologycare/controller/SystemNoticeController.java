...
import com.psychologycare.service.SystemNoticeService;
...
public class SystemNoticeController {
    ...
    @GetMapping("/page")
    public Result<IPage<SystemNotice>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody SystemNotice entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody SystemNotice entity) {
        authService.assertAdminOrTeacherOrCounselor(role);
        service.save(entity);
        return Result.success();
    }
