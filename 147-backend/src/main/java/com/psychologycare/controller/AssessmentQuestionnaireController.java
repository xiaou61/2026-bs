...
public class AssessmentQuestionnaireController {
    ...
    @GetMapping("/page")
    public Result<IPage<AssessmentQuestionnaire>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody AssessmentQuestionnaire entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody AssessmentQuestionnaire entity) {
        service.save(entity);
        return Result.success();
    }
