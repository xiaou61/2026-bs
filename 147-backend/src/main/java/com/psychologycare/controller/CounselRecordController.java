...
public class CounselRecordController {
    ...
    @GetMapping("/page")
    public Result<IPage<CounselRecord>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody CounselRecord entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody CounselRecord entity) {
        service.save(entity);
        return Result.success();
    }
