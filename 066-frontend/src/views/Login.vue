      ...
      <el-tabs v-model="tab">
        ...
        <el-tab-pane label="注册" name="register">
          <el-form ref="regRef" :model="regForm" :rules="regRules">
            ...
            <el-button type="success" style="width: 100%" :loading="loading" @click="handleRegister">注册账号</el-button>
          </el-form>
        </el-tab-pane>
      </el-tabs>
    </el-card>
...
const handleLogin = async () => {
  ...
  try {
    ...
    router.push(res.data.user?.role === 'ADMIN' ? '/dashboard' : '/blog')
  } finally {
    loading.value = false
  }
}
...
.login-wrap {
  ...
  background: linear-gradient(130deg, #0f766e, #0284c7, #1d4ed8);
}
