...
public class ExamItemController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ExamItem>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ExamItem entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ExamItem entity) {
        service.save(entity);
        return Result.success();
    }
