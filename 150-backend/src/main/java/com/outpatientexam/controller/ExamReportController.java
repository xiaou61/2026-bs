...
public class ExamReportController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ExamReport>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ExamReport entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ExamReport entity) {
        service.save(entity);
        return Result.success();
    }
