...
public class DoctorProfileController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<DoctorProfile>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody DoctorProfile entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody DoctorProfile entity) {
        service.save(entity);
        return Result.success();
    }
