...
public class HospitalNoticeController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<HospitalNotice>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody HospitalNotice entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody HospitalNotice entity) {
        service.save(entity);
        return Result.success();
    }
