...
public class ReportDeliveryController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ReportDelivery>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ReportDelivery entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ReportDelivery entity) {
        service.save(entity);
        return Result.success();
    }
