...
public class ExamAppointmentController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ExamAppointment>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ExamAppointment entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ExamAppointment entity) {
        service.save(entity);
        return Result.success();
    }
