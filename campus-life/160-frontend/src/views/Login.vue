  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">校园社团活动预算报销与物资借用</h2>
        <p class="subtitle">面向高校社团管理的活动计划、预算申报、经费报销、物资借用和审批存档一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>union / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>club / 123456</el-tag>
          <el-tag type="info" effect="plain" round>treasurer / 123456</el-tag>
          <el-tag type="danger" effect="plain" round>member / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: clubGradient 4s linear infinite;
}
