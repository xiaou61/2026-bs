<template>
  <div class="login-container">
    ...
    <div class="bg-decoration">
      ...
      <div class="video-icon icon-1">🎬</div>
      <div class="video-icon icon-2">📹</div>
      <div class="video-icon icon-3">🎥</div>
    </div>
    ...
    <div class="login-box">
      ...
      <div class="login-header">
        ...
        <h1 class="login-title">校园短视频</h1>
        <p class="login-subtitle">Campus Video Platform</p>
      </div>
