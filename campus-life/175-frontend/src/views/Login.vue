  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">校园图书漂流借阅与读书打卡</h2>
        <p class="subtitle">面向高校图书馆场景的图书漂流、借阅管理、读书打卡、笔记分享和积分勋章一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>library / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>student / 123456</el-tag>
          <el-tag type="info" effect="plain" round>teacher / 123456</el-tag>
        </div>
      </div>

      <div class="book-tips">
        <span>📖 书中自有黄金屋 · 阅读点亮人生 📖</span>
      </div>
    </el-card>
  </div>
</template>
...
.login {
  ...
  align-items: center;
  background: linear-gradient(135deg, #667eea 0%, #764ba2 30%, #f093fb 60%, #a78bfa 100%);
  position: relative;
  overflow: hidden;
}
...
.login-card::before {
  ...
  right: 0;
  height: 6px;
  background: linear-gradient(90deg, #667eea, #764ba2, #f093fb, #a78bfa, #667eea);
  background-size: 400% 100%;
  animation: bookGradient 5s linear infinite;
}
