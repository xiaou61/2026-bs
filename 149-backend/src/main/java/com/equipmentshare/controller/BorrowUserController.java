...
import com.equipmentshare.service.BorrowUserService;
...
@RestController
@RequestMapping("/api/borrow-user")
@RequiredArgsConstructor
public class BorrowUserController {
    private final AuthService authService;
    private final BorrowUserService service;

    @GetMapping("/page")
    public Result<IPage<BorrowUser>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody BorrowUser entity) {
        authService.assertAdminOrTeacherOrManager(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody BorrowUser entity) {
        authService.assertAdminOrTeacherOrManager(role);
        service.save(entity);
        return Result.success();
    }
