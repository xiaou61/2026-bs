...
public class EquipmentCategoryController {
    ...
    @GetMapping("/page")
    public Result<IPage<EquipmentCategory>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody EquipmentCategory entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody EquipmentCategory entity) {
        service.save(entity);
        return Result.success();
    }
