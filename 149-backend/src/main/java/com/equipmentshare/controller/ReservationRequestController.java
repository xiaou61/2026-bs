...
public class ReservationRequestController {
    ...
    @GetMapping("/page")
    public Result<IPage<ReservationRequest>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ReservationRequest entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ReservationRequest entity) {
        service.save(entity);
        return Result.success();
    }
