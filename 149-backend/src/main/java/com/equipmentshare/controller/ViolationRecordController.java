...
public class ViolationRecordController {
    ...
    @GetMapping("/page")
    public Result<IPage<ViolationRecord>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ViolationRecord entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ViolationRecord entity) {
        service.save(entity);
        return Result.success();
    }
