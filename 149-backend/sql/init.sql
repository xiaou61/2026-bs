...
('trainer', '123456', '实验教师', 'TRAINER', '企业大学', '139139000200', 'trainer@demo.local', 1, NOW(), NOW()),
('employee', '123456', '学生使用者', 'EMPLOYEE', '业务部门', '139139000300', 'employee@demo.local', 1, NOW(), NOW()),
('manager', '123456', '设备管理员', 'MANAGER', '管理中心', '139139000400', 'manager@demo.local', 1, NOW(), NOW());
...
('SUP-133-001', '供应商名称一', '状态标签一', '139133000101', '资质等级一', 'ACTIVE', NOW(), NOW()),
('SUP-133-002', '供应商名称二', '状态标签二', '139133000201', '资质等级二', 'ACTIVE', NOW(), NOW());
