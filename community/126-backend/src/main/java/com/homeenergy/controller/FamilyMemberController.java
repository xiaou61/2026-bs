...
import com.homeenergy.service.FamilyMemberService;
...
public class FamilyMemberController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<FamilyMember>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody FamilyMember entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody FamilyMember entity) {
        authService.assertAdminOrResident(role);
        service.save(entity);
        return Result.success();
    }
