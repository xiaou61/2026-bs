...
public class DeviceUsageController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<DeviceUsage>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody DeviceUsage entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody DeviceUsage entity) {
        authService.assertAdminOrResidentOrAnalyst(role);
        service.save(entity);
        return Result.success();
    }
