  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">社区家政服务预约与人员信用</h2>
        <p class="subtitle">面向社区家政场景的服务预约、派单调度、服务记录、信用评价和结算管理一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="warning" effect="plain" round>worker / 123456</el-tag>
          <el-tag type="info" effect="plain" round>resident / 123456</el-tag>
        </div>
      </div>

      <div class="homcare-tips">
        <span>🏠 贴心家政 · 服务到家 🏠</span>
      </div>
    </el-card>
  </div>
...
.login-card::before {
  ...
  animation: homecareGradient 4s linear infinite;
}

@keyframes homecareGradient {
