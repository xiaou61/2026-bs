<template><DataPage title="账号权限" description="中心管理员、托管老师、家长、安全员、保健老师账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
