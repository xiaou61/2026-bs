...
import com.timebank.service.CommunityActivityService;
...
public class CommunityActivityController {
    ...
    @GetMapping("/page")
    public Result<IPage<CommunityActivity>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody CommunityActivity entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody CommunityActivity entity) {
        authService.assertAdminOrManager(role);
        service.save(entity);
        return Result.success();
    }
