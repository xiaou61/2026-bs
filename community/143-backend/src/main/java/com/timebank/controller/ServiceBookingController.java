...
public class ServiceBookingController {
    ...
    @GetMapping("/page")
    public Result<IPage<ServiceBooking>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ServiceBooking entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ServiceBooking entity) {
        authService.assertAdminOrResident(role);
        service.save(entity);
        return Result.success();
    }
