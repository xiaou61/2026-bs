  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">社区公益时间银行互助</h2>
        <p class="subtitle">面向社区互助服务场景的居民预约、志愿服务、时长兑换、公益活动和站点协同管理平台</p>
      </div>
...
.login-card::before {
  ...
  animation: timeGradient 4s linear infinite;
}
