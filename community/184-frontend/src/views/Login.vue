  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">停车场月租合同续费与异常占位</h2>
        <p class="subtitle">面向停车场运营场景的月租合同、续费提醒、车位检查、异常占位和服务工单一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>parking / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>tenant / 123456</el-tag>
          <el-tag type="info" effect="plain" round>patrol / 123456</el-tag>
        </div>
      </div>

      <div class="parking-tips">
        <span>🅿️ 智慧停车 · 便捷出行 🅿️</span>
      </div>
    </el-card>
  </div>
</template>
...
.login-card::before {
  ...
  animation: parkGradient 4s linear infinite;
}

@keyframes parkGradient {
