  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">社区垃圾分类督导与积分兑换</h2>
        <p class="subtitle">面向社区治理场景的分类督导、签到积分、兑换商城、楼宇排名和整改任务协同管理平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>community / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>resident / 123456</el-tag>
          <el-tag type="info" effect="plain" round>volunteer / 123456</el-tag>
        </div>
      </div>

      <div class="eco-tips">
        <span>♻️ 垃圾分类 · 从我做起 ♻️</span>
      </div>
    </el-card>
  </div>
</template>
...
.login-card::before {
  ...
  animation: ecoGradient 4s linear infinite;
}
