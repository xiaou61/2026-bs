...
import com.eldercare.service.HealthAssessmentService;
...
public class HealthAssessmentController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<HealthAssessment>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody HealthAssessment entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody HealthAssessment entity) {
        authService.assertAdminOrConsultantOrCaregiver(role);
        service.save(entity);
        return Result.success();
    }
