...
public class ElderProfileController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ElderProfile>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ElderProfile entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ElderProfile entity) {
        authService.assertAdminOrConsultant(role);
        service.save(entity);
        return Result.success();
    }
