<template><DataPage title="账号权限" description="物业管理员、业主住户、派单员、维修人员、财务客服账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
