  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">物业报修派单与服务满意度评价</h2>
        <p class="subtitle">面向物业管理场景的报修受理、派单维修、上门服务、费用登记和满意度评价一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>property / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>owner / 123456</el-tag>
          <el-tag type="info" effect="plain" round>worker / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: propertyGradient 4s linear infinite;
}

@keyframes propertyGradient {
