...
public class SettlementDetailController {
    ...
    @GetMapping("/page")
    public Result<IPage<SettlementDetail>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody SettlementDetail entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody SettlementDetail entity) {
        service.save(entity);
        return Result.success();
    }
