...
public class UserCouponController {
    ...
    @GetMapping("/page")
    public Result<IPage<UserCoupon>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody UserCoupon entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody UserCoupon entity) {
        authService.assertAdmin(role);
        service.save(entity);
        return Result.success();
    }
    ...
    @PutMapping("/use/{id}")
    public Result<Void> use(@RequestAttribute String role, @PathVariable Long id) {
        authService.assertAdminOrCashier(role);
