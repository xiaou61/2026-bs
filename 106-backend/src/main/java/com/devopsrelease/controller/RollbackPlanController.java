...
import com.devopsrelease.service.RollbackPlanService;
...
@RestController
@RequestMapping("/api/rollback-plan")
@RequiredArgsConstructor
public class RollbackPlanController {
    private final RollbackPlanService service;
    private final AuthService authService;

    @GetMapping("/page")
    public Result<PageInfo<RollbackPlan>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody RollbackPlan entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody RollbackPlan entity) {
        authService.assertAdminOrReleaseOrOps(role);
        service.save(entity);
        return Result.success();
    }
