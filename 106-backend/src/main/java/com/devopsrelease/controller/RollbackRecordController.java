...
public class RollbackRecordController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<RollbackRecord>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody RollbackRecord entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody RollbackRecord entity) {
        service.save(entity);
        return Result.success();
    }
