...
public class ReleasePlanController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ReleasePlan>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ReleasePlan entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ReleasePlan entity) {
        service.save(entity);
        return Result.success();
    }
