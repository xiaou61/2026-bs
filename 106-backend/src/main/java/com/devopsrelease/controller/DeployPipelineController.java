...
public class DeployPipelineController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<DeployPipeline>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody DeployPipeline entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody DeployPipeline entity) {
        service.save(entity);
        return Result.success();
    }
