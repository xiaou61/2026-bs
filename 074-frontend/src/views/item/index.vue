<template>
  <el-card>
    <div class="bar">
      <el-input v-model="query.title" placeholder="商品标题" style="width: 200px" clearable />
      <el-input v-model="query.craftName" placeholder="工艺名称" style="width: 160px" clearable />
      ...
      <el-button type="success" @click="openAdd">发布作品</el-button>
    </div>
  ...
  <el-dialog v-model="dialogVisible" :title="form.id ? '编辑商品' : '发布作品'" width="680px">
    <el-form ref="formRef" :model="form" :rules="rules" label-width="90px">
      ...
      <el-form-item label="工艺名称" prop="craftName"><el-input v-model="form.craftName" maxlength="80" show-word-limit /></el-form-item>
      <el-form-item label="作坊"><el-input v-model="form.workshopName" maxlength="80" show-word-limit /></el-form-item>
      <el-form-item label="工艺类型"><el-input v-model="form.craftType" maxlength="40" show-word-limit /></el-form-item>
      <el-form-item label="配送方式"><el-input v-model="form.deliveryType" maxlength="30" show-word-limit /></el-form-item>
...
const query = reactive({ pageNum: 1, pageSize: 10, title: '', craftName: '', categoryId: null, status: null })
const form = reactive({})
...
const rules = {
  ...
  craftName: [
    ...
    { max: 80, message: '工艺名称不能超过80字符', trigger: 'blur' }
  ],
  price: [
...
const openAdd = () => {
  Object.assign(form, { id: null, title: '', categoryId: null, craftName: '', workshopName: '', craftType: '', deliveryType: '', cover: '', price: 1, stock: 1, status: 1, description: '' })
