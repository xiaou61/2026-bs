<template>
  <el-card>
    <div class="bar">
      ...
      <el-input v-model="query.craftName" placeholder="工艺名" style="width: 160px" clearable />
    ...
    <el-table :data="tableData" v-loading="loading">
      ...
      <el-table-column prop="workshopName" label="作坊" width="120" />
  ...
  <el-dialog v-model="detailVisible" title="商品详情" width="720px">
    <el-descriptions :column="2" border>
      ...
      <el-descriptions-item label="工艺名">{{ detail.craftName }}</el-descriptions-item>
      <el-descriptions-item label="作坊">{{ detail.workshopName }}</el-descriptions-item>
      <el-descriptions-item label="类型">{{ detail.craftType }}</el-descriptions-item>
...
const query = reactive({ pageNum: 1, pageSize: 10, title: '', craftName: '', categoryId: null })
