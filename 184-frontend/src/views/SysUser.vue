<template><DataPage title="账号权限" description="停车场管理员、收费财务、巡检员、月租车主、客服专员账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
