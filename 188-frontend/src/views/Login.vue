  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">医疗护理培训签到考核与技能档案</h2>
        <p class="subtitle">面向医疗机构场景的培训计划、签到考核、技能评估、证书归档和续训提醒一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>edu / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>nurse / 123456</el-tag>
          <el-tag type="info" effect="plain" round>hr / 123456</el-tag>
        </div>
      </div>

      <div class="nurse-tips">
        <span>👩‍⚕️ 护理培训 · 技能提升 👩‍⚕️</span>
      </div>
    </el-card>
  </div>
</template>
...
.login-card::before {
  ...
  animation: nurseGradient 4s linear infinite;
}

@keyframes nurseGradient {
