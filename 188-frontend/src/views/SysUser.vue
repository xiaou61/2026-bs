<template><DataPage title="账号权限" description="护理培训管理员、带教老师、考核老师、护理人员、护理人事账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
