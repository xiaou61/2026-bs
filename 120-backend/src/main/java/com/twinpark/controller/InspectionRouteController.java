...
public class InspectionRouteController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<InspectionRoute>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody InspectionRoute entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody InspectionRoute entity) {
        service.save(entity);
        return Result.success();
    }
