...
import com.twinpark.service.ParkBuildingService;
...
public class ParkBuildingController {
    ...
    private final ParkBuildingService service;

    @GetMapping("/page")
    public Result<PageInfo<ParkBuilding>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ParkBuilding entity) {
        authService.assertAdminOrManager(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ParkBuilding entity) {
        authService.assertAdminOrManager(role);
        service.save(entity);
        return Result.success();
    }
