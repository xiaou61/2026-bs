...
import com.twinpark.service.InspectionRecordService;
...
public class InspectionRecordController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<InspectionRecord>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody InspectionRecord entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody InspectionRecord entity) {
        authService.assertAdminOrInspector(role);
        service.save(entity);
        return Result.success();
    }
