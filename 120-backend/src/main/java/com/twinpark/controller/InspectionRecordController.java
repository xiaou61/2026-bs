...
public class InspectionRecordController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<InspectionRecord>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody InspectionRecord entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody InspectionRecord entity) {
        service.save(entity);
        return Result.success();
    }
