  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">社区养老服务派单与健康随访</h2>
        <p class="subtitle">面向社区养老场景的服务派单、上门照护、健康随访和预警联动一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>consultant / 123456</el-tag>
...
.login-card::before {
  ...
  animation: careGradient 4s linear infinite;
}

@keyframes careGradient {
