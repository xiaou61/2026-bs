<template>
  <DataPage title="双选确认" description="确认编号、护理人员编号、确认结果、导师姓名、确认意见和状态维护" :api="api" :columns="columns" :form-fields="formFields" :row-actions="rowActions" :defaults="defaults" @row-action="handleAction" />
</template>
