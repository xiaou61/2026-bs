<template>
  <el-card>
    <div class="bar">
      ...
      <el-input v-model="query.gameName" placeholder="游戏名称" style="width: 160px" clearable />
      ...
      <el-button type="success" @click="openAdd">发布商品</el-button>
    </div>
  ...
  <el-dialog v-model="dialogVisible" :title="form.id ? '编辑商品' : '发布商品'" width="680px">
    <el-form ref="formRef" :model="form" :rules="rules" label-width="90px">
      ...
      <el-form-item label="游戏名称" prop="gameName"><el-input v-model="form.gameName" maxlength="80" show-word-limit /></el-form-item>
      <el-form-item label="服务器"><el-input v-model="form.serverName" maxlength="80" show-word-limit /></el-form-item>
      <el-form-item label="商品类型"><el-input v-model="form.itemType" maxlength="40" show-word-limit /></el-form-item>
      <el-form-item label="交易模式"><el-input v-model="form.tradeMode" maxlength="30" show-word-limit /></el-form-item>
...
const query = reactive({ pageNum: 1, pageSize: 10, title: '', gameName: '', categoryId: null, status: null })
const form = reactive({})
...
const rules = {
  ...
  gameName: [
    ...
    { max: 80, message: '游戏名称不能超过80字符', trigger: 'blur' }
  ],
  price: [
...
const openAdd = () => {
  Object.assign(form, { id: null, title: '', categoryId: null, gameName: '', serverName: '', itemType: '', tradeMode: '', cover: '', price: 1, stock: 1, status: 1, description: '' })
