...
public class TopicApplicationController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<TopicApplication>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody TopicApplication entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody TopicApplication entity) {
        service.save(entity);
        return Result.success();
    }
