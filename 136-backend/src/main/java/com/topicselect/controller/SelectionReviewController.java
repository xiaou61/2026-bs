...
import com.topicselect.service.SelectionReviewService;
...
public class SelectionReviewController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<SelectionReview>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody SelectionReview entity) {
        authService.assertAdminOrTeacherOrAffairs(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody SelectionReview entity) {
        authService.assertAdminOrTeacherOrAffairs(role);
        service.save(entity);
        return Result.success();
    }
