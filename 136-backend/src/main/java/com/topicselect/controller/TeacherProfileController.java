...
import com.topicselect.service.TeacherProfileService;
...
public class TeacherProfileController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<TeacherProfile>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody TeacherProfile entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody TeacherProfile entity) {
        authService.assertAdminOrTeacherOrAffairs(role);
        service.save(entity);
        return Result.success();
    }
