...
public class GuidanceMeetingController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<GuidanceMeeting>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody GuidanceMeeting entity) {
        authService.assertAdminOrTeacherOrAffairs(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody GuidanceMeeting entity) {
        authService.assertAdminOrTeacherOrAffairs(role);
        service.save(entity);
        return Result.success();
    }
