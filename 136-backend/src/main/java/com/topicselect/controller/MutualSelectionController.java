...
public class MutualSelectionController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<MutualSelection>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody MutualSelection entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody MutualSelection entity) {
        service.save(entity);
        return Result.success();
    }
