...
public class ProposalRecordController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ProposalRecord>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ProposalRecord entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ProposalRecord entity) {
        service.save(entity);
        return Result.success();
    }
