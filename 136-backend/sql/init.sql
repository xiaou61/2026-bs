DROP DATABASE IF EXISTS topic_selection_136;
CREATE DATABASE topic_selection_136 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE topic_selection_136;
...
('teacher', '123456', '导师', 'TEACHER', '指导教师组', '139136000200', 'teacher@demo.local', 1, NOW(), NOW()),
('student', '123456', '学生', 'STUDENT', '毕业班', '139136000300', 'student@demo.local', 1, NOW(), NOW()),
('affairs', '123456', '教务管理员', 'AFFAIRS', '教务处', '139136000400', 'affairs@demo.local', 1, NOW(), NOW());
