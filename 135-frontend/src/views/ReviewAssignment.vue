...
import { getReviewAssignmentPage, addReviewAssignment, updateReviewAssignment, deleteReviewAssignment, submitReviewAssignment, approveReviewAssignment } from '../api'
const api = { page: getReviewAssignmentPage, add: addReviewAssignment, update: updateReviewAssignment, delete: deleteReviewAssignment }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'submit') await submitReviewAssignment(row.id)
  if (command === 'approve') await approveReviewAssignment(row.id)
