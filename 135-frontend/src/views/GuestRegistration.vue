...
import { getGuestRegistrationPage, addGuestRegistration, updateGuestRegistration, deleteGuestRegistration, submitGuestRegistration, approveGuestRegistration } from '../api'
const api = { page: getGuestRegistrationPage, add: addGuestRegistration, update: updateGuestRegistration, delete: deleteGuestRegistration }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'submit') await submitGuestRegistration(row.id)
  if (command === 'approve') await approveGuestRegistration(row.id)
