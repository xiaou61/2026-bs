...
import { getBlindReviewPage, addBlindReview, updateBlindReview, deleteBlindReview, processBlindReview, finishBlindReview } from '../api'
const api = { page: getBlindReviewPage, add: addBlindReview, update: updateBlindReview, delete: deleteBlindReview }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'process') await processBlindReview(row.id)
  if (command === 'finish') await finishBlindReview(row.id)
