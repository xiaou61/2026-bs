...
import { getConferenceInfoPage, addConferenceInfo, updateConferenceInfo, deleteConferenceInfo, activateConferenceInfo, finishConferenceInfo } from '../api'
const api = { page: getConferenceInfoPage, add: addConferenceInfo, update: updateConferenceInfo, delete: deleteConferenceInfo }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'activate') await activateConferenceInfo(row.id)
  if (command === 'finish') await finishConferenceInfo(row.id)
