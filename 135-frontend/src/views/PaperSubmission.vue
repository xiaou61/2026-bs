...
import { getPaperSubmissionPage, addPaperSubmission, updatePaperSubmission, deletePaperSubmission, processPaperSubmission, finishPaperSubmission } from '../api'
const api = { page: getPaperSubmissionPage, add: addPaperSubmission, update: updatePaperSubmission, delete: deletePaperSubmission }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'process') await processPaperSubmission(row.id)
  if (command === 'finish') await finishPaperSubmission(row.id)
