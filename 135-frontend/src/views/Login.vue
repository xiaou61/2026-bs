  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">学术会议投稿评审与日程</h2>
        <p class="subtitle">面向学术会议场景的投稿管理、论文盲审、录用通知与会议排期平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="warning" effect="plain" round>reviewer / 123456</el-tag>
          <el-tag type="info" effect="plain" round>secretary / 123456</el-tag>
        </div>
      </div>

      <div class="conference-tips">
        <span>🎓 学术交流 · 知识共享 🎓</span>
      </div>
    </el-card>
  </div>
...
.deco-4 { top: 50%; right: 10%; animation-delay: 1s; font-size: 64px; }
...
.login-card::before {
  ...
  animation: conferenceGradient 4s linear infinite;
}

@keyframes conferenceGradient {
...
.login-form :deep(.el-input__wrapper) {
  ...
  box-shadow: 0 2px 12px rgba(74, 20, 140, 0.08) !important;
  padding: 4px 12px;
  transition: all 0.3s ease;
}

.login-form :deep(.el-input__wrapper:hover) {
  box-shadow: 0 4px 16px rgba(74, 20, 140, 0.15) !important;
}

.login-form :deep(.el-input__wrapper.is-focus) {
  box-shadow: 0 4px 20px rgba(74, 20, 140, 0.25) !important;
}
...
.submit-btn {
  ...
  box-shadow: 0 8px 24px rgba(74, 20, 140, 0.3) !important;
...
.submit-btn:hover {
  ...
  box-shadow: 0 12px 32px rgba(74, 20, 140, 0.4) !important;
}
