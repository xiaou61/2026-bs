...
import { getCheckinRecordPage, addCheckinRecord, updateCheckinRecord, deleteCheckinRecord, processCheckinRecord, finishCheckinRecord } from '../api'
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'process') await processCheckinRecord(row.id)
  if (command === 'finish') await finishCheckinRecord(row.id)
