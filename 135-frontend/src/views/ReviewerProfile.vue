...
import { getReviewerProfilePage, addReviewerProfile, updateReviewerProfile, deleteReviewerProfile, submitReviewerProfile, approveReviewerProfile } from '../api'
const api = { page: getReviewerProfilePage, add: addReviewerProfile, update: updateReviewerProfile, delete: deleteReviewerProfile }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'submit') await submitReviewerProfile(row.id)
  if (command === 'approve') await approveReviewerProfile(row.id)
