...
import { getAuthorProfilePage, addAuthorProfile, updateAuthorProfile, deleteAuthorProfile, activateAuthorProfile, finishAuthorProfile } from '../api'
const api = { page: getAuthorProfilePage, add: addAuthorProfile, update: updateAuthorProfile, delete: deleteAuthorProfile }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'activate') await activateAuthorProfile(row.id)
  if (command === 'finish') await finishAuthorProfile(row.id)
