...
import com.greenhouse.service.EnvironmentSensorService;
...
public class EnvironmentSensorController {
    ...
    private final EnvironmentSensorService service;

    @GetMapping("/page")
    public Result<PageInfo<EnvironmentSensor>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody EnvironmentSensor entity) {
        authService.assertAdminOrTechnicianOrManager(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody EnvironmentSensor entity) {
        authService.assertAdminOrTechnicianOrManager(role);
        service.save(entity);
        return Result.success();
    }
