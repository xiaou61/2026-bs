...
import com.greenhouse.service.ControlDeviceService;
...
public class ControlDeviceController {
    ...
    private final ControlDeviceService service;

    @GetMapping("/page")
    public Result<PageInfo<ControlDevice>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ControlDevice entity) {
        authService.assertAdminOrTechnicianOrManager(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ControlDevice entity) {
        authService.assertAdminOrTechnicianOrManager(role);
        service.save(entity);
        return Result.success();
    }
