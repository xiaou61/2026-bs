...
import com.greenhouse.service.EnvironmentReadingService;
...
public class EnvironmentReadingController {
    ...
    private final EnvironmentReadingService service;

    @GetMapping("/page")
    public Result<PageInfo<EnvironmentReading>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody EnvironmentReading entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody EnvironmentReading entity) {
        authService.assertAdminOrTechnicianOrManager(role);
        service.save(entity);
        return Result.success();
    }
