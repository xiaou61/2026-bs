  ...
  <div class="login-container">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">垃圾回收服务系统</h2>
        <p class="subtitle">绿色回收 · 美丽家园</p>
      </div>
      ...
      <el-form :model="form" :rules="rules" ref="formRef" class="login-form">
        ...
        <el-form-item>
          <el-button type="success" @click="handleLogin" :loading="loading" size="large" class="submit-btn">
      ...
      <div class="register-section">
        ...
        <router-link to="/register" class="register-link">
          <el-icon><UserFilled /></el-icon> 居民注册
        </router-link>
      </div>
...
.deco-4 { top: 50%; right: 10%; animation-delay: 1s; font-size: 36px; }
