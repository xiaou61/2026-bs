  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">水产养殖环境监测</h2>
        <p class="subtitle">面向智慧农业的水质监测、投喂预警、病害处置和产量统计平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>breeder / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>technician / 123456</el-tag>
          <el-tag type="info" effect="plain" round>manager / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: aquaGradient 4s linear infinite;
}
