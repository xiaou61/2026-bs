...
public class WaterQualityReadingController {
    ...
    @GetMapping("/page")
    public Result<IPage<WaterQualityReading>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody WaterQualityReading entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody WaterQualityReading entity) {
        authService.assertAdminOrBreederOrTechnician(role);
        service.save(entity);
        return Result.success();
    }
