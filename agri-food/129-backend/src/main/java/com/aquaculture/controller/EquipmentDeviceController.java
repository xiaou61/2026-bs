...
import com.aquaculture.service.EquipmentDeviceService;
...
public class EquipmentDeviceController {
    ...
    private final EquipmentDeviceService service;

    @GetMapping("/page")
    public Result<IPage<EquipmentDevice>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody EquipmentDevice entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody EquipmentDevice entity) {
        authService.assertAdminOrTechnician(role);
        service.save(entity);
        return Result.success();
    }
