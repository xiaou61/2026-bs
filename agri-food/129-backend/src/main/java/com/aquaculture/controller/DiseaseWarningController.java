...
import com.aquaculture.service.DiseaseWarningService;
...
public class DiseaseWarningController {
    ...
    private final DiseaseWarningService service;

    @GetMapping("/page")
    public Result<IPage<DiseaseWarning>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody DiseaseWarning entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody DiseaseWarning entity) {
        authService.assertAdminOrBreederOrTechnician(role);
        service.save(entity);
        return Result.success();
    }
