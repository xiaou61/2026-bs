...
import com.aquaculture.service.FishBatchService;
...
public class FishBatchController {
    ...
    @GetMapping("/page")
    public Result<IPage<FishBatch>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody FishBatch entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody FishBatch entity) {
        authService.assertAdminOrBreeder(role);
        service.save(entity);
        return Result.success();
    }
