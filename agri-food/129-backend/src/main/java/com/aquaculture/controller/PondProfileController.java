...
import com.aquaculture.service.PondProfileService;
...
public class PondProfileController {
    private final AuthService authService;
    private final PondProfileService service;

    @GetMapping("/page")
    public Result<IPage<PondProfile>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody PondProfile entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody PondProfile entity) {
        authService.assertAdminOrBreederOrManager(role);
        service.save(entity);
        return Result.success();
    }
