...
public class FarmerProfileController {
    ...
    @GetMapping("/page")
    public Result<IPage<FarmerProfile>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody FarmerProfile entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody FarmerProfile entity) {
        authService.assertAdminOrFarmer(role);
        service.save(entity);
        return Result.success();
    }
