  ...
  <div class="login-container">
    ...
    <div class="login-box">
      <div class="logo-section">
        ...
        <h2 class="title">农业生产技术管理</h2>
        <p class="subtitle">科技兴农 · 绿色发展</p>
      </div>
      ...
      <el-form :model="loginForm" :rules="rules" ref="formRef" class="login-form">
        ...
        <el-form-item prop="password">
          <el-input v-model="loginForm.password" prefix-icon="Lock" type="password" placeholder="请输入密码" show-password size="large" @keyup.enter="handleLogin" />
        </el-form-item>
        <el-form-item>
          <el-button type="success" :loading="loading" @click="handleLogin" size="large" class="submit-btn">
      ...
      <div class="demo-accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>expert / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>tech / 123456</el-tag>
          <el-tag type="info" effect="plain" round>farmer / 123456</el-tag>
        </div>
      </div>

      <div class="agri-tips">
        <span>🌱 春种一粒粟 · 秋收万颗子 🌱</span>
      </div>
    </div>
  </div>
</template>
...
.login-box {
  ...
  border-radius: 28px;
  box-shadow: 0 24px 64px rgba(46, 125, 50, 0.2);
  position: relative;
  z-index: 10;
