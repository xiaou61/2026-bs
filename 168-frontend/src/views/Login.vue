  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">在线职业培训证书考试与续证提醒</h2>
        <p class="subtitle">面向职业教育场景的课程报名、学习进度、考试评分、证书发放和续证提醒一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>instructor / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>trainee / 123456</el-tag>
          <el-tag type="info" effect="plain" round>examiner / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: certGradient 4s linear infinite;
}
