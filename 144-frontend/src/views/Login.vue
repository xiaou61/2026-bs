  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">无障碍出行路线规划</h2>
        <p class="subtitle">面向无障碍出行服务场景的路线规划、协助预约、志愿调度、签到反馈和消息通知协同平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>traveler / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>volunteer / 123456</el-tag>
          <el-tag type="info" effect="plain" round>dispatcher / 123456</el-tag>
        </div>
      </div>

      <div class="access-tips">
        <span>♿ 无障碍出行 · 温暖同行 ♿</span>
      </div>
    </el-card>
  </div>
</template>
