  ...
  <div class="page">
    <el-card>
      ...
      <el-table :data="tableData" v-loading="loading" border>
        ...
        <el-table-column v-if="!readonly || rowActions.length" label="操作" fixed="right" width="296">
...
const form = reactive({})
const statusOptions = [{ label: '启用', value: 1 }, { label: '停用', value: 0 }, { label: '启用', value: 'ACTIVE' }, { label: '空闲', value: 'IDLE' }, { label: '空库位', value: 'EMPTY' }, { label: '已派发', value: 'DISPATCHED' }, { label: '执行中', value: 'RUNNING' }, { label: '完成', value: 'COMPLETED' }, { label: '打开', value: 'OPEN' }, { label: '成功', value: 'SUCCESS' }]
