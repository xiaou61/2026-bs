  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">智能仓储AGV调度</h2>
        <p class="subtitle">仓库区域、库位优化、AGV任务、路径规划、库存出入库和异常告警闭环</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="danger" effect="plain" round>maintainer / 123456</el-tag>
        </div>
      </div>

      <div class="agv-tips">
        <span>🤖 智能仓储 · AGV调度 🤖</span>
      </div>
    </el-card>
  </div>
</template>
...
.login-card::before {
  ...
  animation: agvGradient 4s linear infinite;
}

@keyframes agvGradient {
...
.logo-icon {
  font-size: 72px;
  margin-bottom: 16px;
  animation: moveRobot 2s ease-in-out infinite;
