<template>
  <DataPage title="操作日志" description="关键操作对象、动作、详情和IP地址审计" :api="api" :columns="columns" :form-fields="formFields" :row-actions="rowActions" :defaults="defaults" @row-action="handleAction" />
</template>
