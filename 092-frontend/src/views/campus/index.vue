  ...
  <div class="page">
    <div class="toolbar">
      <el-form :inline="true" :model="filters">
        <el-form-item label="园区名称">
          <el-input v-model="filters.name" placeholder="请输入园区名称" clearable />
        </el-form-item>
      ...
      <div class="toolbar-actions">
        ...
        <el-button type="success" @click="openDialog()">新增园区</el-button>
      </div>
    </div>
    ...
    <el-card shadow="never">
      <el-table :data="list" stripe>
        ...
        <el-table-column prop="code" label="园区编码" min-width="120" />
    ...
    <el-dialog v-model="dialogVisible" :title="form.id ? '编辑园区' : '新增园区'" width="520px">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="88px">
        ...
        <el-form-item label="园区编码" prop="code">
          <el-input v-model="form.code" placeholder="请输入园区编码" />
        </el-form-item>
...
const rules = {
  ...
  code: [{ required: true, message: '请输入园区编码', trigger: 'blur' }]
}
