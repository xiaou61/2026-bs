<template>
  <div class="page">
    <div class="toolbar">
      <el-form :inline="true" :model="filters">
        <el-form-item label="年级名称">
          <el-input v-model="filters.name" placeholder="请输入年级名称" clearable />
        </el-form-item>
        <el-form-item label="所属园区">
          <el-select v-model="filters.departmentId" placeholder="全部园区" clearable style="width: 160px">
      ...
      <div class="toolbar-actions">
        ...
        <el-button type="success" @click="openDialog()">新增年级</el-button>
      </div>
    </div>

    <el-card shadow="never">
      <el-table :data="list" stripe>
        <el-table-column prop="name" label="年级名称" min-width="160" />
        <el-table-column prop="code" label="年级编码" min-width="120" />
        <el-table-column label="所属园区" min-width="140">
    ...
    <el-dialog v-model="dialogVisible" :title="form.id ? '编辑年级' : '新增年级'" width="560px">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="92px">
        ...
        <el-form-item label="年级编码" prop="code">
          <el-input v-model="form.code" placeholder="请输入年级编码" />
        </el-form-item>
...
const rules = {
  ...
  code: [{ required: true, message: '请输入年级编码', trigger: 'blur' }]
}
