<template>
  <div>
    <el-card>
      <div class="toolbar">
        <el-select v-model="query.status" placeholder="电子票状态" clearable style="width: 160px">
          <el-option label="未使用" value="UNUSED" />
          <el-option label="已使用" value="USED" />
        </el-select>
        <el-input v-model="verifyForm.ticketNo" placeholder="输入电子票号核销" style="width: 280px" />
      ...
      <el-table :data="tableData" border v-loading="loading">
        ...
        <el-table-column prop="ticketNo" label="电子票号" width="260" />
        <el-table-column prop="orderId" label="订单ID" width="100" />
        <el-table-column prop="passengerName" label="乘车人" width="120" />
        <el-table-column prop="seatLabel" label="座位" width="120" />
