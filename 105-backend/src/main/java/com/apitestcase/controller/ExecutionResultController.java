...
public class ExecutionResultController {
    ...
    @GetMapping("/page")
    public Result<IPage<ExecutionResult>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ExecutionResult entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ExecutionResult entity) {
        service.save(entity);
        return Result.success();
    }
