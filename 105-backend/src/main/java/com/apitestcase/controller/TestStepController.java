...
public class TestStepController {
    ...
    @GetMapping("/page")
    public Result<IPage<TestStep>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody TestStep entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody TestStep entity) {
        authService.assertAdminOrTesterOrDeveloper(role);
        service.save(entity);
        return Result.success();
    }
