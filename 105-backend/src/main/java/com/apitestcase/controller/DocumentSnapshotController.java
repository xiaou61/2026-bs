...
import com.apitestcase.service.DocumentSnapshotService;
...
public class DocumentSnapshotController {
    private final DocumentSnapshotService service;
    private final AuthService authService;

    @GetMapping("/page")
    public Result<IPage<DocumentSnapshot>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody DocumentSnapshot entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody DocumentSnapshot entity) {
        authService.assertAdminOrProductOrDeveloper(role);
        service.save(entity);
        return Result.success();
    }
