...
public class TestExecutionController {
    ...
    @GetMapping("/page")
    public Result<IPage<TestExecution>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody TestExecution entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody TestExecution entity) {
        service.save(entity);
        return Result.success();
    }
