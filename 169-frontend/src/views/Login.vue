  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">校车乘车预约与学生上下车核验</h2>
        <p class="subtitle">面向学校与家庭场景的线路规划、乘车预约、上下车核验、异常预警和通知推送协同管理平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>school / 123456</el-tag>
...
.login-card::before {
  ...
  animation: busGradient 4s linear infinite;
}

@keyframes busGradient {
