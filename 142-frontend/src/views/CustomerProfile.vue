...
import { getCustomerProfilePage, addCustomerProfile, updateCustomerProfile, deleteCustomerProfile, processCustomerProfile, finishCustomerProfile } from '../api'
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'process') await processCustomerProfile(row.id)
  if (command === 'finish') await finishCustomerProfile(row.id)
