  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">车辆保险理赔材料审核</h2>
        <p class="subtitle">面向车辆保险理赔场景的报案登记、材料审核、定损赔付、回访通知和进度跟踪平台</p>
      </div>
...
.login-card::before {
  ...
  animation: insuranceGradient 4s linear infinite;
}

@keyframes insuranceGradient {
