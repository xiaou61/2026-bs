...
public class WaterLevelDataController {
    ...
    @GetMapping("/page")
    public Result<IPage<WaterLevelData>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody WaterLevelData entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody WaterLevelData entity) {
        service.save(entity);
        return Result.success();
    }
