...
public class ShelterSiteController {
    ...
    @GetMapping("/page")
    public Result<IPage<ShelterSite>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ShelterSite entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ShelterSite entity) {
        service.save(entity);
        return Result.success();
    }
