...
public class RainGaugeStationController {
    ...
    @GetMapping("/page")
    public Result<IPage<RainGaugeStation>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody RainGaugeStation entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody RainGaugeStation entity) {
        service.save(entity);
        return Result.success();
    }
