...
import com.floodcity.service.MaterialReserveService;
...
public class MaterialReserveController {
    ...
    private final MaterialReserveService service;

    @GetMapping("/page")
    public Result<IPage<MaterialReserve>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody MaterialReserve entity) {
        authService.assertAdminOrDispatcherOrManager(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody MaterialReserve entity) {
        authService.assertAdminOrDispatcherOrManager(role);
        service.save(entity);
        return Result.success();
    }
