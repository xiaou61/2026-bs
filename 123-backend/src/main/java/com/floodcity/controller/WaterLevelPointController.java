...
public class WaterLevelPointController {
    ...
    @GetMapping("/page")
    public Result<IPage<WaterLevelPoint>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody WaterLevelPoint entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody WaterLevelPoint entity) {
        service.save(entity);
        return Result.success();
    }
