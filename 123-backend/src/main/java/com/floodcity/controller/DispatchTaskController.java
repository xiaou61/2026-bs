...
public class DispatchTaskController {
    ...
    @GetMapping("/page")
    public Result<IPage<DispatchTask>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody DispatchTask entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody DispatchTask entity) {
        service.save(entity);
        return Result.success();
    }
