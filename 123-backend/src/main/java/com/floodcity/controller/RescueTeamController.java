...
public class RescueTeamController {
    ...
    @GetMapping("/page")
    public Result<IPage<RescueTeam>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody RescueTeam entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody RescueTeam entity) {
        service.save(entity);
        return Result.success();
    }
