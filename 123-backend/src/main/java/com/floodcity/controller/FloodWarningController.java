...
public class FloodWarningController {
    ...
    @GetMapping("/page")
    public Result<IPage<FloodWarning>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody FloodWarning entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody FloodWarning entity) {
        service.save(entity);
        return Result.success();
    }
