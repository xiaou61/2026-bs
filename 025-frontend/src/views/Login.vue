<template>
  <div class="login-container">
    ...
    <div class="bg-decoration">
      ...
      <div class="smart-icon icon-1">🏠</div>
      <div class="smart-icon icon-2">🅿️</div>
      <div class="smart-icon icon-3">🔧</div>
    </div>
    ...
    <div class="login-box">
      ...
      <div class="login-header">
        ...
        <h1 class="login-title">智慧社区</h1>
        <p class="login-subtitle">Smart Community Platform</p>
      </div>
