...
public class EnergyBudgetController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<EnergyBudget>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody EnergyBudget entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody EnergyBudget entity) {
        service.save(entity);
        return Result.success();
    }
    ...
    @PutMapping("/over/{id}")
    public Result<Void> over(@PathVariable Long id) {
