...
public class HomeProfileController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<HomeProfile>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody HomeProfile entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody HomeProfile entity) {
        service.save(entity);
        return Result.success();
    }
