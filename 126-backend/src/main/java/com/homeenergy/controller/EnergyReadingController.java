...
public class EnergyReadingController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<EnergyReading>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody EnergyReading entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody EnergyReading entity) {
    ...
    public Result<Void> warn(@RequestAttribute String role, @PathVariable Long id) {
        authService.assertAdminOrAnalystOrMaintainer(role);
