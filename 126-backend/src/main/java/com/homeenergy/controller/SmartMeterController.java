...
public class SmartMeterController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<SmartMeter>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody SmartMeter entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody SmartMeter entity) {
        service.save(entity);
        return Result.success();
    }
