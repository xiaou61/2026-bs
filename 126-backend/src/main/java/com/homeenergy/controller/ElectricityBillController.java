...
public class ElectricityBillController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ElectricityBill>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ElectricityBill entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ElectricityBill entity) {
        service.save(entity);
        return Result.success();
    }
