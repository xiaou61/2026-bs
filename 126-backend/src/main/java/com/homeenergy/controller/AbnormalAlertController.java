...
import com.homeenergy.service.AbnormalAlertService;
...
public class AbnormalAlertController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<AbnormalAlert>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody AbnormalAlert entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody AbnormalAlert entity) {
        authService.assertAdminOrAnalyst(role);
        service.save(entity);
        return Result.success();
    }
