...
public class AbnormalAlertController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<AbnormalAlert>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody AbnormalAlert entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody AbnormalAlert entity) {
        service.save(entity);
        return Result.success();
    }
