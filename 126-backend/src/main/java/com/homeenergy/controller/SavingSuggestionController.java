...
public class SavingSuggestionController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<SavingSuggestion>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody SavingSuggestion entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody SavingSuggestion entity) {
        service.save(entity);
        return Result.success();
    }
