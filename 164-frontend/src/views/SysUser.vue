<template><DataPage title="账号权限" description="赛事组织员、队伍教练、参赛学生、裁判员、仲裁委员账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
