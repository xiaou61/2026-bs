  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">校园体育赛事报名编排与裁判评分</h2>
        <p class="subtitle">面向校园体育场景的赛事编排、报名审核、裁判评分、成绩发布和申诉复议协同平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>organizer / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>athlete / 123456</el-tag>
          <el-tag type="info" effect="plain" round>referee / 123456</el-tag>
        </div>
      </div>

      <div class="sport-tips">
...
.login-card::before {
  ...
  animation: sportGradient 4s linear infinite;
}

@keyframes sportGradient {
