  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">校园宿舍能耗监测与节能排名</h2>
        <p class="subtitle">面向高校后勤的宿舍能耗采集、异常预警、节能任务和绿色排名协同管理平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>logistics / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>counselor / 123456</el-tag>
          <el-tag type="info" effect="plain" round>energy / 123456</el-tag>
          <el-tag type="danger" effect="plain" round>student / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: energyGradient 4s linear infinite;
}
...
@keyframes pulse {
  0%, 100% { transform: scale(1); color: #FF6F00; }
  50% { transform: scale(1.2); color: #FFB300; }
}
