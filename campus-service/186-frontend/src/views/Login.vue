  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">校园餐厅后厨留样与卫生巡检</h2>
        <p class="subtitle">面向校园餐饮场景的后厨巡检、食材验收、留样管理、消毒记录和风险预警一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>canteen / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>chef / 123456</el-tag>
          <el-tag type="info" effect="plain" round>inspector / 123456</el-tag>
        </div>
      </div>

      <div class="food-tips">
        <span>🍽️ 食品安全 · 舌尖守护 🍽️</span>
      </div>
    </el-card>
  </div>
</template>
...
.login-card::before {
  ...
  animation: foodGradient 4s linear infinite;
}

@keyframes foodGradient {
