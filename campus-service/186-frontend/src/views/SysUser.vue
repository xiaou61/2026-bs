<template><DataPage title="账号权限" description="食堂管理员、后厨负责人、卫生巡检员、仓储管理员、校方监管账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
