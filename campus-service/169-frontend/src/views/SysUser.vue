<template><DataPage title="账号权限" description="校方管理员、调度管理员、校车司机、跟车老师、学生家长账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
