...
public class ExamAttemptController {
    ...
    @GetMapping("/page")
    public Result<IPage<ExamAttempt>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ExamAttempt entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ExamAttempt entity) {
        service.save(entity);
        return Result.success();
    }
    ...
    public Result<Void> retrain(@PathVariable Long id) {
