...
public class CampaignTargetController {
    ...
    @GetMapping("/page")
    public Result<IPage<CampaignTarget>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody CampaignTarget entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody CampaignTarget entity) {
        service.save(entity);
        return Result.success();
    }
