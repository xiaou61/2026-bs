...
public class TrainingCourseController {
    ...
    @GetMapping("/page")
    public Result<IPage<TrainingCourse>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody TrainingCourse entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody TrainingCourse entity) {
        service.save(entity);
        return Result.success();
    }
