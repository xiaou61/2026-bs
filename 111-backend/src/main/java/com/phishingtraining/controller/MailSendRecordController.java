...
public class MailSendRecordController {
    ...
    @GetMapping("/page")
    public Result<IPage<MailSendRecord>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody MailSendRecord entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody MailSendRecord entity) {
        service.save(entity);
        return Result.success();
    }
    ...
    @PutMapping("/sent/{id}")
    public Result<Void> sent(@PathVariable Long id) {
