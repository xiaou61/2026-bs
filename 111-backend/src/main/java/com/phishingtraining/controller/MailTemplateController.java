...
public class MailTemplateController {
    ...
    @GetMapping("/page")
    public Result<IPage<MailTemplate>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody MailTemplate entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody MailTemplate entity) {
        authService.assertAdminOrSecurity(role);
        service.save(entity);
        return Result.success();
    }
