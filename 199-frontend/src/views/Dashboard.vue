<template>
  <div class="page">
    <div class="dashboard-grid">
      <div class="metric">训练计划<strong>{{ data.record01Count || 0 }}</strong></div>
      <div class="metric">体测评估<strong>{{ data.record02Count || 0 }}</strong></div>
      <div class="metric">康复反馈<strong>{{ data.record03Count || 0 }}</strong></div>
      <div class="metric">风险提醒<strong>{{ data.record04Count || 0 }}</strong></div>
    </div>
