...
import { getTeacherProfilePage, addTeacherProfile, updateTeacherProfile, deleteTeacherProfile, activateTeacherProfile, finishTeacherProfile } from '../api'
const api = { page: getTeacherProfilePage, add: addTeacherProfile, update: updateTeacherProfile, delete: deleteTeacherProfile }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'activate') await activateTeacherProfile(row.id)
  if (command === 'finish') await finishTeacherProfile(row.id)
