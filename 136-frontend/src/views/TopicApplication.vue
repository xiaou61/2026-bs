...
import { getTopicApplicationPage, addTopicApplication, updateTopicApplication, deleteTopicApplication, submitTopicApplication, approveTopicApplication } from '../api'
const api = { page: getTopicApplicationPage, add: addTopicApplication, update: updateTopicApplication, delete: deleteTopicApplication }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'submit') await submitTopicApplication(row.id)
  if (command === 'approve') await approveTopicApplication(row.id)
