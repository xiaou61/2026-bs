...
import { getMidtermCheckPage, addMidtermCheck, updateMidtermCheck, deleteMidtermCheck, activateMidtermCheck, finishMidtermCheck } from '../api'
const api = { page: getMidtermCheckPage, add: addMidtermCheck, update: updateMidtermCheck, delete: deleteMidtermCheck }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'activate') await activateMidtermCheck(row.id)
  if (command === 'finish') await finishMidtermCheck(row.id)
