  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">导师课题双选与开题过程</h2>
        <p class="subtitle">面向毕业设计过程管理的课题双选、开题材料、答辩安排与节点提醒平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="info" effect="plain" round>affairs / 123456</el-tag>
        </div>
      </div>

      <div class="thesis-tips">
        <span>🎓 毕业设计 · 成果展示 🎓</span>
      </div>
    </el-card>
  </div>
...
.login-card::before {
  ...
  animation: thesisGradient 4s linear infinite;
}

@keyframes thesisGradient {
