...
import { getTopicReleasePage, addTopicRelease, updateTopicRelease, deleteTopicRelease, activateTopicRelease, finishTopicRelease } from '../api'
const api = { page: getTopicReleasePage, add: addTopicRelease, update: updateTopicRelease, delete: deleteTopicRelease }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'activate') await activateTopicRelease(row.id)
  if (command === 'finish') await finishTopicRelease(row.id)
