...
import { getTaskBookPage, addTaskBook, updateTaskBook, deleteTaskBook, processTaskBook, finishTaskBook } from '../api'
const api = { page: getTaskBookPage, add: addTaskBook, update: updateTaskBook, delete: deleteTaskBook }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'process') await processTaskBook(row.id)
  if (command === 'finish') await finishTaskBook(row.id)
