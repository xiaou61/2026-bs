<template><DataPage title="账号权限" description="图书馆管理员、漂流负责人、学生读者、读书社团、阅读指导老师账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
