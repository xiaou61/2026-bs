  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">温室大棚物联网控制</h2>
        <p class="subtitle">面向智慧农业的温室环境监测、远程控制、病虫害预警和采收管理平台</p>
      </div>
...
.login-card::before {
  ...
  right: 0;
  height: 6px;
  background: linear-gradient(90deg, #1B5E20, #2E7D32, #43A047, #66BB6A, #1B5E20);
  background-size: 300% 100%;
  animation: greenhouseGradient 4s linear infinite;
}
