  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">校外培训机构课消统计与退费审批</h2>
        <p class="subtitle">面向培训机构的课程管理、学员考勤、课时消费、退费审批和财务对账一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>principal / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>teacher / 123456</el-tag>
          <el-tag type="info" effect="plain" round>finance / 123456</el-tag>
          <el-tag type="danger" effect="plain" round>parent / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: trainingGradient 4s linear infinite;
}

@keyframes trainingGradient {
