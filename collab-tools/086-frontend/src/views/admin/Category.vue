<template>
  <el-card>
    <div class="toolbar">
      <el-input v-model="query.name" placeholder="分类名称" style="width: 220px" clearable />
...
import { addCategory, deleteCategory, getCategoryList, updateCategory } from '../../api'
...
const form = reactive({ id: null, name: '', code: '', icon: '', sort: 0, status: 1 })
...
const resetForm = () => Object.assign(form, { id: null, name: '', code: '', icon: '', sort: 0, status: 1 })
