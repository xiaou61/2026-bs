...
('user2', '123456', '另一位用户', 'https://api.dicebear.com/7.x/initials/svg?seed=USER2', 'user2@wallpaper.com', '13800000003', 'user', '喜欢极简风格壁纸', 1);
...
(1, 1, '构图与清晰度符合要求', 1, CURRENT_TIMESTAMP),
(2, 1, '已通过审核', 1, CURRENT_TIMESTAMP),
(4, 1, '内容质量良好', 1, CURRENT_TIMESTAMP);
...
('高清壁纸投稿规范', '上传壁纸请确保画质清晰，无水印，且标题与分类填写完整。', 'system', 1, 1, CURRENT_TIMESTAMP, 52),
('手机壁纸专区已上线', '新增竖屏壁纸筛选能力，欢迎体验。', 'activity', 1, 1, CURRENT_TIMESTAMP, 37);
