    ...
    <el-col :span="12">
      <el-card>
        ...
        <el-form ref="profileRef" :model="profileForm" :rules="profileRules" label-width="90px">
          ...
          <el-form-item label="头像地址"><el-input v-model="profileForm.avatar" maxlength="255" /></el-form-item>
...
const profileForm = reactive({ id: null, username: '', nickname: '', email: '', avatar: '' })
...
const saveProfile = async () => {
  ...
  await updateProfile({ nickname: profileForm.nickname, email: profileForm.email, avatar: profileForm.avatar })
