  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">家庭能源用电分析</h2>
        <p class="subtitle">面向家庭绿色低碳场景的用电分析、账单预算、设备能耗和节能建议平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>resident / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>analyst / 123456</el-tag>
          <el-tag type="info" effect="plain" round>maintainer / 123456</el-tag>
        </div>
      </div>
