  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">直播电商选品排期与售后</h2>
        <p class="subtitle">选品入池、直播排期、样品话术、订单履约、售后退款、主播绩效闭环</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="warning" effect="plain" round>service / 123456</el-tag>
          <el-tag type="danger" effect="plain" round>merchant / 123456</el-tag>
        </div>
      </div>
...
.login {
  ...
  align-items: center;
  background: linear-gradient(135deg, #E91E63 0%, #F06292 30%, #F48FB1 60%, #F8BBD0 100%);
  position: relative;
  overflow: hidden;
}
