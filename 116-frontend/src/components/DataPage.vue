  ...
  <div class="page">
    <el-card>
      ...
      <el-table :data="tableData" v-loading="loading" border>
        ...
        <el-table-column v-if="!readonly || rowActions.length" label="操作" fixed="right" width="286">
...
const form = reactive({})
const statusOptions = [{ label: '启用', value: 'ACTIVE' }, { label: '待审核', value: 'WAIT_AUDIT' }, { label: '草稿', value: 'DRAFT' }, { label: '已入围', value: 'SHORTLISTED' }, { label: '已排期', value: 'SCHEDULED' }, { label: '直播中', value: 'LIVE' }, { label: '已完成', value: 'FINISHED' }, { label: '处理中', value: 'OPEN' }, { label: '已解决', value: 'RESOLVED' }, { label: '成功', value: 'SUCCESS' }]
