  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">口腔门诊治疗预约与耗材计费</h2>
        <p class="subtitle">面向口腔诊所场景的预约挂号、分诊叫号、治疗记录、耗材管理和费用结算一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>dentist / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>nurse / 123456</el-tag>
          <el-tag type="info" effect="plain" round>patient / 123456</el-tag>
        </div>
      </div>

      <div class="dental-tips">
        <span>🦷 呵护牙齿 · 绽放笑容 🦷</span>
      </div>
    </el-card>
  </div>
...
.login-card::before {
  ...
  animation: dentalGradient 4s linear infinite;
}

@keyframes dentalGradient {
