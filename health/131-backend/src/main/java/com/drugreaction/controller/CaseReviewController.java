...
import com.drugreaction.service.CaseReviewService;
...
public class CaseReviewController {
    ...
    private final CaseReviewService service;

    @GetMapping("/page")
    public Result<IPage<CaseReview>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody CaseReview entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody CaseReview entity) {
        authService.assertAdminOrReviewer(role);
        service.save(entity);
        return Result.success();
    }
