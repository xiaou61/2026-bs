...
import com.drugreaction.service.DrugCatalogService;
...
public class DrugCatalogController {
    ...
    @GetMapping("/page")
    public Result<IPage<DrugCatalog>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody DrugCatalog entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody DrugCatalog entity) {
        authService.assertAdminOrReviewer(role);
        service.save(entity);
        return Result.success();
    }
