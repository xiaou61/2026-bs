...
public class BorrowRequestController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<BorrowRequest>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody BorrowRequest entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody BorrowRequest entity) {
        authService.assertAdminOrNurse(role);
        service.save(entity);
        return Result.success();
    }
