<template><DataPage title="账号权限" description="中心管理员、体测评估师、康复教练、康复治疗师、训练会员账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
