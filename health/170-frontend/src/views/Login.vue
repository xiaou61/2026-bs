  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">养老机构床位分配与护理记录</h2>
        <p class="subtitle">面向养老机构的入住评估、床位分配、护理计划、家属查询和异常上报一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>nursing / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>caregiver / 123456</el-tag>
          <el-tag type="info" effect="plain" round>family / 123456</el-tag>
        </div>
      </div>

      <div class="elder-tips">
        <span>🏠 老有所养 · 老有所依 🏠</span>
      </div>
    </el-card>
  </div>
...
.login-card::before {
  ...
  animation: elderGradient 4s linear infinite;
}

@keyframes elderGradient {
