<template><DataPage title="账号权限" description="医院交接员、收运调度员、转运司机、处置厂审核员、监管人员账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
