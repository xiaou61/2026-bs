  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">药品不良反应上报与随访</h2>
        <p class="subtitle">面向医药监管的不良反应上报、风险评估、随访管理和病例复核平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>reporter / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>reviewer / 123456</el-tag>
          <el-tag type="info" effect="plain" round>doctor / 123456</el-tag>
        </div>
      </div>

      <div class="medical-tips">
        <span>💊 安全用药 · 关注不良反应 💊</span>
      </div>
    </el-card>
  </div>
</template>
...
.login-card::before {
  ...
  animation: medicalGradient 4s linear infinite;
}
