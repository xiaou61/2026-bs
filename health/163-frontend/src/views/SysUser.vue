<template><DataPage title="账号权限" description="教学秘书、带教老师、实习学生、考核评委、科室主任账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
