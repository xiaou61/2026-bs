  ...
  <div class="page-container">
    <el-card>
      <div class="search-bar">
        <el-input v-model="query.itemName" placeholder="项目名称" clearable style="width: 220px" />
      ...
      <el-table :data="tableData" v-loading="loading">
        ...
        <el-table-column prop="lowLimit" label="下限" width="90" />
        <el-table-column prop="highLimit" label="上限" width="90" />
    ...
    <el-dialog v-model="dialogVisible" :title="form.id ? '编辑项目' : '新增项目'" width="560px">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="下限" prop="lowLimit">
          <el-input-number v-model="form.lowLimit" :precision="2" />
        </el-form-item>
        <el-form-item label="上限" prop="highLimit">
          <el-input-number v-model="form.highLimit" :precision="2" />
        </el-form-item>
...
import { addItem, deleteItem, getItemList, updateItem } from '../../api'
