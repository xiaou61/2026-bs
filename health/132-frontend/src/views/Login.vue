  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">医疗器械借用消毒与追踪</h2>
        <p class="subtitle">面向医疗器械管理的借用归还、消毒追踪、二维码流转和风险预警平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>nurse / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>sterilizer / 123456</el-tag>
...
.login-card::before {
  ...
  animation: deviceGradient 4s linear infinite;
}

@keyframes deviceGradient {
