<template><DataPage title="账号权限" description="院区管理员、陪护协调员、护工人员、结算人员、患者家属账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
