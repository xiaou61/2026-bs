...
import com.noisemonitor.service.PatrolRecordService;
...
public class PatrolRecordController {
    ...
    @GetMapping("/page")
    public Result<IPage<PatrolRecord>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody PatrolRecord entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody PatrolRecord entity) {
        authService.assertAdminOrOfficer(role);
        service.save(entity);
        return Result.success();
    }
