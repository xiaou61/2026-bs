...
public class PatrolRecordController {
    ...
    @GetMapping("/page")
    public Result<IPage<PatrolRecord>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody PatrolRecord entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody PatrolRecord entity) {
        service.save(entity);
        return Result.success();
    }
