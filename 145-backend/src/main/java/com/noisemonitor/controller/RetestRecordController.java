...
public class RetestRecordController {
    ...
    @GetMapping("/page")
    public Result<IPage<RetestRecord>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody RetestRecord entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody RetestRecord entity) {
        service.save(entity);
        return Result.success();
    }
