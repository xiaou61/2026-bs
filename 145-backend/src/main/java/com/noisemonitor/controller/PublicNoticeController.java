...
public class PublicNoticeController {
    ...
    @GetMapping("/page")
    public Result<IPage<PublicNotice>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody PublicNotice entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody PublicNotice entity) {
        service.save(entity);
        return Result.success();
    }
