...
public class PublicFeedbackController {
    ...
    @GetMapping("/page")
    public Result<IPage<PublicFeedback>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody PublicFeedback entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody PublicFeedback entity) {
        service.save(entity);
        return Result.success();
    }
