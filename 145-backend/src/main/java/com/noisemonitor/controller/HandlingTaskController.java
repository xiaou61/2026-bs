...
import com.noisemonitor.service.HandlingTaskService;
...
public class HandlingTaskController {
    private final AuthService authService;
    private final HandlingTaskService service;

    @GetMapping("/page")
    public Result<IPage<HandlingTask>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody HandlingTask entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody HandlingTask entity) {
        authService.assertAdminOrSupervisor(role);
        service.save(entity);
        return Result.success();
    }
