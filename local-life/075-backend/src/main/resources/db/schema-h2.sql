...
DROP TABLE IF EXISTS repair_appointment;
...
CREATE INDEX idx_repair_service_category ON repair_service(category_id);
CREATE INDEX idx_repair_service_seller ON repair_service(seller_id);
...
CREATE INDEX idx_repair_appointment_user ON repair_appointment(user_id);
CREATE INDEX idx_repair_appointment_service ON repair_appointment(service_id);
