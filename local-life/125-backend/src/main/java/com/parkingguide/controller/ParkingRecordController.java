...
import com.parkingguide.service.ParkingRecordService;
...
public class ParkingRecordController {
    ...
    @GetMapping("/page")
    public Result<IPage<ParkingRecord>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ParkingRecord entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ParkingRecord entity) {
        authService.assertAdminOrOperatorOrGuard(role);
        service.save(entity);
        return Result.success();
    }
    ...
    @PutMapping("/leave/{id}")
    public Result<Void> leave(@RequestAttribute String role, @PathVariable Long id) {
        authService.assertAdminOrGuard(role);
        service.updateStatus(id, "LEFT");
        return Result.success();
    }
