...
import com.parkingguide.service.NavigationRouteService;
...
public class NavigationRouteController {
    ...
    private final NavigationRouteService service;

    @GetMapping("/page")
    public Result<IPage<NavigationRoute>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody NavigationRoute entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody NavigationRoute entity) {
        authService.assertAdminOrOperatorOrAnalyst(role);
        service.save(entity);
        return Result.success();
    }
