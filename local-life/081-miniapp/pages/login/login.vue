<template>
  <view class="login-container">
    <view class="logo"><text class="title">电器维修服务</text></view>
    <view class="form-box">
      <view class="form-item"><input v-model="form.username" placeholder="请输入用户名" /></view>
      <view class="form-item"><input v-model="form.password" type="password" placeholder="请输入密码" /></view>
    ...
    <view class="modal" v-if="showRegister">
      <view class="modal-content">
        ...
        <view class="form-item"><input v-model="registerForm.username" placeholder="用户名" /></view>
        <view class="form-item"><input v-model="registerForm.password" type="password" placeholder="密码" /></view>
        <view class="form-item"><input v-model="registerForm.realName" placeholder="姓名" /></view>
        <view class="form-item"><input v-model="registerForm.phone" placeholder="手机号" /></view>
...
const registerForm = reactive({ username: '', password: '', realName: '', phone: '', role: 'customer' })
...
<style scoped>
.login-container { min-height: 100vh; background: linear-gradient(135deg, #2d5baf 0%, #1d2a3f 100%); padding: 100rpx 40rpx; }
...
.btn-login { background: #2d5baf; color: #fff; border: none; height: 90rpx; line-height: 90rpx; border-radius: 12rpx; font-size: 32rpx; margin-top: 20rpx; }
.register-link { text-align: center; color: #2d5baf; font-size: 26rpx; margin-top: 30rpx; }
...
.btn-confirm { background: #2d5baf; color: #fff; }
</style>
