<template>
  <el-container style="height: 100vh">
    <el-aside :width="collapse ? '64px' : '220px'" class="aside">
      <div class="logo">{{ collapse ? '修' : '汽车维修预约服务系统' }}</div>
      <el-menu :default-active="$route.path" :collapse="collapse" router background-color="#1f2937" text-color="#cbd5e1" active-text-color="#38bdf8">
        ...
        <el-menu-item v-else index="/item">我的服务</el-menu-item>
        <el-menu-item index="/market">维修项目</el-menu-item>
        <el-menu-item index="/my-order">我的预约</el-menu-item>
        <el-menu-item v-if="!isAdmin" index="/sale-order">预约工单</el-menu-item>
