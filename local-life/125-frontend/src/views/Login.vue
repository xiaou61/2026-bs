  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">智慧停车诱导与空位预测</h2>
        <p class="subtitle">面向智慧交通的停车诱导、空位预测、预约导航和收费运营平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="warning" effect="plain" round>guard / 123456</el-tag>
...
.login-card::before {
  ...
  animation: parkingGradient 4s linear infinite;
}

@keyframes parkingGradient {
