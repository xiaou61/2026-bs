...
import com.pethospital.service.DoctorProfileService;
...
public class DoctorProfileController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<DoctorProfile>> page(@RequestAttribute("role") String role, @RequestParam(required = false) Integer pageNum, @RequestParam(required = false) Integer pageSize, @RequestParam(required = false) String keyword, @RequestParam(required = false) String status) {
