  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">宠物医院接诊排班与疫苗随访</h2>
        <p class="subtitle">覆盖挂号预约、诊疗记录、疫苗计划、药品库存、费用结算和随访提醒的宠物医疗平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="warning" effect="plain" round>doctor / 123456</el-tag>
          <el-tag type="info" effect="plain" round>nurse / 123456</el-tag>
          <el-tag type="danger" effect="plain" round>owner / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: petGradient 4s linear infinite;
}
