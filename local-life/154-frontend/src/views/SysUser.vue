<template><DataPage title="账号权限" description="前台接诊员、宠物医生、护理接种员、宠物主人账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
