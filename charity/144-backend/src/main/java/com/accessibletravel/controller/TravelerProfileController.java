...
import com.accessibletravel.service.TravelerProfileService;
...
public class TravelerProfileController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<TravelerProfile>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody TravelerProfile entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody TravelerProfile entity) {
        authService.assertAdminOrTravelerOrDispatcher(role);
        service.save(entity);
        return Result.success();
    }
