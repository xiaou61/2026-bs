<template>
  <DataPage title="账号权限" description="维护系统账号、角色、联系方式和启停状态，支撑平台权限管理" :api="api" :columns="columns" :form-fields="formFields" :row-actions="rowActions" :defaults="defaults" :can-create="true" :can-edit="true" :can-delete="true" @row-action="handleAction" />
</template>
