  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">企业碳排放核算与减排</h2>
        <p class="subtitle">面向碳管理的企业排放核算、减排任务、核查报告和预警处置平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>accountant / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>auditor / 123456</el-tag>
...
.login-card::before {
  ...
  animation: carbonGradient 4s linear infinite;
}

@keyframes carbonGradient {
