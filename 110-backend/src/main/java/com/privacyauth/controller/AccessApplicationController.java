...
import com.privacyauth.service.AccessApplicationService;
...
@RestController
@RequestMapping("/api/access-application")
...
public class AccessApplicationController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<AccessApplication>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody AccessApplication entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody AccessApplication entity) {
        authService.assertAdminOrDatauser(role);
        service.save(entity);
        return Result.success();
    }
