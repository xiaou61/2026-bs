...
import com.privacyauth.service.DataSubjectService;
...
public class DataSubjectController {
    ...
    private final DataSubjectService service;

    @GetMapping("/page")
    public Result<PageInfo<DataSubject>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody DataSubject entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody DataSubject entity) {
        authService.assertAdmin(role);
        service.save(entity);
        return Result.success();
    }
