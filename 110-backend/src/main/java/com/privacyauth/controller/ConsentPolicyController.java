...
public class ConsentPolicyController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ConsentPolicy>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ConsentPolicy entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ConsentPolicy entity) {
        authService.assertAdminOrPrivacy(role);
        service.save(entity);
        return Result.success();
    }
