...
public class AccessGrantController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<AccessGrant>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody AccessGrant entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody AccessGrant entity) {
        service.save(entity);
        return Result.success();
    }
