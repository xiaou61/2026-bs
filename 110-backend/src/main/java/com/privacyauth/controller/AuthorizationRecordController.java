...
public class AuthorizationRecordController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<AuthorizationRecord>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody AuthorizationRecord entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody AuthorizationRecord entity) {
        service.save(entity);
        return Result.success();
    }
