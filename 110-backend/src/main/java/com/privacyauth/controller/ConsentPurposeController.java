...
public class ConsentPurposeController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ConsentPurpose>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ConsentPurpose entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ConsentPurpose entity) {
        service.save(entity);
        return Result.success();
    }
