  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">高校毕业去向填报与就业帮扶</h2>
        <p class="subtitle">面向高校就业场景的毕业去向、岗位推荐、就业帮扶、合同归档和统计分析一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>career / 123456</el-tag>
...
.login-card::before {
  ...
  animation: careerGradient 5s linear infinite;
}
