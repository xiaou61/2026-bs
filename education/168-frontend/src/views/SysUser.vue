<template><DataPage title="账号权限" description="培训管理员、授课讲师、参训学员、考务管理员、证书管理员账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
