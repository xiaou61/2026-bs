...
public class ApprovalTaskController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ApprovalTask>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ApprovalTask entity) {
        authService.assertAdminOrLeader(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ApprovalTask entity) {
        authService.assertAdminOrLeader(role);
        service.save(entity);
        return Result.success();
    }
