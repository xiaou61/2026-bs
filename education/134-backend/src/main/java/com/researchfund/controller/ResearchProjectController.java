...
public class ResearchProjectController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ResearchProject>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ResearchProject entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ResearchProject entity) {
        authService.assertAdminOrResearcher(role);
        service.save(entity);
        return Result.success();
    }
