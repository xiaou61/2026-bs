...
import com.conferencereview.service.ReviewAssignmentService;
...
public class ReviewAssignmentController {
    ...
    @GetMapping("/page")
    public Result<IPage<ReviewAssignment>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ReviewAssignment entity) {
        authService.assertAdminOrManager(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ReviewAssignment entity) {
        authService.assertAdminOrManager(role);
        service.save(entity);
        return Result.success();
    }
