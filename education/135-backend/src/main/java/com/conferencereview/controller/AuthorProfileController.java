...
import com.conferencereview.service.AuthorProfileService;
...
public class AuthorProfileController {
    ...
    @GetMapping("/page")
    public Result<IPage<AuthorProfile>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody AuthorProfile entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody AuthorProfile entity) {
        authService.assertAdminOrManager(role);
        service.save(entity);
        return Result.success();
    }
