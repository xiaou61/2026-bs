...
import com.conferencereview.service.CheckinRecordService;
...
public class CheckinRecordController {
    ...
    @GetMapping("/page")
    public Result<IPage<CheckinRecord>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody CheckinRecord entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody CheckinRecord entity) {
        authService.assertAdminOrSecretary(role);
        service.save(entity);
        return Result.success();
    }
