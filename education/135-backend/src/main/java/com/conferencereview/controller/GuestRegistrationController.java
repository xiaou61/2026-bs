...
import com.conferencereview.service.GuestRegistrationService;
...
public class GuestRegistrationController {
    ...
    @GetMapping("/page")
    public Result<IPage<GuestRegistration>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody GuestRegistration entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody GuestRegistration entity) {
        authService.assertAdminOrManager(role);
        service.save(entity);
        return Result.success();
    }
