...
import { getMentorProfilePage, addMentorProfile, updateMentorProfile, deleteMentorProfile, activateMentorProfile, finishMentorProfile } from '../api'
const api = { page: getMentorProfilePage, add: addMentorProfile, update: updateMentorProfile, delete: deleteMentorProfile }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'activate') await activateMentorProfile(row.id)
  if (command === 'finish') await finishMentorProfile(row.id)
