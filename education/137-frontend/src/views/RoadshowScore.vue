...
import { getRoadshowScorePage, addRoadshowScore, updateRoadshowScore, deleteRoadshowScore, submitRoadshowScore, approveRoadshowScore } from '../api'
const api = { page: getRoadshowScorePage, add: addRoadshowScore, update: updateRoadshowScore, delete: deleteRoadshowScore }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'submit') await submitRoadshowScore(row.id)
  if (command === 'approve') await approveRoadshowScore(row.id)
