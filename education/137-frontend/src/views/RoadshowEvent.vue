...
import { getRoadshowEventPage, addRoadshowEvent, updateRoadshowEvent, deleteRoadshowEvent, processRoadshowEvent, finishRoadshowEvent } from '../api'
const api = { page: getRoadshowEventPage, add: addRoadshowEvent, update: updateRoadshowEvent, delete: deleteRoadshowEvent }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'process') await processRoadshowEvent(row.id)
  if (command === 'finish') await finishRoadshowEvent(row.id)
