...
import { getIncubationNoticePage, addIncubationNotice, updateIncubationNotice, deleteIncubationNotice, processIncubationNotice, finishIncubationNotice } from '../api'
const api = { page: getIncubationNoticePage, add: addIncubationNotice, update: updateIncubationNotice, delete: deleteIncubationNotice }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'process') await processIncubationNotice(row.id)
  if (command === 'finish') await finishIncubationNotice(row.id)
