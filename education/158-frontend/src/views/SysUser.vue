<template><DataPage title="账号权限" description="校区校长、教务主管、任课老师、财务审核员、学员家长账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
