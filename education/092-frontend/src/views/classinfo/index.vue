  ...
  <div class="page">
    <div class="toolbar">
      <el-form :inline="true" :model="filters">
        ...
        <el-form-item label="所属年级">
          <el-select v-model="filters.majorId" placeholder="全部年级" clearable style="width: 180px">
    ...
    <el-card shadow="never">
      <el-table :data="list" stripe>
        ...
        <el-table-column label="所属年级" min-width="160">
    ...
    <el-dialog v-model="dialogVisible" :title="form.id ? '编辑班级' : '新增班级'" width="560px">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="92px">
        <el-form-item label="所属年级" prop="majorId">
          <el-select v-model="form.majorId" placeholder="请选择年级" style="width: 100%">
            <el-option v-for="item in majorOptions" :key="item.id" :label="item.name" :value="item.id" />
          </el-select>
        </el-form-item>
...
const rules = {
  majorId: [{ required: true, message: '请选择所属年级', trigger: 'change' }],
