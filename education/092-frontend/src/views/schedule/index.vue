  ...
  <div class="page">
    ...
    <el-card shadow="never">
      <el-table :data="list" stripe>
        ...
        <el-table-column prop="teacherName" label="带班教师" min-width="110" />
    ...
    <el-dialog v-model="dialogVisible" :title="form.id ? '编辑排课' : '新增排课'" width="640px">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="92px">
        <el-form-item label="活动" prop="courseId">
          <el-select v-model="form.courseId" placeholder="请选择活动" style="width: 100%">
...
const pageTitle = computed(() => userStore.role === 'teacher' ? '我的带班安排' : '我的个人活动安排')
const pageDesc = computed(() => userStore.role === 'teacher' ? '这里展示当前教师的全部带班排期。' : '这里展示幼儿已选活动形成的个人活动安排。')
