  ...
  <div class="page-container">
    <el-card>
      <div class="search-bar">
        <el-input v-model="query.name" placeholder="分类名称" clearable style="width: 220px" />
...
const form = reactive({ id: null, parentId: 0, name: '', code: '', sort: 0, status: 1 })
const rules = {
...
const resetForm = () => {
  Object.assign(form, { id: null, parentId: 0, name: '', code: '', sort: 0, status: 1 })
}
