...
public class UserController {
    ...
    public Result<?> page(@RequestParam(defaultValue = "1") Integer pageNum,
        ...
        return Result.success(userService.page(pageNum, pageSize, username, role, status, college));
    }

    @GetMapping("/teacher-list")
    public Result<?> teacherList() {
        return Result.success(userService.listByRole("TEACHER"));
    }

    @GetMapping("/student-list")
    public Result<?> studentList() {
        return Result.success(userService.listByRole("STUDENT"));
    }
