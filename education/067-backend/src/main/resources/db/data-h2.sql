...
ALTER TABLE campus_course ALTER COLUMN id RESTART WITH 10;
ALTER TABLE course_enroll ALTER COLUMN id RESTART WITH 10;
ALTER TABLE campus_activity ALTER COLUMN id RESTART WITH 10;
ALTER TABLE activity_signup ALTER COLUMN id RESTART WITH 10;
ALTER TABLE intern_job ALTER COLUMN id RESTART WITH 10;
ALTER TABLE job_apply ALTER COLUMN id RESTART WITH 10;
ALTER TABLE lost_found ALTER COLUMN id RESTART WITH 10;
ALTER TABLE campus_notice ALTER COLUMN id RESTART WITH 10;
