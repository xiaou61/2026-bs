...
import { getOpeningDefensePage, addOpeningDefense, updateOpeningDefense, deleteOpeningDefense, activateOpeningDefense, finishOpeningDefense } from '../api'
const api = { page: getOpeningDefensePage, add: addOpeningDefense, update: updateOpeningDefense, delete: deleteOpeningDefense }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'activate') await activateOpeningDefense(row.id)
  if (command === 'finish') await finishOpeningDefense(row.id)
