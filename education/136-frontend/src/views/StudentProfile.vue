...
import { getStudentProfilePage, addStudentProfile, updateStudentProfile, deleteStudentProfile, processStudentProfile, finishStudentProfile } from '../api'
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'process') await processStudentProfile(row.id)
