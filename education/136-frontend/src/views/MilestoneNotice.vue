...
import { getMilestoneNoticePage, addMilestoneNotice, updateMilestoneNotice, deleteMilestoneNotice, processMilestoneNotice, finishMilestoneNotice } from '../api'
const api = { page: getMilestoneNoticePage, add: addMilestoneNotice, update: updateMilestoneNotice, delete: deleteMilestoneNotice }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'process') await processMilestoneNotice(row.id)
  if (command === 'finish') await finishMilestoneNotice(row.id)
