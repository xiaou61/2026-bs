...
import { getGuidanceMeetingPage, addGuidanceMeeting, updateGuidanceMeeting, deleteGuidanceMeeting, processGuidanceMeeting, finishGuidanceMeeting } from '../api'
const api = { page: getGuidanceMeetingPage, add: addGuidanceMeeting, update: updateGuidanceMeeting, delete: deleteGuidanceMeeting }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'process') await processGuidanceMeeting(row.id)
  if (command === 'finish') await finishGuidanceMeeting(row.id)
