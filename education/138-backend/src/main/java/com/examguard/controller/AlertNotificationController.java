...
import com.examguard.service.AlertNotificationService;
...
public class AlertNotificationController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<AlertNotification>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody AlertNotification entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody AlertNotification entity) {
        authService.assertAdminOrInvigilator(role);
        service.save(entity);
        return Result.success();
    }
