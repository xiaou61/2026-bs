...
import com.examguard.service.ReviewDecisionService;
...
public class ReviewDecisionController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ReviewDecision>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ReviewDecision entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ReviewDecision entity) {
        authService.assertAdminOrReviewer(role);
        service.save(entity);
        return Result.success();
    }
