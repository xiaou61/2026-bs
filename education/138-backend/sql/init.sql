DROP DATABASE IF EXISTS exam_guard_138;
CREATE DATABASE exam_guard_138 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE exam_guard_138;
...
('invigilator', '123456', '监考老师', 'INVIGILATOR', '考试中心', '139138000200', 'invigilator@demo.local', 1, NOW(), NOW()),
('candidate', '123456', '考生', 'CANDIDATE', '考试班级', '139138000300', 'candidate@demo.local', 1, NOW(), NOW()),
('reviewer', '123456', '复核员', 'REVIEWER', '考试督导组', '139138000400', 'reviewer@demo.local', 1, NOW(), NOW());
