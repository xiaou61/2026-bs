...
import com.equipmentshare.service.MaintenanceWorkOrderService;
...
public class MaintenanceWorkOrderController {
    ...
    @GetMapping("/page")
    public Result<IPage<MaintenanceWorkOrder>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody MaintenanceWorkOrder entity) {
        authService.assertAdminOrManager(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody MaintenanceWorkOrder entity) {
        authService.assertAdminOrManager(role);
        service.save(entity);
        return Result.success();
    }
