  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">科研项目经费报销与成果</h2>
        <p class="subtitle">面向高校科研管理的经费预算、报销审批、支付记录和成果绩效平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>researcher / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>finance / 123456</el-tag>
          <el-tag type="info" effect="plain" round>leader / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: researchGradient 4s linear infinite;
}
