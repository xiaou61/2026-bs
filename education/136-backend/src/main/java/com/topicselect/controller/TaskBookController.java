...
import com.topicselect.service.TaskBookService;
...
public class TaskBookController {
    ...
    private final TaskBookService service;

    @GetMapping("/page")
    public Result<PageInfo<TaskBook>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody TaskBook entity) {
        authService.assertAdminOrTeacherOrAffairs(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody TaskBook entity) {
        authService.assertAdminOrTeacherOrAffairs(role);
        service.save(entity);
        return Result.success();
    }
