...
import com.topicselect.service.MidtermCheckService;
...
public class MidtermCheckController {
    ...
    private final MidtermCheckService service;

    @GetMapping("/page")
    public Result<PageInfo<MidtermCheck>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody MidtermCheck entity) {
        authService.assertAdminOrTeacherOrAffairs(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody MidtermCheck entity) {
        authService.assertAdminOrTeacherOrAffairs(role);
        service.save(entity);
        return Result.success();
    }
