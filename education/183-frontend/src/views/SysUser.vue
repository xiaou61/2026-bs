<template><DataPage title="账号权限" description="实验室管理员、饲养员、课题研究员、伦理委员、兽医账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
