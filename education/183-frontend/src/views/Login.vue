  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">实验动物饲养排班与伦理审批</h2>
        <p class="subtitle">面向科研实验室场景的动物档案、饲养排班、伦理申请、健康检查和物料消耗一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>lab / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>researcher / 123456</el-tag>
          <el-tag type="info" effect="plain" round>vet / 123456</el-tag>
        </div>
      </div>
...
.logo-icon {
  font-size: 72px;
  margin-bottom: 16px;
  animation: squeak 2s ease-in-out infinite;
