  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">高校考勤异常申诉与课堂巡查</h2>
        <p class="subtitle">面向高校教务场景的课堂巡查、考勤统计、异常申诉、整改反馈和督导评价一体化平台</p>
      </div>
...
.login-card::before {
  ...
  animation: eduGradient 4s linear infinite;
}

@keyframes eduGradient {
