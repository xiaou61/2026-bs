...
import com.psychologycare.service.FamilyCommunicationService;
...
public class FamilyCommunicationController {
    ...
    @GetMapping("/page")
    public Result<IPage<FamilyCommunication>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody FamilyCommunication entity) {
        authService.assertAdminOrTeacherOrCounselor(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody FamilyCommunication entity) {
        authService.assertAdminOrTeacherOrCounselor(role);
        service.save(entity);
        return Result.success();
    }
