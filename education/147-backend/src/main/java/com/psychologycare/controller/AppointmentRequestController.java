...
import com.psychologycare.service.AppointmentRequestService;
...
public class AppointmentRequestController {
    ...
    @GetMapping("/page")
    public Result<IPage<AppointmentRequest>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody AppointmentRequest entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody AppointmentRequest entity) {
        authService.assertAdminOrStudent(role);
        service.save(entity);
        return Result.success();
    }
