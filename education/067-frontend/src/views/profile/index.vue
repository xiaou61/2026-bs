    ...
    <el-col :span="14">
      <el-card>
        ...
        <el-form ref="profileRef" :model="profile" :rules="profileRules" label-width="90px">
          ...
          <el-form-item label="电话"><el-input v-model="profile.phone" maxlength="20" /></el-form-item>
          <el-form-item label="邮箱"><el-input v-model="profile.email" maxlength="100" /></el-form-item>
          <el-form-item label="学院"><el-input v-model="profile.college" maxlength="100" /></el-form-item>
          <el-form-item label="专业"><el-input v-model="profile.major" maxlength="100" /></el-form-item>
          <el-form-item label="年级"><el-input v-model="profile.grade" maxlength="20" /></el-form-item>
          <el-form-item>
...
const saveProfile = async () => {
  ...
  userStore.user = { ...userStore.user, ...profile }
