...
import { getVenueRoomPage, addVenueRoom, updateVenueRoom, deleteVenueRoom, processVenueRoom, finishVenueRoom } from '../api'
const api = { page: getVenueRoomPage, add: addVenueRoom, update: updateVenueRoom, delete: deleteVenueRoom }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'process') await processVenueRoom(row.id)
  if (command === 'finish') await finishVenueRoom(row.id)
