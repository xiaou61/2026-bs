<template><DataPage title="账号权限" description="教务管理员、选拔评审、导师教师、辅导员、学生用户账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
