  ...
  <div class="page">
    <div class="toolbar">
      ...
      <div class="toolbar-actions">
        ...
        <el-button v-if="canEdit" type="success" @click="openDialog()">新增课程</el-button>
      </div>
    </div>
    ...
    <el-card shadow="never">
      <el-table :data="list" stripe>
        ...
        <el-table-column prop="courseType" label="课程类型" min-width="100" />
        ...
        <el-table-column prop="courseDesc" label="课程简介" min-width="220" show-overflow-tooltip />
