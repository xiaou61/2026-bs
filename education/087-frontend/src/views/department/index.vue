  ...
  <div class="page">
    <div class="toolbar">
      <el-form :inline="true" :model="filters">
        <el-form-item label="院系名称">
          <el-input v-model="filters.name" placeholder="请输入院系名称" clearable />
        </el-form-item>
      ...
      <div class="toolbar-actions">
        ...
        <el-button type="success" @click="openDialog()">新增院系</el-button>
      </div>
    </div>
    ...
    <el-card shadow="never">
      <el-table :data="list" stripe>
        ...
        <el-table-column prop="code" label="院系编码" min-width="120" />
    ...
    <el-dialog v-model="dialogVisible" :title="form.id ? '编辑院系' : '新增院系'" width="520px">
