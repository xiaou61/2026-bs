...
import com.labconsumable.service.PurchaseApprovalService;
...
public class PurchaseApprovalController {
    ...
    @GetMapping("/page")
    public Result<IPage<PurchaseApproval>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody PurchaseApproval entity) {
        authService.assertAdminOrApprover(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody PurchaseApproval entity) {
        authService.assertAdminOrApprover(role);
        service.save(entity);
        return Result.success();
    }
