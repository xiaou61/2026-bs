DROP DATABASE IF EXISTS lab_consumable_133;
CREATE DATABASE lab_consumable_133 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE lab_consumable_133;
...
('keeper', '123456', '库管员', 'KEEPER', '耗材仓库', '139133000200', 'keeper@demo.local', 1, NOW(), NOW()),
('teacher', '123456', '实验教师', 'TEACHER', '教学实验室', '139133000300', 'teacher@demo.local', 1, NOW(), NOW()),
('approver', '123456', '审批负责人', 'APPROVER', '采购办公室', '139133000400', 'approver@demo.local', 1, NOW(), NOW());
