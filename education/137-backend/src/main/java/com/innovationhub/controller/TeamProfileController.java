...
import com.innovationhub.service.TeamProfileService;
...
public class TeamProfileController {
    ...
    @GetMapping("/page")
    public Result<IPage<TeamProfile>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody TeamProfile entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody TeamProfile entity) {
        authService.assertAdminOrMentorOrStudent(role);
        service.save(entity);
        return Result.success();
    }
