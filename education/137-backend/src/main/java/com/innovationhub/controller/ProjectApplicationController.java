...
import com.innovationhub.service.ProjectApplicationService;
...
public class ProjectApplicationController {
    ...
    @GetMapping("/page")
    public Result<IPage<ProjectApplication>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ProjectApplication entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ProjectApplication entity) {
        authService.assertAdminOrStudent(role);
        service.save(entity);
        return Result.success();
    }
