...
import com.innovationhub.service.IncubationPlanService;
...
public class IncubationPlanController {
    private final AuthService authService;
    private final IncubationPlanService service;

    @GetMapping("/page")
    public Result<IPage<IncubationPlan>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody IncubationPlan entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody IncubationPlan entity) {
        authService.assertAdminOrMentor(role);
        service.save(entity);
        return Result.success();
    }
