...
import com.innovationhub.service.FundingRecordService;
...
public class FundingRecordController {
    ...
    private final FundingRecordService service;

    @GetMapping("/page")
    public Result<IPage<FundingRecord>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody FundingRecord entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody FundingRecord entity) {
        authService.assertAdminOrMentor(role);
        service.save(entity);
        return Result.success();
    }
