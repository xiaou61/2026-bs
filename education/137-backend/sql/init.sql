DROP DATABASE IF EXISTS innovation_incubator_137;
CREATE DATABASE innovation_incubator_137 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE innovation_incubator_137;
...
('mentor', '123456', '项目导师', 'MENTOR', '创新学院', '139137000200', 'mentor@demo.local', 1, NOW(), NOW()),
('student', '123456', '创业学生', 'STUDENT', '创业团队', '139137000300', 'student@demo.local', 1, NOW(), NOW()),
('judge', '123456', '评审专家', 'JUDGE', '校外专家库', '139137000400', 'judge@demo.local', 1, NOW(), NOW());
