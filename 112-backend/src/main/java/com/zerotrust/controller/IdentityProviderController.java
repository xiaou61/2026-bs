...
public class IdentityProviderController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<IdentityProvider>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody IdentityProvider entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody IdentityProvider entity) {
        service.save(entity);
        return Result.success();
    }
    ...
    public Result<Void> connect(@PathVariable Long id) {
