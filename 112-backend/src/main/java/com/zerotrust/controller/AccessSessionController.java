...
public class AccessSessionController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<AccessSession>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody AccessSession entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody AccessSession entity) {
        service.save(entity);
        return Result.success();
    }
