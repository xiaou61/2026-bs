...
public class RiskModelController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<RiskModel>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody RiskModel entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody RiskModel entity) {
        service.save(entity);
        return Result.success();
    }
