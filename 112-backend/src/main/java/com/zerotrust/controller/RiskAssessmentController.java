...
import com.zerotrust.service.RiskAssessmentService;
...
public class RiskAssessmentController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<RiskAssessment>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody RiskAssessment entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody RiskAssessment entity) {
        authService.assertAdminOrSecurity(role);
        service.save(entity);
        return Result.success();
    }
    ...
    @PutMapping("/clear/{id}")
    public Result<Void> clear(@RequestAttribute String role, @PathVariable Long id) {
        authService.assertAdminOrSecurity(role);
        service.updateStatus(id, "CLEARED");
        return Result.success();
    }
