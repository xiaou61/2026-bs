  ...
  <div class="login-wrap">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">手工艺品销售</h2>
        <p class="subtitle">匠心独运 · 手作之美</p>
      </div>
...
.login-card::before {
  ...
  animation: craftGradient 4s linear infinite;
}

@keyframes craftGradient {
