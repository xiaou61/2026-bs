  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">直播基地主播排班与选品样品</h2>
        <p class="subtitle">面向直播基地场景的主播排班、直播计划、选品审核、样品借用和回放管理一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>anchor / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>selector / 123456</el-tag>
          <el-tag type="info" effect="plain" round>merchant / 123456</el-tag>
        </div>
      </div>
...
.login-card {
  ...
  border-radius: 28px;
  box-shadow: 0 24px 64px rgba(233, 30, 99, 0.3);
  position: relative;
  z-index: 10;
