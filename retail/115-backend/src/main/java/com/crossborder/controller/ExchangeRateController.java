...
import com.crossborder.service.ExchangeRateService;
...
public class ExchangeRateController {
    ...
    @GetMapping("/page")
    public Result<IPage<ExchangeRate>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ExchangeRate entity) {
        authService.assertAdminOrFinance(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ExchangeRate entity) {
        authService.assertAdminOrFinance(role);
        service.save(entity);
        return Result.success();
    }
