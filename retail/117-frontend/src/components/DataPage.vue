...
const form = reactive({})
const statusOptions = [{ label: '启用', value: 'ACTIVE' }, { label: '草稿', value: 'DRAFT' }, { label: '已发布', value: 'PUBLISHED' }, { label: '运行中', value: 'RUNNING' }, { label: '可使用', value: 'AVAILABLE' }, { label: '已确认', value: 'CONFIRMED' }, { label: '已结算', value: 'SETTLED' }, { label: '成功', value: 'SUCCESS' }, { label: '处理中', value: 'OPEN' }]
