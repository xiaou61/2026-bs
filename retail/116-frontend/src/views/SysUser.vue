<template>
  <DataPage title="账号权限" description="管理员、主播运营、客服专员、商家四角色账号权限和启停状态管理" :api="api" :columns="columns" :form-fields="formFields" :row-actions="rowActions" :defaults="defaults" @row-action="handleAction" />
</template>
