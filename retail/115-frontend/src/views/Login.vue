  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">跨境电商清关与汇率结算</h2>
        <p class="subtitle">清关申报、税费缴纳、汇率折算、结算对账、国际物流跟踪闭环</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>customs / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>finance / 123456</el-tag>
          <el-tag type="danger" effect="plain" round>operator / 123456</el-tag>
        </div>
      </div>

      <div class="cross-border-tips">
        <span>🌍 买全球 · 卖全球 🌍</span>
      </div>
    </el-card>
  </div>
...
.login-card::before {
  ...
  animation: crossBorderGradient 4s linear infinite;
}

@keyframes crossBorderGradient {
