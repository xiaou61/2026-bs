...
public class LiveChannelController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<LiveChannel>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody LiveChannel entity) {
        authService.assertAdminOrOperator(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody LiveChannel entity) {
        authService.assertAdminOrOperator(role);
        service.save(entity);
        return Result.success();
    }
