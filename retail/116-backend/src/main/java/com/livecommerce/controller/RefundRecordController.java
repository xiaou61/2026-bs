...
public class RefundRecordController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<RefundRecord>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody RefundRecord entity) {
        authService.assertAdminOrService(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody RefundRecord entity) {
        authService.assertAdminOrService(role);
        service.save(entity);
        return Result.success();
    }
