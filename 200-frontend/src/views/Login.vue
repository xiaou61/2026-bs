  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">非遗工坊课程预约与作品展销</h2>
        <p class="subtitle">面向非遗传承场景的工坊课程、预约签到、作品展销、传承人管理和结算统计一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>workshop / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>teacher / 123456</el-tag>
          <el-tag type="info" effect="plain" round>visitor / 123456</el-tag>
        </div>
      </div>

      <div class="heritage-tips">
        <span>🎭 非遗传承 · 文化自信 🎭</span>
      </div>
    </el-card>
  </div>
...
.login-card::before {
  ...
  animation: heritageGradient 4s linear infinite;
}

@keyframes heritageGradient {
...
.logo-icon {
  font-size: 72px;
  margin-bottom: 16px;
  animation: perform 2s ease-in-out infinite;
