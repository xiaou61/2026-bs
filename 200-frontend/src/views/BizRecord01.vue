<template><DataPage title="课程预约" description="课程预约编号、课程预约名称、业务类型、负责人、计划时间和状态维护" :api="api" :columns="columns" :form-fields="formFields" /></template>
<script setup>
import DataPage from '../components/DataPage.vue'
import { addBizRecord01, deleteBizRecord01, finishBizRecord01, getBizRecord01Page, processBizRecord01, updateBizRecord01 } from '../api'
const api = { page: getBizRecord01Page, add: addBizRecord01, update: updateBizRecord01, delete: deleteBizRecord01, process: processBizRecord01, finish: finishBizRecord01 }
