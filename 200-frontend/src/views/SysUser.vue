<template><DataPage title="账号权限" description="工坊管理员、非遗讲师、展陈运营、展销财务、学员访客账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
