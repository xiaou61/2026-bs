...
import com.craft.service.CraftOrderService;
...
public class OrderController {
    ...
    public Result<?> create(@RequestBody Map<String, Object> params, HttpServletRequest request) {
        ...
        CraftOrder order = orderService.create(userId, itemId, quantity, remark);
    ...
    public Result<?> page(@RequestParam(defaultValue = "1") Integer pageNum,
        ...
        Page<CraftOrderVO> page = orderService.page(pageNum, pageSize, orderNo, status, userId);
    ...
    public Result<?> my(@RequestParam(defaultValue = "1") Integer pageNum,
                        ...
                        HttpServletRequest request) {
        Long userId = (Long) request.getAttribute("userId");
        Page<CraftOrderVO> page = orderService.myOrders(userId, pageNum, pageSize, status, orderNo);
        return Result.success(page);
    }
    ...
    public Result<?> sale(@RequestParam(defaultValue = "1") Integer pageNum,
                          ...
                          HttpServletRequest request) {
        Long userId = (Long) request.getAttribute("userId");
        Page<CraftOrderVO> page = orderService.saleOrders(userId, pageNum, pageSize, status, orderNo);
        return Result.success(page);
    }
