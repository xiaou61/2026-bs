...
import com.livebase.clerk.ProductCatalogService;
...
public class ProductCatalogController {
    ...
    private final ProductCatalogService clerk;
    ...
    public Result<Void> add(@RequestAttribute("role") String role, @RequestBody ProductCatalog entity) {
        authService.assertAnyRole(role, "ADMIN", "BASE", "SELECTOR", "MERCHANT", "ANCHOR");
        clerk.save(entity);
