  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">旅行社团建行程报名与费用分摊</h2>
        <p class="subtitle">面向旅行社场景的行程规划、报名确认、费用分摊、发票管理和反馈评价一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>agency / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>leader / 123456</el-tag>
          <el-tag type="info" effect="plain" round>participant / 123456</el-tag>
        </div>
      </div>

      <div class="travel-tips">
        <span>✈️ 世界那么大 · 我们去看看 ✈️</span>
      </div>
    </el-card>
  </div>
</template>
