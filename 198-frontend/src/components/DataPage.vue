...
const normalizedStatusOptions = computed(() => props.statusOptions || [
  ...
  { label: '投放中', value: 'DEPLOYING' },
  { label: '巡检中', value: 'INSPECTING' },
...
const getStatusType = (status) => {
  const map = { REGISTERED: 'info', PLANNING: '', DEPLOYING: 'warning', INSPECTING: 'warning', REPAIRING: 'danger', RECYCLING: 'danger', SETTLING: 'warning', CLOSED: 'success' }
...
<style scoped>
.data-page { padding: 0; }
.main-card { border-radius: 12px; box-shadow: 0 2px 12px rgba(2, 119, 189, 0.06); }
