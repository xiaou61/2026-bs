<template>
  <div class="page">
    <div class="dashboard-grid">
      <div class="metric">点位投放<strong>{{ data.record01Count || 0 }}</strong></div>
      <div class="metric">设备巡检<strong>{{ data.record02Count || 0 }}</strong></div>
      <div class="metric">收益结算<strong>{{ data.record03Count || 0 }}</strong></div>
      <div class="metric">异常回收<strong>{{ data.record04Count || 0 }}</strong></div>
    </div>
