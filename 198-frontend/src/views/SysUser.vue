<template><DataPage title="账号权限" description="运营管理员、点位商户、巡检人员、财务结算、合作商户账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
