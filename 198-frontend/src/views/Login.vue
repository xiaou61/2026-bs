  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">共享充电宝投放巡检与收益结算</h2>
        <p class="subtitle">面向共享充电场景的设备投放、巡检维护、租赁订单、收益结算和故障报修一体化平台</p>
      </div>
...
.login-card::before {
  ...
  animation: chargeGradient 5s linear infinite;
}
