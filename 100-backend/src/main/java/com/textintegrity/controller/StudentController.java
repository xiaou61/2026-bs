...
public class StudentController {
    ...
    public Result<PageInfo<Map<String, Object>>> page(@RequestParam(defaultValue = "1") Integer pageNum,
                                                      ...
                                                      String major,
                                                      Integer status) {
        return Result.success(crudService.page("student", pageNum, pageSize, keyword, Filters.of("classId", classId, "major", major, "status", status)));
    }
    ...
    public Result<Void> add(@RequestAttribute Long userId, @RequestAttribute String role, @RequestBody Map<String, Object> data) {
        ...
        crudService.save("student", data);
        accessLogService.record(userId, "学生档案", "新增", "新增学生：" + data.get("name"));
    ...
    public Result<Void> update(@RequestAttribute Long userId, @RequestAttribute String role, @RequestBody Map<String, Object> data) {
        authService.assertTeacher(role);
        crudService.save("student", data);
        accessLogService.record(userId, "学生档案", "编辑", "编辑学生：" + data.get("name"));
        return Result.success();
    }
    ...
    public Result<Void> delete(@RequestAttribute Long userId, @RequestAttribute String role, @PathVariable Long id) {
        authService.assertTeacher(role);
        crudService.delete("student", id);
        accessLogService.record(userId, "学生档案", "删除", "删除学生：" + id);
        return Result.success();
    }
}
