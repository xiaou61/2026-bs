...
public class ChargingSessionController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ChargingSession>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ChargingSession entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ChargingSession entity) {
        service.save(entity);
        return Result.success();
    }
