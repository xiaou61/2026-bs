...
import com.chargepile.service.UserVehicleService;
...
public class UserVehicleController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<UserVehicle>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody UserVehicle entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody UserVehicle entity) {
        authService.assertAdminOrOwner(role);
        service.save(entity);
        return Result.success();
    }
