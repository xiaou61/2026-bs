...
public class RevenueStatisticController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<RevenueStatistic>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody RevenueStatistic entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody RevenueStatistic entity) {
        authService.assertAdminOrOperator(role);
        service.save(entity);
        return Result.success();
    }
