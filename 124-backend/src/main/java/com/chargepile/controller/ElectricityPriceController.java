...
public class ElectricityPriceController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ElectricityPrice>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ElectricityPrice entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ElectricityPrice entity) {
        authService.assertAdminOrOperator(role);
        service.save(entity);
        return Result.success();
    }
