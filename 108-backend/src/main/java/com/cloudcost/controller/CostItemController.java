...
import com.cloudcost.service.CostItemService;
...
public class CostItemController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<CostItem>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody CostItem entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody CostItem entity) {
        authService.assertAdminOrFinops(role);
        service.save(entity);
        return Result.success();
    }
