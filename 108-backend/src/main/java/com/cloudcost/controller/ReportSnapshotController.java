...
import com.cloudcost.service.ReportSnapshotService;
...
public class ReportSnapshotController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ReportSnapshot>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ReportSnapshot entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ReportSnapshot entity) {
        authService.assertAdminOrFinops(role);
        service.save(entity);
        return Result.success();
    }
