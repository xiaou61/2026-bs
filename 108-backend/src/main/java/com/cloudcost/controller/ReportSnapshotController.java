...
public class ReportSnapshotController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ReportSnapshot>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ReportSnapshot entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ReportSnapshot entity) {
        service.save(entity);
        return Result.success();
    }
