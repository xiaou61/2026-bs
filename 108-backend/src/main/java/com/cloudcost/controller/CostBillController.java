...
import com.cloudcost.service.CostBillService;
...
public class CostBillController {
    ...
    private final CostBillService service;

    @GetMapping("/page")
    public Result<PageInfo<CostBill>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody CostBill entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody CostBill entity) {
        authService.assertAdminOrFinops(role);
        service.save(entity);
        return Result.success();
    }
