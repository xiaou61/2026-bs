...
public class SavingPlanController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<SavingPlan>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody SavingPlan entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody SavingPlan entity) {
        service.save(entity);
        return Result.success();
    }
