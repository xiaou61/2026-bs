...
public class ResourceNamespaceController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ResourceNamespace>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ResourceNamespace entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ResourceNamespace entity) {
        authService.assertAdmin(role);
        service.save(entity);
        return Result.success();
    }
