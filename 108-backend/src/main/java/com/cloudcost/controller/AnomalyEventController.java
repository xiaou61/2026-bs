...
import com.cloudcost.service.AnomalyEventService;
...
public class AnomalyEventController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<AnomalyEvent>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody AnomalyEvent entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody AnomalyEvent entity) {
        authService.assertAdminOrDevops(role);
        service.save(entity);
        return Result.success();
    }
