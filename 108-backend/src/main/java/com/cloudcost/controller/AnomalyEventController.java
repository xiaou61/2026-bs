...
public class AnomalyEventController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<AnomalyEvent>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody AnomalyEvent entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody AnomalyEvent entity) {
        service.save(entity);
        return Result.success();
    }
