...
public class IdleResourceController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<IdleResource>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody IdleResource entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody IdleResource entity) {
        service.save(entity);
        return Result.success();
    }
    ...
    @PutMapping("/clean/{id}")
    public Result<Void> clean(@PathVariable Long id) {
