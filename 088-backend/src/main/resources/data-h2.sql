...
(1, 3, 2, '420101199506180021', '已婚', DATE '1995-06-18', '湖北省', '武汉市', '武昌区中北路88号', '教师', '15-25万', '夫妻二人稳定工作，有一套住房。', '希望给孩子一个温暖稳定的成长环境。', 1),
(2, 4, 1, '320101199302150019', '已婚', DATE '1993-02-15', '江苏省', '南京市', '建邺区江东中路66号', '工程师', '20-30万', '家庭成员关系稳定，父母支持收养。', '愿意承担长期监护责任并提供教育资源。', 1);
...
(1, 'CH20260001', '晨晨', 1, DATE '2020-04-10', 5, 1, 0, 'https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?auto=format&fit=crop&w=800&q=80', '性格开朗，喜欢绘画和拼图。', '武汉市儿童福利院', DATE '2021-01-15'),
(2, 'CH20260002', '小雨', 2, DATE '2019-08-21', 6, 1, 2, 'https://images.unsplash.com/photo-1516627145497-ae6968895b74?auto=format&fit=crop&w=800&q=80', '适应能力强，热爱音乐。', '武汉市儿童福利院', DATE '2020-03-08'),
(3, 'CH20260003', '乐乐', 1, DATE '2021-02-11', 4, 1, 0, 'https://images.unsplash.com/photo-1519345182560-3f2917c472ef?auto=format&fit=crop&w=800&q=80', '活泼好动，喜欢户外活动。', '武汉市儿童福利院', DATE '2022-06-20');
...
(1, 'AP202603140001', 1, 3, 5, '希望为孩子提供稳定的学习与生活环境。', DATE '2026-03-20', '材料通过，进入匹配阶段', TIMESTAMP '2026-03-14 09:30:00', TIMESTAMP '2026-03-14 16:10:00'),
(2, 'AP202603140002', 3, 4, 2, '家庭成员一致同意收养，并已做好长期规划。', DATE '2026-03-22', '待材料初审', TIMESTAMP '2026-03-14 10:20:00', NULL);
...
(1, 1, 2, DATE '2026-03-18', '通过', '居住环境整洁，家庭关系稳定。');
...
(1, 'AG202603140001', 1, 1, 3, 1, DATE '2026-03-25', '双方确认完成收养意向与监护责任约定。');
...
(1, 1, 1, DATE '2026-04-25', '正常', '孩子适应情况良好，家庭反馈积极。', DATE '2026-05-25', 2);

INSERT INTO system_notice (id, title, type, content, status, publish_time) VALUES
(1, '收养申请材料说明', '公告', '请申请人提前准备身份证明、收入证明、婚姻情况说明等材料。', 1, TIMESTAMP '2026-03-10 10:00:00'),
(2, '三月回访安排', '通知', '已签约家庭请关注本月回访时间安排，保持联系方式畅通。', 1, TIMESTAMP '2026-03-12 15:00:00');
