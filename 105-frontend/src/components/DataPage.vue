...
const form = reactive({})
const statusOptions = [{ label: '启用', value: 'ACTIVE' }, { label: '草稿', value: 'DRAFT' }, { label: '已发布', value: 'PUBLISHED' }, { label: '运行中', value: 'RUNNING' }, { label: '已完成', value: 'FINISHED' }, { label: '已确认', value: 'CONFIRMED' }]
