...
public class MerchantStoreController {
    ...
    @GetMapping("/page")
    public Result<IPage<MerchantStore>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody MerchantStore entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody MerchantStore entity) {
        service.save(entity);
        return Result.success();
    }
