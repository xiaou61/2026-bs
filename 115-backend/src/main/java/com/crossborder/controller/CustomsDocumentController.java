...
public class CustomsDocumentController {
    ...
    @GetMapping("/page")
    public Result<IPage<CustomsDocument>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody CustomsDocument entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody CustomsDocument entity) {
        service.save(entity);
        return Result.success();
    }
