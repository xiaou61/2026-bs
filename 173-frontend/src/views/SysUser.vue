<template><DataPage title="账号权限" description="就业中心、学院就业老师、辅导员、毕业生、用人单位账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
