  ...
  <div class="login-container">
    ...
    <div class="login-box">
      ...
      <div class="login-header">
        ...
        <h1 class="login-title">志愿活动平台</h1>
        <p class="login-subtitle">Volunteer Activity Management</p>
      </div>
...
.logo-icon {
  ...
  height: 80px;
  margin: 0 auto 20px;
  background: linear-gradient(135deg, #2E7D32 0%, #795548 100%);
  border-radius: 50%;
  display: flex;
  align-items: center;
  justify-content: center;
