  ...
  <div>
    <el-card>
      <div class="toolbar">
        ...
        <el-select v-if="isManager" v-model="query.status" placeholder="状态" clearable style="width: 160px">
          <el-option label="待审核" value="PENDING" />
          <el-option label="通过" value="APPROVED" />
          <el-option label="拒绝" value="REJECTED" />
        </el-select>
        <el-button type="primary" @click="loadData">查询</el-button>
        <el-button v-if="!isManager" type="success" @click="showAdd = true">发布评价</el-button>
      </div>
    ...
    <el-dialog v-model="showAdd" title="发布评价" width="500px">
