...
const normalizedStatusOptions = computed(() => props.statusOptions || [
  ...
  { label: '签到中', value: 'CHECKING' },
  { label: '展销中', value: 'SHOWING' },
...
const getStatusType = (status) => {
  const map = { REGISTERED: 'info', SCHEDULED: '', BOOKING: 'warning', REVIEWING: 'warning', CHECKING: '', SHOWING: 'success', SETTLING: 'warning', CLOSED: 'danger' }
...
<style scoped>
.data-page { padding: 0; }
.main-card { border-radius: 12px; box-shadow: 0 2px 12px rgba(139, 69, 19, 0.06); }
