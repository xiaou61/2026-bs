  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">铁路订票平台</h2>
        <p class="subtitle">便捷出行 · 畅游天下</p>
      </div>
      ...
      <div class="train-tips">
        <span>🛤️ 安全出行 · 准时到达 🛤️</span>
      </div>
    </el-card>

    <el-dialog v-model="registerVisible" title="注册乘客账号" width="460px" class="register-dialog">
...
.login-card::before {
  ...
  animation: trainGradient 4s linear infinite;
}
