  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">景区失物招领与游客寻回</h2>
        <p class="subtitle">面向景区服务场景的失物登记、拾物上报、认领审核、位置追溯和广播通知协同平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>service / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>security / 123456</el-tag>
...
.login-card {
  ...
  border-radius: 28px;
  box-shadow: 0 24px 64px rgba(79, 195, 247, 0.3);
  position: relative;
  z-index: 10;
...
.login-card::before {
  ...
  animation: lostGradient 4s linear infinite;
}

@keyframes lostGradient {
