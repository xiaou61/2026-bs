<template><DataPage title="账号权限" description="旅行社管理员、行程策划、财务人员、团队领队、团建成员账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
