...
const submitOrder = async () => {
  ...
  await createTicketOrder({ spotId: currentTicket.value.spotId, ticketTypeId: currentTicket.value.id, quantity: orderForm.value.quantity, ticketDate: orderForm.value.visitDate })
