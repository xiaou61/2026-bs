...
import com.worksite.service.WorkTeamService;
...
public class WorkTeamController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<WorkTeam>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody WorkTeam entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody WorkTeam entity) {
        authService.assertAdminOrSupervisor(role);
        service.save(entity);
        return Result.success();
    }
