...
public class AcceptanceRecordController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<AcceptanceRecord>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody AcceptanceRecord entity) {
        authService.assertAdminOrSupervisor(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody AcceptanceRecord entity) {
        authService.assertAdminOrSupervisor(role);
        service.save(entity);
        return Result.success();
    }
