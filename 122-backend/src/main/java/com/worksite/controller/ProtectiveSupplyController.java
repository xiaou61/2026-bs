...
public class ProtectiveSupplyController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ProtectiveSupply>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ProtectiveSupply entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ProtectiveSupply entity) {
        service.save(entity);
        return Result.success();
    }
