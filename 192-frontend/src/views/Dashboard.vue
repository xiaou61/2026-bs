<template>
  <div class="page">
    <div class="dashboard-grid">
      <div class="metric">陪护预约<strong>{{ data.record01Count || 0 }}</strong></div>
      <div class="metric">护工排班<strong>{{ data.record02Count || 0 }}</strong></div>
      <div class="metric">服务记录<strong>{{ data.record03Count || 0 }}</strong></div>
      <div class="metric">评价结算<strong>{{ data.record04Count || 0 }}</strong></div>
    </div>
