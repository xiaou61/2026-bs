...
import { getHospitalNoticePage, addHospitalNotice, updateHospitalNotice, deleteHospitalNotice, processHospitalNotice, finishHospitalNotice } from '../api'
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'process') await processHospitalNotice(row.id)
