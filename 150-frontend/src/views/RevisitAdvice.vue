...
import { getRevisitAdvicePage, addRevisitAdvice, updateRevisitAdvice, deleteRevisitAdvice, activateRevisitAdvice, finishRevisitAdvice } from '../api'
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'activate') await activateRevisitAdvice(row.id)
