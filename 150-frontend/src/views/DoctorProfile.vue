...
import { getDoctorProfilePage, addDoctorProfile, updateDoctorProfile, deleteDoctorProfile, processDoctorProfile, finishDoctorProfile } from '../api'
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'process') await processDoctorProfile(row.id)
  if (command === 'finish') await finishDoctorProfile(row.id)
