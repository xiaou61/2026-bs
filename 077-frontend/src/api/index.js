...
export const getReviewByItem = (serviceId) => request.get(`/api/review/item/${serviceId}`)
...
export const toggleFavorite = (serviceId) => request.post(`/api/favorite/${serviceId}`)
export const getMyFavorite = () => request.get('/api/favorite/my')
export const checkFavorite = (serviceId) => request.get(`/api/favorite/check/${serviceId}`)
...
export const getHotItems = () => request.get('/api/dashboard/hotServices')
