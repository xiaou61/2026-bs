<template>
  <el-container style="height: 100vh">
    <el-aside :width="collapse ? '64px' : '220px'" class="aside">
      <div class="logo">{{ collapse ? '制' : 'MES生产制造执行系统' }}</div>
      <el-menu :default-active="$route.path" :collapse="collapse" router background-color="#1f2937" text-color="#cbd5e1" active-text-color="#38bdf8">
        ...
        <template v-if="isAdmin">
          ...
          <el-menu-item index="/item">任务管理</el-menu-item>
          <el-menu-item index="/order">工单管理</el-menu-item>
          <el-menu-item index="/review">评价管理</el-menu-item>
          <el-menu-item index="/complaint">申诉管理</el-menu-item>
        </template>
        <el-menu-item v-else index="/item">我的任务</el-menu-item>
        <el-menu-item index="/market">生产任务</el-menu-item>
        <el-menu-item index="/my-order">我的工单</el-menu-item>
        <el-menu-item v-if="!isAdmin" index="/sale-order">工单处理</el-menu-item>
