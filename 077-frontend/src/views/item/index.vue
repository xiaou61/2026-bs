<template>
  <el-card>
    <div class="bar">
      <el-input v-model="query.title" placeholder="任务标题" style="width: 200px" clearable />
      <el-input v-model="query.serviceName" placeholder="任务编码" style="width: 160px" clearable />
      ...
      <el-button type="success" @click="openAdd">发布任务</el-button>
    </div>
    ...
    <el-table :data="tableData" v-loading="loading">
      ...
      <el-table-column prop="stock" label="产能上限" width="80" />
      <el-table-column prop="bookedCount" label="完工量" width="80" />
  ...
  <el-dialog v-model="dialogVisible" :title="form.id ? '编辑任务' : '发布任务'" width="680px">
    <el-form ref="formRef" :model="form" :rules="rules" label-width="90px">
      ...
      <el-form-item label="任务编码" prop="serviceName"><el-input v-model="form.serviceName" maxlength="80" show-word-limit /></el-form-item>
      <el-form-item label="生产车间"><el-input v-model="form.storeName" maxlength="80" show-word-limit /></el-form-item>
      <el-form-item label="工艺类型"><el-input v-model="form.vehicleType" maxlength="40" show-word-limit /></el-form-item>
      <el-form-item label="执行方式"><el-input v-model="form.bookingType" maxlength="30" show-word-limit /></el-form-item>
      ...
      <el-row :gutter="10">
        ...
        <el-col :span="12"><el-form-item label="产能上限" prop="stock"><el-input-number v-model="form.stock" :min="0" style="width: 100%" /></el-form-item></el-col>
      </el-row>
...
const rules = {
  ...
  serviceName: [
    ...
    { max: 80, message: '任务编码不能超过80字符', trigger: 'blur' }
  ],
  price: [
  ...
  stock: [{ required: true, message: '请输入产能上限', trigger: 'blur' }]
}
