  ...
  <div class="login-wrap">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">MES生产制造执行</h2>
        <p class="subtitle">智能制造 · 精准执行</p>
      </div>
...
.login-card::before {
  ...
  animation: mesGradient 4s linear infinite;
}

@keyframes mesGradient {
