...
public class DeviceMaintenanceController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<DeviceMaintenance>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody DeviceMaintenance entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody DeviceMaintenance entity) {
        service.save(entity);
        return Result.success();
    }
