...
public class WarehouseZoneController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<WarehouseZone>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody WarehouseZone entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody WarehouseZone entity) {
        service.save(entity);
        return Result.success();
    }
