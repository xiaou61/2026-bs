...
public class LocationRecommendationController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<LocationRecommendation>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody LocationRecommendation entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody LocationRecommendation entity) {
        service.save(entity);
        return Result.success();
    }
