...
public class StorageLocationController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<StorageLocation>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody StorageLocation entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody StorageLocation entity) {
        service.save(entity);
        return Result.success();
    }
