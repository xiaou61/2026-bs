  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">农贸市场摊位巡检与食品追溯</h2>
        <p class="subtitle">面向农贸市场的摊位巡检、食品抽样、来源追溯、风险预警和台账管理一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>market / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>inspector / 123456</el-tag>
          <el-tag type="info" effect="plain" round>vendor / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: marketGradient 4s linear infinite;
}

@keyframes marketGradient {
