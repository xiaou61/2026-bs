<template><DataPage title="账号权限" description="市场管理员、巡检员、摊位商户、抽检员、监管审核员账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
