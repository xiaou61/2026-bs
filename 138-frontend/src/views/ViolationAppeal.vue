...
import { getViolationAppealPage, addViolationAppeal, updateViolationAppeal, deleteViolationAppeal, processViolationAppeal, finishViolationAppeal } from '../api'
const api = { page: getViolationAppealPage, add: addViolationAppeal, update: updateViolationAppeal, delete: deleteViolationAppeal }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'process') await processViolationAppeal(row.id)
  if (command === 'finish') await finishViolationAppeal(row.id)
