...
import { getReviewTaskPage, addReviewTask, updateReviewTask, deleteReviewTask, processReviewTask, finishReviewTask } from '../api'
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'process') await processReviewTask(row.id)
  if (command === 'finish') await finishReviewTask(row.id)
