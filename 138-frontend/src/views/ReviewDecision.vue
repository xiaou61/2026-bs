...
import { getReviewDecisionPage, addReviewDecision, updateReviewDecision, deleteReviewDecision, activateReviewDecision, finishReviewDecision } from '../api'
const api = { page: getReviewDecisionPage, add: addReviewDecision, update: updateReviewDecision, delete: deleteReviewDecision }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'activate') await activateReviewDecision(row.id)
  if (command === 'finish') await finishReviewDecision(row.id)
