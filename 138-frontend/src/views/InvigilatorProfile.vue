...
import { getInvigilatorProfilePage, addInvigilatorProfile, updateInvigilatorProfile, deleteInvigilatorProfile, activateInvigilatorProfile, finishInvigilatorProfile } from '../api'
const api = { page: getInvigilatorProfilePage, add: addInvigilatorProfile, update: updateInvigilatorProfile, delete: deleteInvigilatorProfile }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'activate') await activateInvigilatorProfile(row.id)
  if (command === 'finish') await finishInvigilatorProfile(row.id)
