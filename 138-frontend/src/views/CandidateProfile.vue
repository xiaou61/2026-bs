...
import { getCandidateProfilePage, addCandidateProfile, updateCandidateProfile, deleteCandidateProfile, processCandidateProfile, finishCandidateProfile } from '../api'
const api = { page: getCandidateProfilePage, add: addCandidateProfile, update: updateCandidateProfile, delete: deleteCandidateProfile }
...
const handleAction = async ({ command, row, refresh }) => {
  if (command === 'process') await processCandidateProfile(row.id)
  if (command === 'finish') await finishCandidateProfile(row.id)
