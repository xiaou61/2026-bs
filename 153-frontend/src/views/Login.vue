  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">校园二手物品寄卖与信用评价</h2>
        <p class="subtitle">面向高校学生的闲置物品寄卖、担保交易、信用积分和申诉仲裁一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="warning" effect="plain" round>seller / 123456</el-tag>
          <el-tag type="info" effect="plain" round>buyer / 123456</el-tag>
          <el-tag type="danger" effect="plain" round>arbiter / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: campusGradient 4s linear infinite;
}
