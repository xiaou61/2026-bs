<template>
  <div class="page">
    <div class="dashboard-grid">
      <div class="metric">物品分类<strong>{{ data['categoryCount'] || 0 }}</strong></div>
      <div class="metric">学生档案<strong>{{ data['studentCount'] || 0 }}</strong></div>
      <div class="metric">寄卖物品<strong>{{ data['consignmentCount'] || 0 }}</strong></div>
      <div class="metric">上架审核<strong>{{ data['auditCount'] || 0 }}</strong></div>
    </div>
