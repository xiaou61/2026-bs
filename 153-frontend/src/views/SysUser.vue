<template><DataPage title="账号权限" description="平台运营、寄卖学生、购买学生、信用仲裁员账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
