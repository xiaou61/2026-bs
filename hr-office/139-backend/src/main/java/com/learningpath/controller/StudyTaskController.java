...
import com.learningpath.service.StudyTaskService;
...
public class StudyTaskController {
    ...
    @GetMapping("/page")
    public Result<IPage<StudyTask>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody StudyTask entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody StudyTask entity) {
        authService.assertAdminOrTrainerOrManager(role);
        service.save(entity);
        return Result.success();
    }
    ...
    public Result<Void> submit(@RequestAttribute String role, @PathVariable Long id) {
        authService.assertAdminOrTrainerOrEmployee(role);
