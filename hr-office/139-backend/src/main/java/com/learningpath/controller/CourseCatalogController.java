...
import com.learningpath.service.CourseCatalogService;
...
public class CourseCatalogController {
    ...
    @GetMapping("/page")
    public Result<IPage<CourseCatalog>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody CourseCatalog entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody CourseCatalog entity) {
        authService.assertAdminOrTrainerOrManager(role);
        service.save(entity);
        return Result.success();
    }
