  ...
  <div class="login-page">
    ...
    <div class="login-panel">
      <div class="brand">
        ...
        <div class="brand-tag">LEGAL SYSTEM</div>
      ...
      <el-form :model="form" class="login-form" @keyup.enter="handleLogin">
        <div class="form-header">
          ...
          <p class="form-subtitle">输入账号进入法律管理系统</p>
        </div>
        <el-form-item>
        ...
        <div class="accounts">
          ...
          <div class="account-tags">
            ...
            <el-tag type="success" effect="plain" round>lawyer / 123456</el-tag>
            <el-tag type="warning" effect="plain" round>assistant / 123456</el-tag>
            <el-tag type="danger" effect="plain" round>client / 123456</el-tag>
          </div>
        </div>
        <div class="legal-tips">
          <span>⚖️ 公平正义 · 法治社会 ⚖️</span>
        </div>
      </el-form>
    </div>
  </div>
...
.deco-4 { top: 50%; right: 10%; animation-delay: 6s; font-size: 40px; }
...
.login-panel::before {
  ...
  right: 0;
  height: 6px;
  background: linear-gradient(90deg, #1a1a2e, #533483, #7b2d8e, #1a1a2e);
  background-size: 300% 100%;
  animation: legalGradient 4s linear infinite;
}
...
.login-form :deep(.el-input__wrapper) {
  ...
  box-shadow: 0 2px 12px rgba(83, 52, 131, 0.08) !important;
  padding: 4px 12px;
  transition: all 0.3s ease;
}

.login-form :deep(.el-input__wrapper:hover) {
  box-shadow: 0 4px 16px rgba(83, 52, 131, 0.15) !important;
}

.login-form :deep(.el-input__wrapper.is-focus) {
  box-shadow: 0 4px 20px rgba(83, 52, 131, 0.25) !important;
}
...
.submit-btn {
  ...
  background: linear-gradient(135deg, #1a1a2e 0%, #533483 50%, #7b2d8e 100%) !important;
  border: none !important;
  box-shadow: 0 8px 24px rgba(83, 52, 131, 0.3) !important;
...
.submit-btn:hover {
  ...
  box-shadow: 0 12px 32px rgba(83, 52, 131, 0.4) !important;
}
