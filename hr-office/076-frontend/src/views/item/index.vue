<template>
  <el-card>
    <div class="bar">
      <el-input v-model="query.title" placeholder="信息标题" style="width: 200px" clearable />
      <el-input v-model="query.serviceName" placeholder="企业简称" style="width: 160px" clearable />
    ...
    <el-table :data="tableData" v-loading="loading">
      ...
      <el-table-column prop="stock" label="可处理容量" width="80" />
      <el-table-column prop="bookedCount" label="处理量" width="80" />
  ...
  <el-dialog v-model="dialogVisible" :title="form.id ? '编辑信息' : '发布信息'" width="680px">
    <el-form ref="formRef" :model="form" :rules="rules" label-width="90px">
      ...
      <el-form-item label="企业简称" prop="serviceName"><el-input v-model="form.serviceName" maxlength="80" show-word-limit /></el-form-item>
      <el-form-item label="所属行业"><el-input v-model="form.storeName" maxlength="80" show-word-limit /></el-form-item>
      <el-form-item label="企业规模"><el-input v-model="form.vehicleType" maxlength="40" show-word-limit /></el-form-item>
      <el-form-item label="处理方式"><el-input v-model="form.bookingType" maxlength="30" show-word-limit /></el-form-item>
      ...
      <el-row :gutter="10">
        ...
        <el-col :span="12"><el-form-item label="可处理容量" prop="stock"><el-input-number v-model="form.stock" :min="0" style="width: 100%" /></el-form-item></el-col>
      </el-row>
...
const rules = {
  ...
  serviceName: [
    ...
    { max: 80, message: '企业简称不能超过80字符', trigger: 'blur' }
  ],
  price: [
  ...
  stock: [{ required: true, message: '请输入可处理容量', trigger: 'blur' }]
}
