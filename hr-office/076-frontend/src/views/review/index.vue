<template>
  <el-card>
    <div class="bar">
      <el-input-number v-model="query.serviceId" :min="1" placeholder="信息ID" style="width: 160px" />
      <el-button type="primary" @click="loadData">查询</el-button>
    </div>
    <el-table :data="tableData" v-loading="loading">
      <el-table-column prop="id" label="ID" width="80" />
      <el-table-column prop="orderId" label="处理单ID" width="100" />
      <el-table-column prop="serviceId" label="信息ID" width="100" />
