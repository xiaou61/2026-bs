  ...
  <div class="login-container">
    ...
    <div class="login-box">
      <div class="logo-section">
        ...
        <h2 class="title">企业OA管理系统</h2>
        <p class="subtitle">高效办公 · 智慧协同</p>
      </div>
      ...
      <div class="demo-accounts">
        ...
        <div class="account-tags">
          <el-tag effect="plain" round>admin / admin123</el-tag>
          <el-tag type="success" effect="plain" round>manager / manager123</el-tag>
          <el-tag type="info" effect="plain" round>employee / employee123</el-tag>
        </div>
      </div>

      <div class="office-tips">
        <span>🏢 让工作更高效 · 让协同更智慧 🏢</span>
      </div>
    </div>
  </div>
</template>
