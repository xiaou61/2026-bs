...
const props = defineProps({ title: String, description: String, api: Object, columns: Array, formFields: Array, rowActions: { type: Array, default: () => [] }, defaults: { type: Object, default: () => ({}) }, readonly: Boolean, canCreate: { type: Boolean, default: undefined }, canEdit: { type: Boolean, default: undefined }, canDelete: { type: Boolean, default: undefined } })
