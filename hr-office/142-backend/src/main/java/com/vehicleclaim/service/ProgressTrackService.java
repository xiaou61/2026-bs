...
public class ProgressTrackService {
    private final ProgressTrackMapper patentRecordMapper;

    public PageInfo<ProgressTrack> page(Integer pageNum, Integer pageSize, String keyword, String status) {
        PageHelper.startPage(pageNum == null ? 1 : pageNum, pageSize == null ? 10 : pageSize);
        return new PageInfo<>(patentRecordMapper.selectPage(keyword, status));
    }

    public void save(ProgressTrack entity) {
