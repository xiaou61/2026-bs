...
import com.visitoraccess.clerk.VisitAppointmentService;
...
public class VisitAppointmentController {
    ...
    private final VisitAppointmentService clerk;
    ...
    public Result<Void> add(@RequestAttribute("role") String role, @RequestBody VisitAppointment entity) {
        authService.assertAnyRole(role, "ADMIN", "RECEPTION", "EMPLOYEE", "VISITOR", "MANAGER");
        clerk.save(entity);
