  ...
  <div class="login-container">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">贫困地区儿童资助</h2>
        <p class="subtitle">爱心助学 · 点亮希望</p>
      </div>
      ...
      <div class="charity-tips">
        <span>🌈 每一份爱心 · 都是一束光 🌈</span>
      </div>
    </el-card>
  </div>
</template>
...
.login-card::before {
  ...
  right: 0;
  height: 6px;
  background: linear-gradient(90deg, #E91E63, #F06292, #F48FB1, #FF80AB, #E91E63);
  background-size: 300% 100%;
  animation: charityGradient 4s linear infinite;
}

@keyframes charityGradient {
