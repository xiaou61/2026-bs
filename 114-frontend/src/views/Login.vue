  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">供应链冷链温控追踪</h2>
        <p class="subtitle">温控记录、运输轨迹、异常告警、处置任务、责任追溯闭环</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>dispatcher / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>carrier / 123456</el-tag>
          <el-tag type="danger" effect="plain" round>supervisor / 123456</el-tag>
        </div>
      </div>

      <div class="cold-tips">
        <span>❄️ 冷链保鲜 · 安全送达 ❄️</span>
      </div>
    </el-card>
  </div>
</template>
...
.login-card::before {
  ...
  animation: coldGradient 4s linear infinite;
}
