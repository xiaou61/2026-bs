...
import com.parkingguide.service.ParkingAreaService;
...
public class ParkingAreaController {
    ...
    @GetMapping("/page")
    public Result<IPage<ParkingArea>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ParkingArea entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ParkingArea entity) {
        authService.assertAdminOrOperator(role);
        service.save(entity);
        return Result.success();
    }
