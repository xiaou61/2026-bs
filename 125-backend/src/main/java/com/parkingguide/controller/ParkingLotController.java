...
public class ParkingLotController {
    ...
    @GetMapping("/page")
    public Result<IPage<ParkingLot>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ParkingLot entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ParkingLot entity) {
        service.save(entity);
        return Result.success();
    }
