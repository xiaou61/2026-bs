...
import com.parkingguide.service.SpaceSensorService;
...
public class SpaceSensorController {
    private final AuthService authService;
    private final SpaceSensorService service;

    @GetMapping("/page")
    public Result<IPage<SpaceSensor>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody SpaceSensor entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody SpaceSensor entity) {
        authService.assertAdminOrOperator(role);
        service.save(entity);
        return Result.success();
    }
