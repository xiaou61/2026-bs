...
public class GuidanceScreenController {
    ...
    @GetMapping("/page")
    public Result<IPage<GuidanceScreen>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody GuidanceScreen entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody GuidanceScreen entity) {
        service.save(entity);
        return Result.success();
    }
