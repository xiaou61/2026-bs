...
public class UserService {
    ...
    public User register(User user) {
        ...
        user.setCollege(user.getCollege() == null ? "" : user.getCollege().trim());
        user.setMajor(user.getMajor() == null ? "" : user.getMajor().trim());
    ...
    public void updateProfile(Long userId, User profile) {
        ...
        user.setPhone(profile.getPhone() == null ? "" : profile.getPhone().trim());
        user.setEmail(profile.getEmail() == null ? "" : profile.getEmail().trim());
        user.setCollege(profile.getCollege() == null ? "" : profile.getCollege().trim());
        user.setMajor(profile.getMajor() == null ? "" : profile.getMajor().trim());
        user.setGrade(profile.getGrade() == null ? "" : profile.getGrade().trim());
    ...
    public PageResult<User> page(Integer pageNum, Integer pageSize, String username, String role, Integer status, String college) {
        ...
        List<User> list = userMapper.selectPageList(username, role, status, college);
    ...
    public List<User> listByRole(String role) {
        List<User> list = userMapper.selectActiveList(role);
        list.forEach(item -> item.setPassword(null));
        return list;
    }
    ...
    private void update(User user) {
        ...
        if (!Objects.equals(db.getRole(), newRole)) {
            invalidate = true;
        }
