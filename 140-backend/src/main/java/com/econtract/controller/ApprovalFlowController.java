...
import com.econtract.service.ApprovalFlowService;
...
public class ApprovalFlowController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ApprovalFlow>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ApprovalFlow entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ApprovalFlow entity) {
        authService.assertAdminOrLegalOrApprover(role);
        service.save(entity);
        return Result.success();
    }
