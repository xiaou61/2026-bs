...
import com.econtract.service.CounterpartyProfileService;
...
public class CounterpartyProfileController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<CounterpartyProfile>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody CounterpartyProfile entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody CounterpartyProfile entity) {
        authService.assertAdminOrLegal(role);
        service.save(entity);
        return Result.success();
    }
