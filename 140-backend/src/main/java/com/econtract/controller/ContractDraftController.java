...
public class ContractDraftController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ContractDraft>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ContractDraft entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ContractDraft entity) {
        service.save(entity);
        return Result.success();
    }
