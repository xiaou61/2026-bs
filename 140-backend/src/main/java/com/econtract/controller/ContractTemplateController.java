...
public class ContractTemplateController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ContractTemplate>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody ContractTemplate entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody ContractTemplate entity) {
        service.save(entity);
        return Result.success();
    }
