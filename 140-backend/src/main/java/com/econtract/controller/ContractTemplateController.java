...
public class ContractTemplateController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<ContractTemplate>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ContractTemplate entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ContractTemplate entity) {
        authService.assertAdminOrLegal(role);
        service.save(entity);
        return Result.success();
    }
