...
import com.econtract.service.SealApplicationService;
...
public class SealApplicationController {
    ...
    @GetMapping("/page")
    public Result<PageInfo<SealApplication>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody SealApplication entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody SealApplication entity) {
        authService.assertAdminOrApplicant(role);
        service.save(entity);
        return Result.success();
    }
