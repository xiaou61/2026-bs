  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">本地生活服务券核销</h2>
        <p class="subtitle">服务券发放、到店核销、结算明细、商户打款、申诉统计闭环</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>merchant / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>cashier / 123456</el-tag>
          <el-tag type="danger" effect="plain" round>finance / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: localGradient 4s linear infinite;
}

@keyframes localGradient {
