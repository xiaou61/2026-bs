...
public class RoadshowEventController {
    ...
    @GetMapping("/page")
    public Result<IPage<RoadshowEvent>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody RoadshowEvent entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody RoadshowEvent entity) {
        service.save(entity);
        return Result.success();
    }
