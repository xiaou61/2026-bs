...
import com.innovationhub.service.MentorProfileService;
...
public class MentorProfileController {
    ...
    @GetMapping("/page")
    public Result<IPage<MentorProfile>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody MentorProfile entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody MentorProfile entity) {
        authService.assertAdminOrMentor(role);
        service.save(entity);
        return Result.success();
    }
