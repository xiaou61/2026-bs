...
public class AchievementShowcaseController {
    ...
    @GetMapping("/page")
    public Result<IPage<AchievementShowcase>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody AchievementShowcase entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody AchievementShowcase entity) {
        service.save(entity);
        return Result.success();
    }
