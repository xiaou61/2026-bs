...
import com.innovationhub.service.MentorCoachingService;
...
public class MentorCoachingController {
    private final AuthService authService;
    private final MentorCoachingService service;

    @GetMapping("/page")
    public Result<IPage<MentorCoaching>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody MentorCoaching entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody MentorCoaching entity) {
        authService.assertAdminOrMentor(role);
        service.save(entity);
        return Result.success();
    }
