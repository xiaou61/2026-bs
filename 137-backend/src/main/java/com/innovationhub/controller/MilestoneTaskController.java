...
public class MilestoneTaskController {
    ...
    @GetMapping("/page")
    public Result<IPage<MilestoneTask>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody MilestoneTask entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody MilestoneTask entity) {
        service.save(entity);
        return Result.success();
    }
