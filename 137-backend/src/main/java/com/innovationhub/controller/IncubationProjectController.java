...
public class IncubationProjectController {
    ...
    @GetMapping("/page")
    public Result<IPage<IncubationProject>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody IncubationProject entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody IncubationProject entity) {
        service.save(entity);
        return Result.success();
    }
