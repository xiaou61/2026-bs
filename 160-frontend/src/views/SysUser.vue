<template><DataPage title="账号权限" description="团委审核员、社团负责人、社团财务员、物资管理员、社团成员账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
