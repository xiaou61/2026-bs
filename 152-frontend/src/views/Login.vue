  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">工厂危险作业审批与监护巡检</h2>
        <p class="subtitle">覆盖作业许可证、气体检测、隐患排查、应急方案和监护巡检闭环管理平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>safety / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>approver / 123456</el-tag>
          <el-tag type="info" effect="plain" round>guardian / 123456</el-tag>
          <el-tag type="danger" effect="plain" round>worker / 123456</el-tag>
        </div>
      </div>

      <div class="safety-tips">
        <span>⚠️ 安全第一 · 预防为主 ⚠️</span>
      </div>
    </el-card>
  </div>
</template>
...
.login-card::before {
  ...
  animation: safetyGradient 3s linear infinite;
}
