<template>
  <div class="page">
    <div class="dashboard-grid">
      <div class="metric">危废暂存<strong>{{ data.record01Count || 0 }}</strong></div>
      <div class="metric">转运联单<strong>{{ data.record02Count || 0 }}</strong></div>
      <div class="metric">称重记录<strong>{{ data.record03Count || 0 }}</strong></div>
      <div class="metric">台账审计<strong>{{ data.record04Count || 0 }}</strong></div>
    </div>
