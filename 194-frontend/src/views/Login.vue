  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">工业园区危废暂存与转运联动监管</h2>
        <p class="subtitle">面向工业园区场景的危废暂存、转运联单、车辆调度、台账审计和风险预警一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>park / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>warehouse / 123456</el-tag>
          <el-tag type="info" effect="plain" round>enterprise / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: hazardGradient 3s linear infinite;
}

@keyframes hazardGradient {
