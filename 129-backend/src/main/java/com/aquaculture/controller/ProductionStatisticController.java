...
import com.aquaculture.service.ProductionStatisticService;
...
public class ProductionStatisticController {
    ...
    private final ProductionStatisticService service;

    @GetMapping("/page")
    public Result<IPage<ProductionStatistic>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ProductionStatistic entity) {
        authService.assertAdminOrBreederOrManager(role);
        service.save(entity);
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ProductionStatistic entity) {
        authService.assertAdminOrBreederOrManager(role);
        service.save(entity);
        return Result.success();
    }
