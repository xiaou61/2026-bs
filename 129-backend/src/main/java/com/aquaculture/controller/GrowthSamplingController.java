...
public class GrowthSamplingController {
    ...
    @GetMapping("/page")
    public Result<IPage<GrowthSampling>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody GrowthSampling entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody GrowthSampling entity) {
        service.save(entity);
        return Result.success();
    }
