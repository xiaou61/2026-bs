...
public class SensorDeviceController {
    ...
    @GetMapping("/page")
    public Result<IPage<SensorDevice>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody SensorDevice entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody SensorDevice entity) {
        service.save(entity);
        return Result.success();
    }
