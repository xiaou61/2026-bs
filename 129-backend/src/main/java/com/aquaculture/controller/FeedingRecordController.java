...
public class FeedingRecordController {
    ...
    @GetMapping("/page")
    public Result<IPage<FeedingRecord>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody FeedingRecord entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody FeedingRecord entity) {
        service.save(entity);
        return Result.success();
    }
