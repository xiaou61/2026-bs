...
import com.aquaculture.service.FeedingPlanService;
...
public class FeedingPlanController {
    ...
    @GetMapping("/page")
    public Result<IPage<FeedingPlan>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody FeedingPlan entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody FeedingPlan entity) {
        authService.assertAdminOrBreeder(role);
        service.save(entity);
        return Result.success();
    }
