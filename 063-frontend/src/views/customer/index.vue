<template>
  <el-card>
    <div class="bar">
      <el-input v-model="query.name" placeholder="客户名称" style="width: 220px" clearable />
    ...
    <el-table :data="tableData" v-loading="loading">
      <el-table-column prop="customerNo" label="编码" width="170" />
...
import { addCustomer, deleteCustomer, getCustomerPage, updateCustomer } from '../../api'
