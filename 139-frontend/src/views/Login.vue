  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">企业培训学习路径与能力画像</h2>
        <p class="subtitle">面向企业培训学习场景的课程学习、学习路径、能力画像和认证记录平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>trainer / 123456</el-tag>
