<template>
  <el-card>
    <div class="bar">
      <el-input-number v-model="query.serviceId" :min="1" placeholder="项目ID" style="width: 160px" />
      <el-button type="primary" @click="loadData">查询</el-button>
    </div>
    <el-table :data="tableData" v-loading="loading">
      <el-table-column prop="id" label="ID" width="80" />
      <el-table-column prop="orderId" label="预约单ID" width="100" />
      <el-table-column prop="serviceId" label="项目ID" width="100" />
