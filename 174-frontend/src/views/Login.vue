  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">社区慢病档案随访与服药依从性</h2>
        <p class="subtitle">面向社区卫生场景的慢病档案、随访计划、服药提醒、风险分层和健康指标一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>doctor / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>nurse / 123456</el-tag>
          <el-tag type="info" effect="plain" round>resident / 123456</el-tag>
        </div>
      </div>

      <div class="health-tips">
        <span>❤️ 慢病管理 · 健康随行 ❤️</span>
      </div>
    </el-card>
  </div>
</template>
...
.login-card::before {
  ...
  animation: chronicGradient 4s linear infinite;
}

@keyframes chronicGradient {
