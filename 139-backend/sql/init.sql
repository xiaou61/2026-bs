...
('employee', '123456', '企业员工', 'EMPLOYEE', '业务部门', '139139000300', 'employee@demo.local', 1, NOW(), NOW()),
('manager', '123456', '部门主管', 'MANAGER', '管理中心', '139139000400', 'manager@demo.local', 1, NOW(), NOW());
