...
import com.learningpath.service.TrainingProgramService;
...
public class TrainingProgramController {
    ...
    @GetMapping("/page")
    public Result<IPage<TrainingProgram>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody TrainingProgram entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody TrainingProgram entity) {
        authService.assertAdminOrTrainerOrManager(role);
        service.save(entity);
        return Result.success();
    }
