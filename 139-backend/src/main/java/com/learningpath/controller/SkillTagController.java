...
public class SkillTagController {
    ...
    @GetMapping("/page")
    public Result<IPage<SkillTag>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody SkillTag entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody SkillTag entity) {
        service.save(entity);
        return Result.success();
    }
