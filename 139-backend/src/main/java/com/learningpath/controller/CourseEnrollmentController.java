...
import com.learningpath.service.CourseEnrollmentService;
...
public class CourseEnrollmentController {
    ...
    @GetMapping("/page")
    public Result<IPage<CourseEnrollment>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody CourseEnrollment entity) {
        authService.assertAdminOrEmployee(role);
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody CourseEnrollment entity) {
        authService.assertAdminOrEmployee(role);
        service.save(entity);
        return Result.success();
    }
