...
public class CertificationRecordController {
    ...
    @GetMapping("/page")
    public Result<IPage<CertificationRecord>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody CertificationRecord entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody CertificationRecord entity) {
        authService.assertAdminOrTrainerOrManager(role);
        service.save(entity);
        return Result.success();
    }
