...
import com.learningpath.service.ExamScoreService;
...
public class ExamScoreController {
    ...
    @GetMapping("/page")
    public Result<IPage<ExamScore>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ExamScore entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ExamScore entity) {
        authService.assertAdminOrTrainerOrManager(role);
        service.save(entity);
        return Result.success();
    }
