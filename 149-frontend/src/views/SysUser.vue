<template>
  <DataPage title="账号权限" description="用户账号、角色、部门、联系电话和启停状态维护" :api="api" :columns="columns" :form-fields="formFields" :row-actions="rowActions" :defaults="defaults" @row-action="handleAction" />
</template>
