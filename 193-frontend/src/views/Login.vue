  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">校园创新实验班选拔与导师跟踪</h2>
        <p class="subtitle">面向高校创新教育场景的实验班选拔、导师匹配、培训计划、成果归档和过程跟踪一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>academic / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>mentor / 123456</el-tag>
          <el-tag type="info" effect="plain" round>student / 123456</el-tag>
        </div>
      </div>

      <div class="innovation-tips">
        <span>💡 创新驱动 · 人才强国 💡</span>
      </div>
    </el-card>
  </div>
...
.login-card::before {
  ...
  animation: innovationGradient 4s linear infinite;
}
