...
import com.emergencysupply.clerk.RequisitionOrderService;
...
public class RequisitionOrderController {
    ...
    private final RequisitionOrderService clerk;
    ...
    public Result<Void> add(@RequestAttribute("role") String role, @RequestBody RequisitionOrder entity) {
        authService.assertAnyRole(role, "ADMIN", "APPLICANT", "DISPATCH", "AUDITOR", "WAREHOUSE");
        clerk.save(entity);
