  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">生鲜门店临期商品预警与促销处置</h2>
        <p class="subtitle">面向生鲜零售场景的保质期监控、临期预警、促销策略和报损处置协同管理平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="warning" effect="plain" round>clerk / 123456</el-tag>
          <el-tag type="info" effect="plain" round>marketing / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: freshGradient 4s linear infinite;
}

@keyframes freshGradient {
