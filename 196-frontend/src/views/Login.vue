  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">药店处方审核与慢病续方提醒</h2>
        <p class="subtitle">面向药房场景的处方审核、慢病续方、用药指导、采购管理和库存预警一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>pharmacy / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>pharmacist / 123456</el-tag>
          <el-tag type="info" effect="plain" round>customer / 123456</el-tag>
        </div>
      </div>

      <div class="pharmacy-tips">
        <span>💊 安全用药 · 健康守护 💊</span>
      </div>
    </el-card>
  </div>
...
.login-card::before {
  ...
  animation: pharmacyGradient 4s linear infinite;
}

@keyframes pharmacyGradient {
