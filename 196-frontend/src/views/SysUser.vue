<template><DataPage title="账号权限" description="药店管理员、药师审核、门店店员、随访专员、慢病顾客账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
