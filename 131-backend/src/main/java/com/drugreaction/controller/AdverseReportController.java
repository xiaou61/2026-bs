...
public class AdverseReportController {
    ...
    @GetMapping("/page")
    public Result<IPage<AdverseReport>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody AdverseReport entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody AdverseReport entity) {
        service.save(entity);
        return Result.success();
    }
