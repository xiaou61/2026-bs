...
public class ReporterProfileController {
    ...
    @GetMapping("/page")
    public Result<IPage<ReporterProfile>> page(@RequestAttribute String role,
    ...
    @PostMapping
    public Result<Void> add(@RequestAttribute String role, @RequestBody ReporterProfile entity) {
    ...
    @PutMapping
    public Result<Void> update(@RequestAttribute String role, @RequestBody ReporterProfile entity) {
        authService.assertAdminOrReporter(role);
        service.save(entity);
        return Result.success();
    }
