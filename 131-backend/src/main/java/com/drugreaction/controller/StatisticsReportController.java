...
public class StatisticsReportController {
    ...
    @GetMapping("/page")
    public Result<IPage<StatisticsReport>> page(@RequestParam(required = false) Integer pageNum,
    ...
    @PostMapping
    public Result<Void> add(@RequestBody StatisticsReport entity) {
        service.save(entity);
        return Result.success();
    }

    @PutMapping
    public Result<Void> update(@RequestBody StatisticsReport entity) {
        service.save(entity);
        return Result.success();
    }
