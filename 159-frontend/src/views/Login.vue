  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">医疗废弃物收运联单与闭环监管</h2>
        <p class="subtitle">面向医废监管场景的产废登记、收运联单、处置确认、异常追溯和合规审计一体化平台</p>
      </div>
      ...
      <el-form :model="form" class="login-form" @keyup.enter="handleLogin">
        ...
        <el-button type="danger" size="large" class="submit-btn" @click="handleLogin">
          <el-icon><Key /></el-icon> 监管登录
        </el-button>
      </el-form>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>hospital / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>collector / 123456</el-tag>
          <el-tag type="info" effect="plain" round>transporter / 123456</el-tag>
          <el-tag type="danger" effect="plain" round>disposal / 123456</el-tag>
        </div>
      </div>

      <div class="waste-tips">
        <span>♻️ 医废监管 · 安全处置 ♻️</span>
      </div>
    </el-card>
  </div>
</template>
...
.login-card {
  ...
  border-radius: 28px;
  box-shadow: 0 24px 64px rgba(46, 125, 50, 0.3);
  position: relative;
  z-index: 10;
...
.login-card::before {
  ...
  right: 0;
  height: 6px;
  background: linear-gradient(90deg, #2E7D32, #43A047, #66BB6A, #81C784, #2E7D32);
  background-size: 300% 100%;
  animation: wasteGradient 4s linear infinite;
}

@keyframes wasteGradient {
