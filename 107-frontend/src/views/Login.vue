  ...
  <div class="login-page">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">云服务器资产监控与告警</h2>
        <p class="subtitle">云区域、主机资产、指标采样、告警事件和处置工单协同管理</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>ops / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>sre / 123456</el-tag>
          <el-tag type="danger" effect="plain" round>manager / 123456</el-tag>
        </div>
      </div>

      <div class="cloud-tips">
        <span>☁️ 云端监控 · 智能告警 ☁️</span>
      </div>
    </el-card>
  </div>
</template>
...
.login-card::before {
  ...
  animation: cloudGradient 4s linear infinite;
}
