...
const normalizedStatusOptions = computed(() => props.statusOptions || [
  ...
  { label: '待派单', value: 'BOOKING' },
  { label: '派单中', value: 'DISPATCHING' },
  { label: '服务中', value: 'SERVING' },
  { label: '待评价', value: 'EVALUATING' },
  { label: '投诉中', value: 'COMPLAINING' },
...
const getStatusType = (status) => {
  const map = { REGISTERED: 'info', BOOKING: 'warning', DISPATCHING: '', SERVING: 'success', EVALUATING: 'warning', COMPLAINING: 'danger', SETTLED: '', CLOSED: 'danger' }
...
<style scoped>
.data-page { padding: 0; }
.main-card { border-radius: 12px; box-shadow: 0 2px 12px rgba(230, 81, 0, 0.06); }
