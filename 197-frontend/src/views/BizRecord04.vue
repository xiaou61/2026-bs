<template><DataPage title="投诉处理" description="投诉处理编号、投诉处理名称、业务类型、负责人、计划时间和状态维护" :api="api" :columns="columns" :form-fields="formFields" /></template>
<script setup>
import DataPage from '../components/DataPage.vue'
import { addBizRecord04, deleteBizRecord04, finishBizRecord04, getBizRecord04Page, processBizRecord04, updateBizRecord04 } from '../api'
const api = { page: getBizRecord04Page, add: addBizRecord04, update: updateBizRecord04, delete: deleteBizRecord04, process: processBizRecord04, finish: finishBizRecord04 }
