<template>
  <div class="page">
    <div class="dashboard-grid">
      <div class="metric">服务站点<strong>{{ data['stationCount'] || 0 }}</strong></div>
      <div class="metric">居民档案<strong>{{ data['residentCount'] || 0 }}</strong></div>
      <div class="metric">人员档案<strong>{{ data['workerCount'] || 0 }}</strong></div>
      <div class="metric">服务项目<strong>{{ data['serviceCount'] || 0 }}</strong></div>
    </div>
