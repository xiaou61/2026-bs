<template>
  <div class="page">
    <div class="dashboard-grid">
      <div class="metric">服务预约<strong>{{ data.record01Count || 0 }}</strong></div>
      <div class="metric">人员排班<strong>{{ data.record02Count || 0 }}</strong></div>
      <div class="metric">信用评价<strong>{{ data.record03Count || 0 }}</strong></div>
      <div class="metric">投诉处理<strong>{{ data.record04Count || 0 }}</strong></div>
    </div>
