<template><DataPage title="账号权限" description="服务站管理员、派单调度、家政人员、品控专员、社区居民账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
