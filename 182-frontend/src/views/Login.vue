  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">养老助餐配送排线与营养套餐</h2>
        <p class="subtitle">面向社区养老场景的助餐点管理、营养菜单、配送排线、签收确认和补贴发放一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>dietitian / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>dispatch / 123456</el-tag>
          <el-tag type="info" effect="plain" round>elder / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: mealGradient 4s linear infinite;
}

@keyframes mealGradient {
