  ...
  <div class="login">
    ...
    <el-card class="login-card" shadow="always">
      <div class="logo-section">
        ...
        <h2 class="title">医院手术室器械包追踪与灭菌放行</h2>
        <p class="subtitle">面向医院供应室场景的器械打包、灭菌放行、手术使用、回收清点和缺陷追溯一体化平台</p>
      </div>
      ...
      <div class="accounts">
        ...
        <div class="account-tags">
          ...
          <el-tag type="success" effect="plain" round>ornurse / 123456</el-tag>
          <el-tag type="warning" effect="plain" round>cssd / 123456</el-tag>
          <el-tag type="info" effect="plain" round>surgeon / 123456</el-tag>
        </div>
      </div>
...
.login-card::before {
  ...
  animation: surgeryGradient 4s linear infinite;
}

@keyframes surgeryGradient {
