<template><DataPage title="账号权限" description="手术室护士、供应中心、灭菌人员、质控审核、手术医生账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
