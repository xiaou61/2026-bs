...
import com.autorepair.utils.JwtUtils;
...
public class UserService {
    ...
    public Map<String, Object> login(String username, String password) {
        ...
        redisTemplate.opsForValue().set("autorepair:token:" + user.getId(), token, 24, TimeUnit.HOURS);
    ...
    public void logout(Long userId) {
        redisTemplate.delete("autorepair:token:" + userId);
    }
