...
import com.autorepair.service.DashboardService;
...
public class DashboardController {
    ...
    @GetMapping("/hotServices")
    public Result<?> hotServices(HttpServletRequest request) {
        checkAdmin((String) request.getAttribute("role"));
        return Result.success(dashboardService.hotServices());
    }
