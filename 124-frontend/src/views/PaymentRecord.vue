<template>
  <DataPage title="支付记录" description="支付编号、充电编号、车主、支付金额、支付方式和支付时间管理" :api="api" :columns="columns" :form-fields="formFields" :row-actions="rowActions" :defaults="defaults" @row-action="handleAction" />
</template>
...
const columns = [{"prop": "paymentNo", "label": "支付编号"}, {"prop": "sessionNo", "label": "充电编号"}, {"prop": "ownerName", "label": "车主"}, {"prop": "payAmount", "label": "支付金额"}, {"prop": "payMethod", "label": "支付方式"}, {"prop": "payTime", "label": "支付时间"}, {"prop": "status", "label": "状态"}]
const formFields = [{"prop": "paymentNo", "label": "支付编号"}, {"prop": "sessionNo", "label": "充电编号"}, {"prop": "ownerName", "label": "车主"}, {"prop": "payAmount", "label": "支付金额", "type": "number"}, {"prop": "payMethod", "label": "支付方式"}, {"prop": "payTime", "label": "支付时间"}, {"prop": "status", "label": "状态", "type": "select", "options": [{"label": "ACTIVE", "value": "ACTIVE"}, {"label": "DISABLED", "value": "DISABLED"}, {"label": "AVAILABLE", "value": "AVAILABLE"}, {"label": "OCCUPIED", "value": "OCCUPIED"}, {"label": "CREATED", "value": "CREATED"}, {"label": "RESERVED", "value": "RESERVED"}, {"label": "CHARGING", "value": "CHARGING"}, {"label": "FINISHED", "value": "FINISHED"}, {"label": "OPEN", "value": "OPEN"}, {"label": "PROCESSING", "value": "PROCESSING"}, {"label": "CLOSED", "value": "CLOSED"}, {"label": "PAID", "value": "PAID"}, {"label": "REFUNDED", "value": "REFUNDED"}, {"label": "WARNING", "value": "WARNING"}]}]
