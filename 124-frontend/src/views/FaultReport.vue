<template>
  <DataPage title="故障报修" description="报修编号、桩位、故障类型、严重等级、上报人和上报时间管理" :api="api" :columns="columns" :form-fields="formFields" :row-actions="rowActions" :defaults="defaults" @row-action="handleAction" />
</template>
