<template><DataPage title="账号权限" description="游客服务员、安保巡查员、景区运营员、通知协同员、游客用户账号与状态维护" :api="api" :columns="columns" :form-fields="formFields" :manage-roles="['ADMIN']" :delete-roles="['ADMIN']" :status-options="statusOptions" :default-status="1" /></template>
<script setup>
